...
#line 29 "/opt/gnome3/source/folks/tests/folks/name-details.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "structured-name-to-string", _name_details_tests_test_structured_name_to_string_folks_test_case_test_method, self);
#line 31 "/opt/gnome3/source/folks/tests/folks/name-details.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "structured-name-to-string-with-format", _name_details_tests_test_structured_name_to_string_with_format_folks_test_case_test_method, self);
