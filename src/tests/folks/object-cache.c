/* object-cache.c generated by valac 0.35.3.10-6b27, the Vala compiler
...
static void __lambda9_ (Block4Data* _data4_, GObject* o, GAsyncResult* r);
static void ___lambda9__gasync_ready_callback (GObject* source_object, GAsyncResult* res, gpointer self);
static Block5Data* block5_data_ref (Block5Data* _data5_);
static void block5_data_unref (void * _userdata_);
static void __lambda10_ (Block5Data* _data5_, GObject* o, GAsyncResult* r);
...
static void __lambda13_ (Block6Data* _data6_, GObject* o, GAsyncResult* r);
...
static void __lambda16_ (Block7Data* _data7_, GObject* o, GAsyncResult* r);
...
static void __lambda18_ (Block8Data* _data8_, GObject* o, GAsyncResult* r);
...
static void __lambda20_ (Block9Data* _data9_, GObject* o, GAsyncResult* r);
...
static void __lambda22_ (Block10Data* _data10_, GObject* o, GAsyncResult* r);
...
static void __lambda24_ (Block11Data* _data11_, GObject* o, GAsyncResult* r);
...
TestObject* test_object_construct (GType object_type, const gchar* my_string, guint my_int) {
	...
	const gchar* _tmp0_;
	guint _tmp1_;
#line 10 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_val_if_fail (my_string != NULL, NULL);
#line 10 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (TestObject*) g_type_create_instance (object_type);
#line 12 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = my_string;
#line 12 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	test_object_set_my_string (self, _tmp0_);
#line 13 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = my_int;
#line 13 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	test_object_set_my_int (self, _tmp1_);
#line 10 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return self;
#line 359 "object-cache.c"
}
...
const gchar* test_object_get_my_string (TestObject* self) {
	const gchar* result;
	const gchar* _tmp0_;
#line 7 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
guint test_object_get_my_int (TestObject* self) {
	guint result;
	guint _tmp0_;
#line 8 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 425 "object-cache.c"
}


static void value_test_object_init (GValue* value) {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	value->data[0].v_pointer = NULL;
#line 432 "object-cache.c"
}
...
#line 451 "object-cache.c"
	} else {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		dest_value->data[0].v_pointer = NULL;
#line 455 "object-cache.c"
	}
}
...
#line 477 "object-cache.c"
		} else if (!g_value_type_compatible (G_TYPE_FROM_INSTANCE (object), G_VALUE_TYPE (value))) {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			return g_strconcat ("invalid object type `", g_type_name (G_TYPE_FROM_INSTANCE (object)), "' for value type `", G_VALUE_TYPE_NAME (value), "'", NULL);
#line 481 "object-cache.c"
		}
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		value->data[0].v_pointer = test_object_ref (object);
#line 485 "object-cache.c"
	} else {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		value->data[0].v_pointer = NULL;
#line 489 "object-cache.c"
	}
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return NULL;
#line 493 "object-cache.c"
}
...
#line 504 "object-cache.c"
	}
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	if (!value->data[0].v_pointer) {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		*object_p = NULL;
#line 510 "object-cache.c"
	} else if (collect_flags & G_VALUE_NOCOPY_CONTENTS) {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		*object_p = value->data[0].v_pointer;
#line 514 "object-cache.c"
	} else {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		*object_p = test_object_ref (value->data[0].v_pointer);
#line 518 "object-cache.c"
	}
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return NULL;
#line 522 "object-cache.c"
}
...
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		value->data[0].v_pointer = v_object;
#line 594 "object-cache.c"
	} else {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		value->data[0].v_pointer = NULL;
#line 598 "object-cache.c"
	}
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	if (old) {
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		test_object_unref (old);
#line 604 "object-cache.c"
	}
}
...
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((TestObjectClass *) klass)->finalize = test_object_finalize;
#line 5 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_type_class_add_private (klass, sizeof (TestObjectPrivate));
#line 616 "object-cache.c"
}
...
TestCache* test_cache_construct (GType object_type, const gchar* id) {
	TestCache * self = NULL;
	const gchar* _tmp0_;
#line 19 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_val_if_fail (id != NULL, NULL);
#line 21 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = id;
#line 21 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 698 "object-cache.c"
}


static gpointer _g_variant_type_copy0 (gpointer self) {
#line 27 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return self ? g_variant_type_copy (self) : NULL;
#line 705 "object-cache.c"
}
...
static GVariantType* test_cache_real_get_serialised_object_type (FolksObjectCache* base, guint8 object_version) {
	...
	GVariantType* _tmp6_;
	GVariantType* _tmp7_;
#line 24 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (TestCache*) base;
#line 27 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
static guint8 test_cache_real_get_serialised_object_version (FolksObjectCache* base) {
	TestCache * self;
	guint8 result = 0U;
#line 33 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (TestCache*) base;
#line 35 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	result = (guint8) 1;
#line 35 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return result;
#line 764 "object-cache.c"
}
...
static GVariant* test_cache_real_serialise_object (FolksObjectCache* base, TestObject* obj) {
	...
	GVariant* _tmp10_;
	GVariant* _tmp11_;
#line 38 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (TestCache*) base;
#line 38 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_val_if_fail (obj != NULL, NULL);
#line 40 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = obj;
#line 40 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
static TestObject* test_cache_real_deserialise_object (FolksObjectCache* base, GVariant* variant, guint8 object_version) {
	...
	guint32 _tmp10_;
	TestObject* _tmp11_;
#line 46 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (TestCache*) base;
#line 46 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_val_if_fail (variant != NULL, NULL);
#line 50 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = variant;
#line 50 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 50 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	my_string = _tmp5_;
#line 51 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp6_ = variant;
#line 51 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 51 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	my_int = _tmp10_;
#line 53 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 53 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return result;
#line 893 "object-cache.c"
}


static void test_cache_class_init (TestCacheClass * klass) {
#line 17 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	test_cache_parent_class = g_type_class_peek_parent (klass);
#line 17 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((FolksObjectCacheClass *) klass)->get_serialised_object_type = test_cache_real_get_serialised_object_type;
#line 17 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((FolksObjectCacheClass *) klass)->get_serialised_object_version = test_cache_real_get_serialised_object_version;
#line 17 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((FolksObjectCacheClass *) klass)->serialise_object = test_cache_real_serialise_object;
#line 17 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((FolksObjectCacheClass *) klass)->deserialise_object = test_cache_real_deserialise_object;
#line 908 "object-cache.c"
}
...
static void _object_cache_tests_test_create_folks_test_case_test_method (gpointer self) {
#line 74 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_create ((ObjectCacheTests*) self);
#line 931 "object-cache.c"
}


static void _object_cache_tests_test_store_objects_folks_test_case_test_method (gpointer self) {
#line 75 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_store_objects ((ObjectCacheTests*) self);
#line 938 "object-cache.c"
}


static void _object_cache_tests_test_store_objects_empty_folks_test_case_test_method (gpointer self) {
#line 76 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_store_objects_empty ((ObjectCacheTests*) self);
#line 945 "object-cache.c"
}


static void _object_cache_tests_test_load_objects_folks_test_case_test_method (gpointer self) {
#line 77 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_load_objects ((ObjectCacheTests*) self);
#line 952 "object-cache.c"
}


static void _object_cache_tests_test_load_objects_empty_folks_test_case_test_method (gpointer self) {
#line 78 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_load_objects_empty ((ObjectCacheTests*) self);
#line 959 "object-cache.c"
}


static void _object_cache_tests_test_load_objects_nonexistent_folks_test_case_test_method (gpointer self) {
#line 79 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_load_objects_nonexistent ((ObjectCacheTests*) self);
#line 966 "object-cache.c"
}


static void _object_cache_tests_test_clear_folks_test_case_test_method (gpointer self) {
#line 81 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
static void _object_cache_tests_test_clear_empty_folks_test_case_test_method (gpointer self) {
#line 82 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_clear_empty ((ObjectCacheTests*) self);
#line 980 "object-cache.c"
}


static void _object_cache_tests_test_clear_nonexistent_folks_test_case_test_method (gpointer self) {
#line 83 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_clear_nonexistent ((ObjectCacheTests*) self);
#line 987 "object-cache.c"
}


static void _object_cache_tests_test_store_objects_cancellation_folks_test_case_test_method (gpointer self) {
#line 86 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_store_objects_cancellation ((ObjectCacheTests*) self);
#line 994 "object-cache.c"
}


static void _object_cache_tests_test_load_objects_cancellation_folks_test_case_test_method (gpointer self) {
#line 88 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_load_objects_cancellation ((ObjectCacheTests*) self);
#line 1001 "object-cache.c"
}


static void _object_cache_tests_test_stress_folks_test_case_test_method (gpointer self) {
#line 92 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	object_cache_tests_test_stress ((ObjectCacheTests*) self);
#line 1008 "object-cache.c"
}
...
ObjectCacheTests* object_cache_tests_construct (GType object_type) {
	...
	const gchar* _tmp2_;
	GFile* _tmp3_;
#line 64 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (ObjectCacheTests*) folks_test_case_construct (object_type, "ObjectCache");
#line 68 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_get_tmp_dir ();
#line 68 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = g_strconcat (_tmp0_, "/folks-object-cache-tests", NULL);
#line 68 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	tmp_path = _tmp1_;
#line 69 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_setenv ("XDG_CACHE_HOME", tmp_path, TRUE);
#line 70 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = g_get_user_cache_dir ();
#line 70 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (g_strcmp0 (_tmp2_, tmp_path) == 0, "Environment.get_user_cache_dir () == tmp_path");
#line 71 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 74 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "create", _object_cache_tests_test_create_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 75 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "store-objects", _object_cache_tests_test_store_objects_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 76 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "store-objects-empty", _object_cache_tests_test_store_objects_empty_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 77 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "load-objects", _object_cache_tests_test_load_objects_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 78 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "load-objects-empty", _object_cache_tests_test_load_objects_empty_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 79 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "load-objects-nonexistent", _object_cache_tests_test_load_objects_nonexistent_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 81 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "clear", _object_cache_tests_test_clear_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 82 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "clear-empty", _object_cache_tests_test_clear_empty_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 83 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "clear-nonexistent", _object_cache_tests_test_clear_nonexistent_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 86 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "store-objects-cancellation", _object_cache_tests_test_store_objects_cancellation_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 88 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "load-objects-cancellation", _object_cache_tests_test_load_objects_cancellation_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 92 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "stress", _object_cache_tests_test_stress_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 62 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_free0 (tmp_path);
#line 62 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return self;
#line 1067 "object-cache.c"
}
...
#line 1074 "object-cache.c"
}


static void object_cache_tests_real_set_up (FolksTestCase* base) {
	ObjectCacheTests * self;
#line 95 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (ObjectCacheTests*) base;
#line 97 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 98 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_object_cache_tests_delete_cache_directory (self);
#line 1086 "object-cache.c"
}


static void object_cache_tests_real_tear_down (FolksTestCase* base) {
	ObjectCacheTests * self;
#line 101 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = (ObjectCacheTests*) base;
#line 103 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_object_cache_tests_delete_cache_directory (self);
#line 104 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 107 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (self != NULL);
#line 107 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (dir != NULL);
#line 110 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = dir;
#line 110 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 110 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		return;
#line 1128 "object-cache.c"
	}
#line 114 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = enumerator;
#line 114 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 114 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		return;
#line 1144 "object-cache.c"
	}
#line 115 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	while (TRUE) {
#line 1148 "object-cache.c"
		GFileInfo* _tmp4_;
		GFile* child_file;
		GFile* _tmp5_;
		GFileInfo* _tmp6_;
...
#line 115 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			break;
#line 1167 "object-cache.c"
		}
#line 117 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_tmp5_ = dir;
#line 117 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_tmp6_ = file_info;
#line 117 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 117 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		child_file = _tmp8_;
#line 119 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_tmp9_ = child_file;
#line 119 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_tmp10_ = g_file_query_file_type (_tmp9_, G_FILE_QUERY_INFO_NONE, NULL);
#line 119 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		if (_tmp10_ == G_FILE_TYPE_DIRECTORY) {
#line 1185 "object-cache.c"
			GFile* _tmp11_;
#line 122 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			_tmp11_ = child_file;
#line 122 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 122 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				return;
#line 1203 "object-cache.c"
			}
		} else {
			GFile* _tmp12_;
#line 126 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			_tmp12_ = child_file;
#line 126 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 126 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				return;
#line 1223 "object-cache.c"
			}
		}
#line 129 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_tmp14_ = enumerator;
#line 129 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 131 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp17_ = enumerator;
#line 131 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 134 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp18_ = dir;
#line 134 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
void _object_cache_tests_delete_cache_directory (ObjectCacheTests* self) {
	GError * _inner_error_ = NULL;
#line 137 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (self != NULL);
#line 1304 "object-cache.c"
	{
		GFile* _tmp0_;
#line 141 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_tmp0_ = self->priv->_cache_dir;
#line 141 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_object_cache_tests_delete_directory (self, _tmp0_, &_inner_error_);
#line 141 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		if (G_UNLIKELY (_inner_error_ != NULL)) {
#line 1313 "object-cache.c"
	...
	{
		GError* e = NULL;
#line 139 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		e = _inner_error_;
#line 139 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_inner_error_ = NULL;
#line 139 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_g_error_free0 (e);
#line 1327 "object-cache.c"
	}
	__finally0:
#line 139 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
void object_cache_tests_test_create (ObjectCacheTests* self) {
	TestCache* cache;
	TestCache* _tmp0_;
#line 149 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (self != NULL);
#line 152 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = test_cache_new ("test-create");
#line 152 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	cache = _tmp0_;
#line 154 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (cache != NULL, "cache != null");
#line 149 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_object_unref0 (cache);
#line 1356 "object-cache.c"
}


static Block1Data* block1_data_ref (Block1Data* _data1_) {
#line 157 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data1_->_ref_count_);
#line 157 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data1_;
#line 1365 "object-cache.c"
}
...
static void __lambda4_ (Block1Data* _data1_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 168 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data1_->self;
#line 168 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 170 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 170 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data1_->cache, _tmp0_);
#line 171 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data1_->main_loop);
#line 1404 "object-cache.c"
}
...
#line 159 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 159 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data1_->main_loop = _tmp0_;
#line 160 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-store-objects");
#line 160 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data1_->cache = _tmp1_;
#line 162 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = gee_hash_set_new (TYPE_TEST_OBJECT, (GBoxedCopyFunc) test_object_ref, test_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
#line 162 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj_set = _tmp2_;
#line 163 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 164 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 165 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 166 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 168 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data1_->cache, (GeeSet*) obj_set, NULL, ___lambda4__gasync_ready_callback, block1_data_ref (_data1_));
#line 174 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 157 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data1_ = NULL;
#line 1493 "object-cache.c"
}


static Block2Data* block2_data_ref (Block2Data* _data2_) {
#line 177 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data2_->_ref_count_);
#line 177 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data2_;
#line 1502 "object-cache.c"
}
...
static void __lambda5_ (Block2Data* _data2_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 182 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data2_->self;
#line 182 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 184 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 184 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data2_->cache, _tmp0_);
#line 185 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data2_->main_loop);
#line 1541 "object-cache.c"
}
...
#line 179 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 179 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data2_->main_loop = _tmp0_;
#line 180 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 182 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = _tmp2_;
#line 182 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data2_->cache, (GeeSet*) _tmp3_, NULL, ___lambda5__gasync_ready_callback, block2_data_ref (_data2_));
#line 182 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_object_unref0 (_tmp3_);
#line 188 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data2_->main_loop);
#line 177 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	block2_data_unref (_data2_);
#line 177 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data2_ = NULL;
#line 1590 "object-cache.c"
}


static Block3Data* block3_data_ref (Block3Data* _data3_) {
#line 191 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data3_->_ref_count_);
#line 191 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data3_;
#line 1599 "object-cache.c"
}
...
static void __lambda6_ (Block3Data* _data3_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp1_;
	GMainLoop* _tmp2_;
#line 205 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data3_->self;
#line 205 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 207 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = _data3_->cache;
#line 207 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = r;
#line 207 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _tmp0_, _tmp1_);
#line 208 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = _data3_->main_loop;
#line 208 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_tmp2_);
#line 1646 "object-cache.c"
}
...
static void __lambda7_ (Block3Data* _data3_, GObject* o, GAsyncResult* r) {
	...
	GeeSet* _tmp2_;
	GMainLoop* _tmp3_;
#line 215 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data3_->self;
#line 215 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 217 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = _data3_->cache;
#line 217 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = r;
#line 217 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 218 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = _data3_->main_loop;
#line 218 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_tmp3_);
#line 1683 "object-cache.c"
}
...
#line 193 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 193 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data3_->main_loop = _tmp0_;
#line 194 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-load-objects");
#line 194 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data3_->cache = _tmp1_;
#line 197 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = test_object_new ("Foo", (guint) 1);
#line 197 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj1 = _tmp2_;
#line 198 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = test_object_new ("Bar", (guint) 2);
#line 198 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj2 = _tmp3_;
#line 200 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp4_ = gee_hash_set_new (TYPE_TEST_OBJECT, (GBoxedCopyFunc) test_object_ref, test_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
#line 200 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj_set = _tmp4_;
#line 201 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp5_ = obj_set;
#line 201 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp6_ = obj1;
#line 201 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp5_, _tmp6_);
#line 202 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp7_ = obj_set;
#line 202 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp8_ = obj2;
#line 202 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 205 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp10_ = obj_set;
#line 205 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _tmp9_, (GeeSet*) _tmp10_, NULL, ___lambda6__gasync_ready_callback, block3_data_ref (_data3_));
#line 211 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp11_ = _data3_->main_loop;
#line 211 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_tmp11_);
#line 214 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data3_->new_obj_set = NULL;
#line 215 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp12_ = _data3_->cache;
#line 215 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _tmp12_, NULL, ___lambda7__gasync_ready_callback, block3_data_ref (_data3_));
#line 221 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp13_ = _data3_->main_loop;
#line 221 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_tmp13_);
#line 224 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp14_ = _data3_->new_obj_set;
#line 224 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (_tmp14_ != NULL, "new_obj_set != null");
#line 225 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 1803 "object-cache.c"
	{
		GeeIterator* _new_obj_it;
		GeeSet* _tmp21_;
		GeeIterator* _tmp22_;
#line 227 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 229 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			partner_found = FALSE;
#line 1842 "object-cache.c"
			{
				GeeIterator* _original_obj_it;
				GeeHashSet* _tmp27_;
				GeeIterator* _tmp28_;
#line 231 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				_tmp27_ = obj_set;
#line 231 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 231 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				while (TRUE) {
#line 1855 "object-cache.c"
					GeeIterator* _tmp29_;
					gboolean _tmp30_;
					TestObject* original_obj;
					GeeIterator* _tmp31_;
					gpointer _tmp32_;
...
#line 233 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
					_tmp34_ = new_obj;
#line 233 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 1898 "object-cache.c"
						...
						guint _tmp44_;
						guint _tmp45_;
#line 234 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						_tmp40_ = new_obj;
#line 234 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 1919 "object-cache.c"
					} else {
#line 233 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						_tmp33_ = FALSE;
#line 1923 "object-cache.c"
					}
#line 233 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
					if (_tmp33_) {
#line 1927 "object-cache.c"
						GeeHashSet* _tmp46_;
						TestObject* _tmp47_;
#line 236 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						_tmp46_ = obj_set;
#line 236 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						_tmp47_ = original_obj;
#line 236 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						gee_abstract_collection_remove ((GeeAbstractCollection*) _tmp46_, _tmp47_);
#line 237 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						partner_found = TRUE;
#line 238 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						_test_object_unref0 (original_obj);
#line 238 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
						break;
#line 1942 "object-cache.c"
					}
#line 231 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
					_test_object_unref0 (original_obj);
#line 1946 "object-cache.c"
				}
#line 231 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				_g_object_unref0 (_original_obj_it);
#line 1950 "object-cache.c"
			}
#line 242 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			_tmp48_ = partner_found;
#line 242 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			_vala_assert (_tmp48_, "partner_found");
#line 227 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			_test_object_unref0 (new_obj);
#line 1958 "object-cache.c"
		}
#line 227 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		_g_object_unref0 (_new_obj_it);
#line 1962 "object-cache.c"
	}
#line 245 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp49_ = obj_set;
#line 245 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 191 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data3_ = NULL;
#line 1982 "object-cache.c"
}


static Block4Data* block4_data_ref (Block4Data* _data4_) {
#line 248 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data4_->_ref_count_);
#line 248 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data4_;
#line 1991 "object-cache.c"
}
...
static void __lambda8_ (Block4Data* _data4_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 254 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data4_->self;
#line 254 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 256 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 256 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data4_->cache, _tmp0_);
#line 257 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data4_->main_loop);
#line 2032 "object-cache.c"
}
...
static void __lambda9_ (Block4Data* _data4_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 264 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data4_->self;
#line 264 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 266 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 266 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 267 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data4_->main_loop);
#line 2063 "object-cache.c"
}
...
#line 250 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 250 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data4_->main_loop = _tmp0_;
#line 251 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 254 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = _tmp2_;
#line 254 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data4_->cache, (GeeSet*) _tmp3_, NULL, ___lambda8__gasync_ready_callback, block4_data_ref (_data4_));
#line 254 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_object_unref0 (_tmp3_);
#line 260 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data4_->main_loop);
#line 263 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data4_->new_obj_set = NULL;
#line 264 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data4_->cache, NULL, ___lambda9__gasync_ready_callback, block4_data_ref (_data4_));
#line 270 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data4_->main_loop);
#line 273 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (_data4_->new_obj_set != NULL, "new_obj_set != null");
#line 274 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
static Block5Data* block5_data_ref (Block5Data* _data5_) {
#line 277 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data5_->_ref_count_);
#line 277 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data5_;
#line 2137 "object-cache.c"
}
...
static void __lambda10_ (Block5Data* _data5_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 287 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data5_->self;
#line 287 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 289 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 289 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 290 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data5_->main_loop);
#line 2183 "object-cache.c"
}
...
#line 279 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 279 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data5_->main_loop = _tmp0_;
#line 280 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-load-objects-nonexistent");
#line 280 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data5_->cache = _tmp1_;
#line 283 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_object_cache_tests_delete_cache_directory (self);
#line 286 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data5_->new_obj_set = NULL;
#line 287 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data5_->cache, NULL, ___lambda10__gasync_ready_callback, block5_data_ref (_data5_));
#line 293 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data5_->main_loop);
#line 296 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (_data5_->new_obj_set == NULL, "new_obj_set == null");
#line 277 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	block5_data_unref (_data5_);
#line 277 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data5_ = NULL;
#line 2230 "object-cache.c"
}


static Block6Data* block6_data_ref (Block6Data* _data6_) {
#line 299 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data6_->_ref_count_);
#line 299 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data6_;
#line 2239 "object-cache.c"
}
...
static void __lambda11_ (Block6Data* _data6_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 313 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data6_->self;
#line 313 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 315 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 315 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data6_->cache, _tmp0_);
#line 316 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data6_->main_loop);
#line 2280 "object-cache.c"
}
...
static void __lambda12_ (Block6Data* _data6_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 322 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data6_->self;
#line 322 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 324 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 324 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_clear_cache_finish ((FolksObjectCache*) _data6_->cache, _tmp0_);
#line 325 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data6_->main_loop);
#line 2306 "object-cache.c"
}
...
static void __lambda13_ (Block6Data* _data6_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 332 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data6_->self;
#line 332 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 334 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 334 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 335 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data6_->main_loop);
#line 2337 "object-cache.c"
}
...
#line 301 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 301 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data6_->main_loop = _tmp0_;
#line 302 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-clear");
#line 302 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data6_->cache = _tmp1_;
#line 305 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = test_object_new ("Foo", (guint) 1);
#line 305 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj1 = _tmp2_;
#line 306 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = test_object_new ("Bar", (guint) 2);
#line 306 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj2 = _tmp3_;
#line 308 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp4_ = gee_hash_set_new (TYPE_TEST_OBJECT, (GBoxedCopyFunc) test_object_ref, test_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
#line 308 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj_set = _tmp4_;
#line 309 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) obj_set, obj1);
#line 310 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) obj_set, obj2);
#line 313 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data6_->cache, (GeeSet*) obj_set, NULL, ___lambda11__gasync_ready_callback, block6_data_ref (_data6_));
#line 319 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data6_->main_loop);
#line 322 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_clear_cache ((FolksObjectCache*) _data6_->cache, ___lambda12__gasync_ready_callback, block6_data_ref (_data6_));
#line 328 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data6_->main_loop);
#line 331 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data6_->new_obj_set = NULL;
#line 332 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data6_->cache, NULL, ___lambda13__gasync_ready_callback, block6_data_ref (_data6_));
#line 338 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data6_->main_loop);
#line 340 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 299 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data6_ = NULL;
#line 2418 "object-cache.c"
}


static Block7Data* block7_data_ref (Block7Data* _data7_) {
#line 343 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
static void __lambda14_ (Block7Data* _data7_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 349 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data7_->self;
#line 349 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 351 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 351 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data7_->cache, _tmp0_);
#line 352 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data7_->main_loop);
#line 2468 "object-cache.c"
}
...
static void __lambda15_ (Block7Data* _data7_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 358 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data7_->self;
#line 358 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 360 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 360 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_clear_cache_finish ((FolksObjectCache*) _data7_->cache, _tmp0_);
#line 361 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data7_->main_loop);
#line 2494 "object-cache.c"
}
...
static void __lambda16_ (Block7Data* _data7_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 368 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data7_->self;
#line 368 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 370 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 370 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 371 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data7_->main_loop);
#line 2525 "object-cache.c"
}
...
#line 345 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 345 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data7_->main_loop = _tmp0_;
#line 346 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 349 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = _tmp2_;
#line 349 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data7_->cache, (GeeSet*) _tmp3_, NULL, ___lambda14__gasync_ready_callback, block7_data_ref (_data7_));
#line 349 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_object_unref0 (_tmp3_);
#line 355 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data7_->main_loop);
#line 358 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_clear_cache ((FolksObjectCache*) _data7_->cache, ___lambda15__gasync_ready_callback, block7_data_ref (_data7_));
#line 364 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data7_->main_loop);
#line 367 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data7_->new_obj_set = NULL;
#line 368 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data7_->cache, NULL, ___lambda16__gasync_ready_callback, block7_data_ref (_data7_));
#line 374 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data7_->main_loop);
#line 376 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (_data7_->new_obj_set == NULL, "new_obj_set == null");
#line 343 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	block7_data_unref (_data7_);
#line 343 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data7_ = NULL;
#line 2586 "object-cache.c"
}


static Block8Data* block8_data_ref (Block8Data* _data8_) {
#line 379 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data8_->_ref_count_);
#line 379 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data8_;
#line 2595 "object-cache.c"
}
...
static void __lambda17_ (Block8Data* _data8_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 388 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data8_->self;
#line 388 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 390 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 390 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_clear_cache_finish ((FolksObjectCache*) _data8_->cache, _tmp0_);
#line 391 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data8_->main_loop);
#line 2636 "object-cache.c"
}
...
static void __lambda18_ (Block8Data* _data8_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 398 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data8_->self;
#line 398 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 400 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 400 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 401 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data8_->main_loop);
#line 2667 "object-cache.c"
}
...
#line 381 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 381 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data8_->main_loop = _tmp0_;
#line 382 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-clear-nonexistent");
#line 382 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data8_->cache = _tmp1_;
#line 385 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_object_cache_tests_delete_cache_directory (self);
#line 388 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_clear_cache ((FolksObjectCache*) _data8_->cache, ___lambda17__gasync_ready_callback, block8_data_ref (_data8_));
#line 394 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data8_->main_loop);
#line 397 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data8_->new_obj_set = NULL;
#line 398 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data8_->cache, NULL, ___lambda18__gasync_ready_callback, block8_data_ref (_data8_));
#line 404 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data8_->main_loop);
#line 406 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (_data8_->new_obj_set == NULL, "new_obj_set == null");
#line 379 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	block8_data_unref (_data8_);
#line 379 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data8_ = NULL;
#line 2718 "object-cache.c"
}


static Block9Data* block9_data_ref (Block9Data* _data9_) {
#line 409 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data9_->_ref_count_);
#line 409 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data9_;
#line 2727 "object-cache.c"
}
...
static void __lambda19_ (Block9Data* _data9_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 422 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data9_->self;
#line 422 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 424 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 424 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data9_->cache, _tmp0_);
#line 425 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data9_->main_loop);
#line 2768 "object-cache.c"
}
...
static void __lambda20_ (Block9Data* _data9_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 434 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data9_->self;
#line 434 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 436 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 436 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 437 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data9_->main_loop);
#line 2799 "object-cache.c"
}
...
#line 411 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 411 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data9_->main_loop = _tmp0_;
#line 412 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-store-objects-cancellation");
#line 412 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data9_->cache = _tmp1_;
#line 414 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = gee_hash_set_new (TYPE_TEST_OBJECT, (GBoxedCopyFunc) test_object_ref, test_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
#line 414 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj_set = _tmp2_;
#line 415 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = test_object_new ("Foo", (guint) 1);
#line 415 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp4_ = _tmp3_;
#line 415 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 415 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_test_object_unref0 (_tmp4_);
#line 416 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp5_ = test_object_new ("Bar", (guint) 2);
#line 416 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp6_ = _tmp5_;
#line 416 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 416 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_test_object_unref0 (_tmp6_);
#line 417 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp7_ = test_object_new ("De", (guint) 3);
#line 417 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp8_ = _tmp7_;
#line 417 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 417 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_test_object_unref0 (_tmp8_);
#line 418 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp9_ = test_object_new ("Baz", (guint) 4);
#line 418 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp10_ = _tmp9_;
#line 418 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 418 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_test_object_unref0 (_tmp10_);
#line 420 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp11_ = g_cancellable_new ();
#line 420 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	cancellable = _tmp11_;
#line 422 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data9_->cache, (GeeSet*) obj_set, cancellable, ___lambda19__gasync_ready_callback, block9_data_ref (_data9_));
#line 429 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_cancellable_cancel (cancellable);
#line 430 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data9_->main_loop);
#line 433 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data9_->new_obj_set = NULL;
#line 434 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data9_->cache, NULL, ___lambda20__gasync_ready_callback, block9_data_ref (_data9_));
#line 440 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data9_->main_loop);
#line 442 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 409 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data9_ = NULL;
#line 2906 "object-cache.c"
}


static Block10Data* block10_data_ref (Block10Data* _data10_) {
#line 445 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data10_->_ref_count_);
#line 445 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data10_;
#line 2915 "object-cache.c"
}
...
static void __lambda21_ (Block10Data* _data10_, GObject* o, GAsyncResult* r) {
	ObjectCacheTests* self;
	GAsyncResult* _tmp0_;
#line 459 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data10_->self;
#line 459 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 461 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 461 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _data10_->cache, _tmp0_);
#line 462 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data10_->main_loop);
#line 2956 "object-cache.c"
}
...
static void __lambda22_ (Block10Data* _data10_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp0_;
	GeeSet* _tmp1_;
#line 471 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data10_->self;
#line 471 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 473 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = r;
#line 473 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 474 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_data10_->main_loop);
#line 2987 "object-cache.c"
}
...
#line 447 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 447 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data10_->main_loop = _tmp0_;
#line 448 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-load-objects-cancellation");
#line 448 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data10_->cache = _tmp1_;
#line 451 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = test_object_new ("Foo", (guint) 1);
#line 451 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj1 = _tmp2_;
#line 452 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = test_object_new ("Bar", (guint) 2);
#line 452 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj2 = _tmp3_;
#line 454 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp4_ = gee_hash_set_new (TYPE_TEST_OBJECT, (GBoxedCopyFunc) test_object_ref, test_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
#line 454 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj_set = _tmp4_;
#line 455 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) obj_set, obj1);
#line 456 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) obj_set, obj2);
#line 459 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _data10_->cache, (GeeSet*) obj_set, NULL, ___lambda21__gasync_ready_callback, block10_data_ref (_data10_));
#line 465 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data10_->main_loop);
#line 468 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp5_ = g_cancellable_new ();
#line 468 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	cancellable = _tmp5_;
#line 470 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data10_->new_obj_set = NULL;
#line 471 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _data10_->cache, cancellable, ___lambda22__gasync_ready_callback, block10_data_ref (_data10_));
#line 478 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_cancellable_cancel (cancellable);
#line 479 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_data10_->main_loop);
#line 481 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 445 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data10_ = NULL;
#line 3074 "object-cache.c"
}


static Block11Data* block11_data_ref (Block11Data* _data11_) {
#line 484 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_atomic_int_inc (&_data11_->_ref_count_);
#line 484 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _data11_;
#line 3083 "object-cache.c"
}
...
static void __lambda23_ (Block11Data* _data11_, GObject* o, GAsyncResult* r) {
	...
	GAsyncResult* _tmp3_;
	GMainLoop* _tmp4_;
#line 501 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data11_->self;
#line 501 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 503 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_test_timer_elapsed ();
#line 503 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	elapsed_time = _tmp0_;
#line 504 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 507 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = _data11_->cache;
#line 507 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = r;
#line 507 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects_finish ((FolksObjectCache*) _tmp2_, _tmp3_);
#line 508 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp4_ = _data11_->main_loop;
#line 508 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_tmp4_);
#line 3141 "object-cache.c"
}
...
static void __lambda24_ (Block11Data* _data11_, GObject* o, GAsyncResult* r) {
	...
	GeeSet* _tmp4_;
	GMainLoop* _tmp5_;
#line 517 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	self = _data11_->self;
#line 517 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_return_if_fail (r != NULL);
#line 519 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_test_timer_elapsed ();
#line 519 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	elapsed_time = _tmp0_;
#line 520 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = _data11_->obj_count;
#line 520 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_message ("object-cache.vala:520: Loading %u objects from a cache file took %f se" \
"conds.", (guint) _tmp1_, elapsed_time);
#line 523 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = _data11_->cache;
#line 523 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp3_ = r;
#line 523 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 524 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp5_ = _data11_->main_loop;
#line 524 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_quit (_tmp5_);
#line 3189 "object-cache.c"
}
...
#line 486 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 486 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data11_->main_loop = _tmp0_;
#line 487 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp1_ = test_cache_new ("test-stress");
#line 487 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data11_->cache = _tmp1_;
#line 490 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data11_->obj_count = 66666;
#line 491 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp2_ = gee_hash_set_new (TYPE_TEST_OBJECT, (GBoxedCopyFunc) test_object_ref, test_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
#line 491 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	obj_set = _tmp2_;
#line 3240 "object-cache.c"
	{
		gint i;
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
		i = 0;
#line 3245 "object-cache.c"
		{
			gboolean _tmp3_;
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
			_tmp3_ = TRUE;
...
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				if (!_tmp3_) {
#line 3261 "object-cache.c"
					gint _tmp4_;
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
					_tmp4_ = i;
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
					i = _tmp4_ + 1;
#line 3267 "object-cache.c"
				}
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				_tmp3_ = FALSE;
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 493 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
					break;
#line 3279 "object-cache.c"
				}
#line 495 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				_tmp7_ = obj_set;
#line 495 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				_tmp8_ = i;
#line 495 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 495 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
				_test_object_unref0 (_tmp10_);
#line 3293 "object-cache.c"
			}
		}
	}
#line 499 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_test_timer_start ();
#line 501 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 501 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp12_ = obj_set;
#line 501 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_store_objects ((FolksObjectCache*) _tmp11_, (GeeSet*) _tmp12_, NULL, ___lambda23__gasync_ready_callback, block11_data_ref (_data11_));
#line 511 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp13_ = _data11_->main_loop;
#line 511 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_tmp13_);
#line 514 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_test_timer_start ();
#line 516 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data11_->new_obj_set = NULL;
#line 517 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp14_ = _data11_->cache;
#line 517 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_object_cache_load_objects ((FolksObjectCache*) _tmp14_, NULL, ___lambda24__gasync_ready_callback, block11_data_ref (_data11_));
#line 527 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp15_ = _data11_->main_loop;
#line 527 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_main_loop_run (_tmp15_);
#line 531 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_vala_assert (_data11_->new_obj_set != NULL, "new_obj_set != null");
#line 532 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 484 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_data11_ = NULL;
#line 3341 "object-cache.c"
}


static void object_cache_tests_class_init (ObjectCacheTestsClass * klass) {
#line 58 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
...
#line 58 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((FolksTestCaseClass *) klass)->set_up = object_cache_tests_real_set_up;
#line 58 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	((FolksTestCaseClass *) klass)->tear_down = object_cache_tests_real_tear_down;
#line 58 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	G_OBJECT_CLASS (klass)->finalize = object_cache_tests_finalize;
#line 3356 "object-cache.c"
}
...
#line 60 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_object_unref0 (self->priv->_cache_dir);
#line 58 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	G_OBJECT_CLASS (object_cache_tests_parent_class)->finalize (obj);
#line 3375 "object-cache.c"
}
...
gint _vala_main (gchar** args, int args_length1) {
	gint result = 0;
	ObjectCacheTests* tests;
	ObjectCacheTests* _tmp0_;
#line 538 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_test_init (&args_length1, &args, NULL);
#line 540 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_tmp0_ = object_cache_tests_new ();
#line 540 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	tests = _tmp0_;
#line 541 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 542 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	g_test_run ();
#line 543 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 545 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	result = 0;
#line 545 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	_g_object_unref0 (tests);
#line 545 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return result;
#line 3413 "object-cache.c"
}
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 536 "/opt/gnome/source/folks/tests/folks/object-cache.vala"
	return _vala_main (argv, argc);
#line 3423 "object-cache.c"
}
