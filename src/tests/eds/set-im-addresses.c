...
#line 36 "/opt/gnome3/source/folks/tests/eds/set-im-addresses.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "setting im addresses on e-d-s persona", _set_im_addresses_tests_test_set_im_addresses_folks_test_case_test_method, g_object_ref (self), g_object_unref);
