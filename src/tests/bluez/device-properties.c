/* device-properties.c generated by valac 0.27.1.3-6129, the Vala compiler
...
#line 30 "/opt/gnome3/source/folks/tests/bluez/device-properties.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "device pairing", _device_properties_tests_test_device_pairing_folks_test_case_test_method, self);
#line 31 "/opt/gnome3/source/folks/tests/bluez/device-properties.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "blocked device", _device_properties_tests_test_blocked_device_folks_test_case_test_method, self);
#line 32 "/opt/gnome3/source/folks/tests/bluez/device-properties.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "device alias", _device_properties_tests_test_device_alias_folks_test_case_test_method, self);
