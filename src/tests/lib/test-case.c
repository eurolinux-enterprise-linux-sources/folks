...
static void _vala_array_add1 (gchar*** array, int* length, int* size, gchar* value) {
#line 77 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if ((*length) == (*size)) {
#line 77 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 77 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
static void _vala_array_add2 (gchar*** array, int* length, int* size, gchar* value) {
#line 80 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if ((*length) == (*size)) {
#line 80 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 80 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
static void _vala_array_add3 (gchar*** array, int* length, int* size, gchar* value) {
#line 83 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if ((*length) == (*size)) {
#line 83 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 83 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
static void _vala_array_add4 (gchar*** array, int* length, int* size, gchar* value) {
#line 86 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if ((*length) == (*size)) {
#line 86 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 86 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
static void _vala_array_add5 (gchar*** array, int* length, int* size, gchar* value) {
#line 89 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if ((*length) == (*size)) {
#line 89 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 89 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
static void _vala_array_add6 (gchar*** array, int* length, int* size, gchar* value) {
#line 92 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if ((*length) == (*size)) {
#line 92 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 92 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 964 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
	_tmp0_ = separator;
#line 964 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
	if (_tmp0_ == NULL) {
#line 965 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		separator = "";
#line 290 "test-case.c"
	}
#line 967 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
	_tmp3_ = str_array;
#line 967 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 969 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		len = (gsize) 1;
#line 374 "test-case.c"
		{
			gboolean _tmp9_ = FALSE;
#line 970 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
			i = 0;
#line 970 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
			_tmp9_ = TRUE;
#line 970 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 971 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
				_tmp22_ = str_array;
#line 971 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 973 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp31_ = i;
#line 973 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		if (_tmp31_ == 0) {
#line 524 "test-case.c"
			gchar* _tmp32_ = NULL;
#line 974 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
			_tmp32_ = g_strdup ("");
#line 974 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
			result = _tmp32_;
#line 974 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 976 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp33_ = i;
#line 976 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		str_array_length1 = _tmp33_;
#line 976 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp34_ = str_array_length1;
#line 977 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp35_ = len;
#line 977 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp36_ = separator;
#line 977 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 979 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp40_ = len;
#line 979 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp41_ = g_malloc (_tmp40_);
#line 979 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		res = _tmp41_;
#line 980 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp42_ = res;
#line 980 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp43_ = str_array;
#line 980 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 981 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
			i = 1;
#line 981 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
			_tmp46_ = TRUE;
#line 981 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 982 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
				_tmp50_ = ptr;
#line 982 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
				_tmp51_ = separator;
#line 982 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 982 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
				ptr = _tmp52_;
#line 983 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
				_tmp54_ = str_array;
#line 983 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 986 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp62_ = res;
#line 986 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		res = NULL;
#line 986 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 673 "test-case.c"
		...
		gchar* _tmp63_ = NULL;
#line 988 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		_tmp63_ = g_strdup ("");
#line 988 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
		result = _tmp63_;
#line 988 "/opt/gnome3/build/share/vala-0.28/vapi/glib-2.0.vapi"
...
#line 51 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("FOLKS_DEBUG", "all", FALSE);
#line 55 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("GIO_USE_VFS", "local", TRUE);
#line 60 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_unsetenv ("DBUS_STARTER_ADDRESS");
#line 61 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_unsetenv ("DBUS_STARTER_BUS_TYPE");
#line 63 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	folks_test_case_log_adaptor_set_up ();
#line 64 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp0_ = name;
#line 64 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 67 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	folks_test_case_private_bus_up (self);
#line 69 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 729 "test-case.c"
		...
		gchar* _tmp26_ = NULL;
		gchar* _tmp27_ = NULL;
#line 71 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 868 "test-case.c"
		}
#line 94 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp25_ = locations;
#line 94 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 884 "test-case.c"
	}
#line 99 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 131 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	tmp = _tmp0_;
#line 132 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 134 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp2_ == NULL) {
#line 942 "test-case.c"
		gint _tmp3_ = 0;
		const gchar* _tmp4_ = NULL;
#line 135 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp3_ = errno;
#line 135 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp4_ = g_strerror (_tmp3_);
#line 135 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:135: unable to create temporary directory in '%s': %s", tmp, _tmp4_);
#line 951 "test-case.c"
	}
#line 138 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_debug ("test-case.vala:138: setting up in transient directory %s", transient);
#line 141 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("GSETTINGS_BACKEND", "memory", TRUE);
#line 144 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("HOME", transient, TRUE);
#line 148 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 150 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	cache = _tmp5_;
#line 151 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 153 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp6_ != 0) {
#line 971 "test-case.c"
		gint _tmp7_ = 0;
		const gchar* _tmp8_ = NULL;
#line 154 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp7_ = errno;
#line 154 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp8_ = g_strerror (_tmp7_);
#line 154 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:154: unable to create '%s': %s", cache, _tmp8_);
...
#line 157 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	config = _tmp9_;
#line 158 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 161 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp11_ = errno;
#line 161 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp12_ = g_strerror (_tmp11_);
#line 161 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:161: unable to create '%s': %s", config, _tmp12_);
...
#line 164 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	local = _tmp13_;
#line 165 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 167 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp14_ != 0) {
#line 1013 "test-case.c"
		gint _tmp15_ = 0;
		const gchar* _tmp16_ = NULL;
#line 168 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp15_ = errno;
#line 168 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp16_ = g_strerror (_tmp15_);
#line 168 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:168: unable to create '%s': %s", local, _tmp16_);
...
#line 174 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	runtime = _tmp17_;
#line 175 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 177 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp18_ != 0) {
#line 1034 "test-case.c"
		gint _tmp19_ = 0;
		const gchar* _tmp20_ = NULL;
#line 178 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp19_ = errno;
#line 178 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp20_ = g_strerror (_tmp19_);
#line 178 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:178: unable to create '%s': %s", runtime, _tmp20_);
#line 1043 "test-case.c"
	}
#line 182 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp21_ = g_strdup_printf ("%s/dbus-1/system-services", transient);
#line 182 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	dbus_system = _tmp21_;
#line 184 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp22_ = g_mkdir_with_parents (dbus_system, 0700);
#line 184 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp22_ != 0) {
#line 1053 "test-case.c"
		gint _tmp23_ = 0;
		const gchar* _tmp24_ = NULL;
#line 185 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp23_ = errno;
#line 185 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp24_ = g_strerror (_tmp23_);
#line 185 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:185: unable to create '%s': %s", local, _tmp24_);
#line 1062 "test-case.c"
	}
#line 188 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp25_ = g_strdup_printf ("%s/dbus-1/services", transient);
#line 188 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	dbus_session = _tmp25_;
#line 190 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp26_ = g_mkdir_with_parents (dbus_session, 0700);
#line 190 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp26_ != 0) {
#line 1072 "test-case.c"
		gint _tmp27_ = 0;
		const gchar* _tmp28_ = NULL;
#line 191 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp27_ = errno;
#line 191 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp28_ = g_strerror (_tmp27_);
#line 191 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:191: unable to create '%s': %s", local, _tmp28_);
...
#line 203 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_unsetenv ("XDG_VIDEOS_DIR");
#line 205 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	result = transient;
#line 205 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 205 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	return result;
#line 1115 "test-case.c"
}


gchar* folks_test_case_create_transient_dir (FolksTestCase* self) {
#line 129 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 233 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (self != NULL);
#line 233 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (bus_name != NULL);
#line 233 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (dbusmock_template_name != NULL);
#line 237 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp0_ = bus_type;
#line 237 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	switch (_tmp0_) {
#line 237 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		case G_BUS_TYPE_SYSTEM:
#line 1196 "test-case.c"
		{
			gchar* _tmp1_ = NULL;
...
#line 240 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			service_dir = _tmp1_;
#line 241 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			break;
#line 1207 "test-case.c"
		}
#line 237 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		case G_BUS_TYPE_SESSION:
#line 1211 "test-case.c"
		{
			gchar* _tmp2_ = NULL;
...
#line 243 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			service_dir = _tmp2_;
#line 244 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			break;
#line 1222 "test-case.c"
		}
		default:
#line 237 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 1229 "test-case.c"
		{
#line 248 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			g_assert_not_reached ();
#line 1233 "test-case.c"
		}
	}
...
#line 253 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	python = _tmp3_;
#line 254 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (python == NULL) {
#line 256 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:256: %s", "Couldn’t find `python3` in $PATH; can’t run " "python-dbusmock.");
#line 1244 "test-case.c"
	}
#line 262 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 266 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp13_ = bus_name;
#line 266 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 270 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 273 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp23_ = bus_name;
#line 273 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 1302 "test-case.c"
	{
#line 280 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_file_set_contents (service_file_name, service_file, (gssize) (-1), &_inner_error_);
#line 280 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		if (G_UNLIKELY (_inner_error_ != NULL)) {
#line 280 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			if (_inner_error_->domain == G_FILE_ERROR) {
#line 1310 "test-case.c"
...
#line 278 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		e2 = _inner_error_;
#line 278 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_inner_error_ = NULL;
#line 284 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp26_ = e2->message;
#line 284 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_error ("test-case.vala:284: Error creating D-Bus service file ‘%s’: %s", service_file_name, _tmp26_);
#line 278 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_g_error_free0 (e2);
#line 1347 "test-case.c"
	}
	__finally0:
#line 278 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static void folks_test_case_real_private_bus_up (FolksTestCase* self) {
	...
	const gchar* _tmp16_ = NULL;
	gchar* _tmp17_ = NULL;
#line 336 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 341 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 341 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_g_free0 (_tmp6_);
#line 344 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	folks_test_dbus_up (test_system_dbus);
#line 346 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 350 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	test_dbus = _tmp11_;
#line 351 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 351 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_g_free0 (_tmp15_);
#line 353 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	folks_test_dbus_up (test_dbus);
#line 355 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp16_ = folks_test_dbus_get_bus_address (test_dbus);
#line 355 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp17_ = g_strdup (_tmp16_);
#line 355 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	session_bus_address = _tmp17_;
#line 359 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("DBUS_SYSTEM_BUS_ADDRESS", system_bus_address, TRUE);
#line 361 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("DBUS_SESSION_BUS_ADDRESS", session_bus_address, TRUE);
#line 367 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_setenv ("FOLKS_TESTS_SANDBOXED_DBUS", "no-services", TRUE);
#line 333 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 371 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (self != NULL);
#line 373 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp0_ = g_test_get_root ();
#line 373 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp1_ = self->priv->_suite;
#line 373 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_test_suite_add_suite (_tmp0_, _tmp1_);
#line 1527 "test-case.c"
}
...
#line 378 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
void folks_test_case_set_up (FolksTestCase* self) {
#line 391 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (self != NULL);
#line 391 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	FOLKS_TEST_CASE_GET_CLASS (self)->set_up (self);
#line 1573 "test-case.c"
}
...
void folks_test_case_tear_down (FolksTestCase* self) {
#line 402 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (self != NULL);
#line 402 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	FOLKS_TEST_CASE_GET_CLASS (self)->tear_down (self);
#line 1593 "test-case.c"
}
...
#line 425 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 427 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp1_) {
#line 428 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_folks_test_case_dbus_1_set_no_exit_on_disconnect ();
#line 1624 "test-case.c"
	}
#line 441 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp2_ = self->priv->_transient_dir;
#line 441 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp2_ != NULL) {
#line 1630 "test-case.c"
		const gchar* dir = NULL;
		const gchar* _tmp3_ = NULL;
		const gchar* _tmp4_ = NULL;
#line 443 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp3_ = self->priv->_transient_dir;
#line 443 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		dir = (const gchar*) _tmp3_;
#line 444 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp4_ = dir;
#line 444 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		haze_remove_directory (_tmp4_);
#line 1642 "test-case.c"
	}
#line 447 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	exit (0);
#line 449 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp5_ = self->test_dbus;
#line 449 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp5_ != NULL) {
#line 1650 "test-case.c"
...
#line 452 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_g_object_unref0 (self->test_dbus);
#line 452 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		self->test_dbus = NULL;
#line 1660 "test-case.c"
	}
...
#line 457 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp8_ = self->test_system_dbus;
#line 457 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		folks_test_dbus_down (G_TYPE_CHECK_INSTANCE_CAST (_tmp8_, FOLKS_TYPE_TEST_DBUS, FolksTestDBus));
#line 458 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_g_object_unref0 (self->test_system_dbus);
#line 458 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		self->test_system_dbus = NULL;
#line 1676 "test-case.c"
	}
}


void folks_test_case_final_tear_down (FolksTestCase* self) {
#line 423 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_if_fail (self != NULL);
#line 423 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	FOLKS_TEST_CASE_GET_CLASS (self)->final_tear_down (self);
#line 1686 "test-case.c"
}
...
const gchar* folks_test_case_get_transient_dir (FolksTestCase* self) {
	...
	const gchar* _tmp0_ = NULL;
	const gchar* _tmp1_ = NULL;
#line 111 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	g_return_val_if_fail (self != NULL, NULL);
...
#line 114 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp1_ = self->priv->_transient_dir;
#line 114 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	result = (const gchar*) _tmp1_;
#line 114 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	return result;
#line 1706 "test-case.c"
}


gboolean folks_test_case_get_uses_dbus_1 (FolksTestCase* self) {
#line 318 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 318 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	self = base;
#line 320 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	result = FALSE;
#line 320 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	return result;
#line 1728 "test-case.c"
}


static FolksTestCaseLogAdaptor* folks_test_case_log_adaptor_construct (GType object_type) {
	FolksTestCaseLogAdaptor* self = NULL;
#line 469 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	self = (FolksTestCaseLogAdaptor*) g_type_create_instance (object_type);
#line 469 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	return self;
#line 1738 "test-case.c"
}
...
#line 1745 "test-case.c"
}


static void __folks_test_case_log_adaptor_printerr_func_stack_trace_gprint_func (const gchar* text) {
#line 475 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
static void _folks_test_case_log_adaptor_printerr_func_stack_trace (const gchar* text) {
	...
	FILE* _tmp5_ = NULL;
	const gchar* _tmp6_ = NULL;
#line 481 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp1_ = text;
#line 481 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp1_ == NULL) {
#line 481 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 481 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		_tmp0_ = _tmp4_;
#line 1796 "test-case.c"
	}
#line 481 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp0_) {
#line 482 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		return;
#line 1802 "test-case.c"
	}
#line 484 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp5_ = stderr;
#line 484 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp6_ = text;
#line 484 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	fprintf (_tmp5_, "%s", _tmp6_);
#line 487 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 490 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 499 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	_tmp4_ = folks_test_case_in_final_tear_down;
#line 499 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	if (_tmp4_) {
#line 500 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		return;
#line 1844 "test-case.c"
	}
...
#line 509 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		g_on_error_stack_trace ("libtool --mode=execute gdb");
#line 1852 "test-case.c"
	}
}


static void folks_test_case_value_log_adaptor_init (GValue* value) {
#line 467 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	value->data[0].v_pointer = NULL;
#line 1860 "test-case.c"
}
...
#line 1879 "test-case.c"
	} else {
#line 467 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		dest_value->data[0].v_pointer = NULL;
#line 1883 "test-case.c"
	}
}
...
#line 1905 "test-case.c"
		} else if (!g_value_type_compatible (G_TYPE_FROM_INSTANCE (object), G_VALUE_TYPE (value))) {
#line 467 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
			return g_strconcat ("invalid object type `", g_type_name (G_TYPE_FROM_INSTANCE (object)), "' for value type `", G_VALUE_TYPE_NAME (value), "'", NULL);
#line 1909 "test-case.c"
		}
#line 467 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		value->data[0].v_pointer = folks_test_case_log_adaptor_ref (object);
#line 1913 "test-case.c"
	} else {
#line 467 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		value->data[0].v_pointer = NULL;
#line 1917 "test-case.c"
	}
#line 467 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	return NULL;
#line 1921 "test-case.c"
}
...
#line 102 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	self->priv->_transient_dir = NULL;
#line 297 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	self->test_dbus = NULL;
#line 307 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
	self->test_system_dbus = NULL;
#line 2155 "test-case.c"
}
...
#line 464 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
...
#line 35 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		break;
#line 2214 "test-case.c"
		default:
#line 35 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 35 "/opt/gnome3/source/folks/tests/lib/test-case.vala"
		break;
#line 2220 "test-case.c"
	}
}
