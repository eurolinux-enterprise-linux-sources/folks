...
#line 41 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 43 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	_tmp0_ = name;
#line 43 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	self = (KfTestTestCase*) folks_test_case_construct (object_type, _tmp0_);
#line 45 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	_tmp1_ = kf_test_backend_new ();
#line 45 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	_kf_test_backend_unref0 (self->kf_backend);
#line 45 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	self->kf_backend = _tmp1_;
#line 47 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	g_setenv ("FOLKS_BACKENDS_ALLOWED", "key-file", TRUE);
#line 48 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
...
#line 60 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
...
#line 51 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
...
#line 60 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	context = _tmp1_;
#line 61 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	while (TRUE) {
...
#line 63 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
...
#line 27 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
...
#line 39 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
	_kf_test_backend_unref0 (self->kf_backend);
#line 27 "/opt/gnome3/source/folks/tests/lib/key-file/test-case.vala"
