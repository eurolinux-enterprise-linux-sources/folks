/* fullname-updates.c generated by valac 0.26.2.1-1f25, the Vala compiler
...
static void _fullname_updates_tests_test_fullname_updates_folks_test_case_test_method (gpointer self) {
#line 42 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 40 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 38 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	return self;
#line 132 "fullname-updates.c"
}
...
#line 45 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_return_if_fail (self != NULL);
#line 47 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 47 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 47 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_main_loop = _tmp0_;
#line 48 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp1_ = g_strdup ("persona #1");
#line 48 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_initial_fullname);
#line 48 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_initial_fullname = _tmp1_;
#line 49 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp2_ = g_strdup ("updated persona #1");
#line 49 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_updated_fullname);
#line 49 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_updated_fullname = _tmp2_;
#line 50 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp3_ = g_strdup ("<urn:contact001>");
#line 50 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_contact_urn);
#line 50 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_contact_urn = _tmp3_;
#line 51 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 57 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 59 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_initial_name_found = FALSE;
#line 60 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_updated_name_found = FALSE;
#line 61 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_deleted_name_found = FALSE;
#line 62 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp9_ = g_strdup ("");
#line 62 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_individual_id);
#line 62 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	self->priv->_individual_id = _tmp9_;
#line 64 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_fullname_updates_tests_test_fullname_updates_async (self, NULL, NULL);
#line 66 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp10_ = self->priv->_main_loop;
#line 66 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	folks_test_utils_loop_run_with_timeout (_tmp10_, 5);
#line 68 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp11_ = self->priv->_initial_name_found;
#line 68 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_vala_assert (_tmp11_ == TRUE, "this._initial_name_found == true");
#line 69 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp12_ = self->priv->_updated_name_found;
#line 69 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_vala_assert (_tmp12_ == TRUE, "this._updated_name_found == true");
#line 45 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (c1);
#line 232 "fullname-updates.c"
}
...
static void _fullname_updates_tests_test_fullname_updates_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 26 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (_data_->self);
#line 26 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_slice_free (FullnameUpdatesTestsTestFullnameUpdatesAsyncData, _data_);
#line 243 "fullname-updates.c"
}
...
#line 250 "fullname-updates.c"
}


static void _fullname_updates_tests_test_fullname_updates_async (FullnameUpdatesTests* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FullnameUpdatesTestsTestFullnameUpdatesAsyncData* _data_;
	FullnameUpdatesTests* _tmp0_ = NULL;
#line 26 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 277 "fullname-updates.c"
}


static void _fullname_updates_tests_test_fullname_updates_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	FullnameUpdatesTestsTestFullnameUpdatesAsyncData* _data_;
#line 75 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_data_ = _user_data_;
#line 75 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 75 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_fullname_updates_tests_test_fullname_updates_async_co (_data_);
#line 291 "fullname-updates.c"
}


static void __fullname_updates_tests_individuals_changed_cb_folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
#line 77 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_fullname_updates_tests_individuals_changed_cb ((FullnameUpdatesTests*) self, changes);
#line 298 "fullname-updates.c"
}


static gboolean _fullname_updates_tests_test_fullname_updates_async_co (FullnameUpdatesTestsTestFullnameUpdatesAsyncData* _data_) {
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	switch (_data_->_state_) {
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		case 0:
#line 307 "fullname-updates.c"
		goto _state_0;
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		case 1:
#line 311 "fullname-updates.c"
		goto _state_1;
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		case 2:
#line 315 "fullname-updates.c"
		goto _state_2;
		default:
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 320 "fullname-updates.c"
	...
	_state_0:
#line 74 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_data_->_tmp0_ = NULL;
#line 74 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 75 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	return FALSE;
#line 335 "fullname-updates.c"
	_state_1:
#line 75 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	folks_backend_store_prepare_finish (_data_->store, _data_->_res_);
#line 76 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_data_->_tmp1_ = NULL;
#line 76 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 353 "fullname-updates.c"
	{
#line 81 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_data_->_tmp3_ = NULL;
#line 81 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 371 "fullname-updates.c"
	...
	__catch0_g_error:
	{
#line 79 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_data_->e = _data_->_inner_error_;
#line 79 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_data_->_inner_error_ = NULL;
#line 85 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_data_->_tmp4_ = NULL;
#line 85 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 415 "fullname-updates.c"
	} else {
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 419 "fullname-updates.c"
	}
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_object_unref (_data_->_async_result);
#line 72 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	return FALSE;
#line 425 "fullname-updates.c"
}


static void __fullname_updates_tests_notify_full_name_cb_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
#line 101 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_fullname_updates_tests_notify_full_name_cb ((FullnameUpdatesTests*) self, _sender, pspec);
#line 432 "fullname-updates.c"
}
...
static void _fullname_updates_tests_individuals_changed_cb (FullnameUpdatesTests* self, GeeMultiMap* changes) {
	...
	gint _tmp24_ = 0;
	gint _tmp25_ = 0;
#line 89 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_return_if_fail (self != NULL);
#line 89 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_return_if_fail (changes != NULL);
#line 92 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp0_ = changes;
#line 92 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp1_ = gee_multi_map_get_values (_tmp0_);
#line 92 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	added = _tmp1_;
#line 93 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp2_ = changes;
#line 93 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 95 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_tmp4_ = added;
#line 95 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 97 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_tmp10_ = i;
#line 97 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_vala_assert (_tmp10_ != NULL, "i != null");
#line 99 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_tmp11_ = i;
#line 99 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 102 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
				_tmp16_ = i;
#line 102 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 103 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
				self->priv->_initial_name_found = TRUE;
#line 104 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 551 "fullname-updates.c"
			}
#line 95 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_g_object_unref0 (i);
#line 555 "fullname-updates.c"
		}
#line 95 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_g_object_unref0 (_i_it);
#line 559 "fullname-updates.c"
	}
#line 109 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp23_ = removed;
#line 109 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 569 "fullname-updates.c"
	{
		GeeIterator* _i_it = NULL;
		GeeSet* _tmp26_ = NULL;
		GeeIterator* _tmp27_ = NULL;
#line 111 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_tmp26_ = removed;
#line 111 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 113 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_tmp32_ = i;
#line 113 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_vala_assert (_tmp32_ == NULL, "i == null");
#line 111 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
			_g_object_unref0 (i);
#line 611 "fullname-updates.c"
		}
#line 111 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_g_object_unref0 (_i_it);
#line 615 "fullname-updates.c"
	}
#line 89 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (removed);
#line 89 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (added);
#line 621 "fullname-updates.c"
}
...
static void _fullname_updates_tests_notify_full_name_cb (FullnameUpdatesTests* self, GObject* individual_obj, GParamSpec* ps) {
	...
	const gchar* _tmp5_ = NULL;
#line 117 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_return_if_fail (self != NULL);
#line 117 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_return_if_fail (individual_obj != NULL);
#line 117 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_return_if_fail (ps != NULL);
#line 119 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp0_ = individual_obj;
#line 119 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp1_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, FOLKS_TYPE_INDIVIDUAL, FolksIndividual));
#line 119 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	i = _tmp1_;
#line 121 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp2_ = i;
#line 121 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
...
#line 655 "fullname-updates.c"
		GMainLoop* _tmp6_ = NULL;
#line 123 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		self->priv->_updated_name_found = TRUE;
#line 124 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		_tmp6_ = self->priv->_main_loop;
#line 124 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
		g_main_loop_quit (_tmp6_);
#line 663 "fullname-updates.c"
	}
#line 117 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (i);
#line 667 "fullname-updates.c"
}
...
#line 28 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 29 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (self->priv->_aggregator);
#line 32 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_updated_fullname);
#line 33 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_individual_id);
#line 34 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_initial_fullname);
#line 35 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_free0 (self->priv->_contact_urn);
#line 26 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	G_OBJECT_CLASS (fullname_updates_tests_parent_class)->finalize (obj);
#line 707 "fullname-updates.c"
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	FullnameUpdatesTests* _tmp0_ = NULL;
#line 131 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_test_init (&args_length1, &args, NULL);
#line 133 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_tmp0_ = fullname_updates_tests_new ();
#line 133 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	tests = _tmp0_;
#line 134 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 135 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	g_test_run ();
#line 136 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 138 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	result = 0;
#line 138 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	_g_object_unref0 (tests);
#line 138 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	return result;
#line 745 "fullname-updates.c"
}
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 129 "/opt/gnome3/source/folks/tests/tracker/fullname-updates.vala"
	return _vala_main (argv, argc);
#line 755 "fullname-updates.c"
}
