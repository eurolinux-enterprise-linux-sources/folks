/* suffix-name-updates.c generated by valac 0.35.3.10-6b27, the Vala compiler
...
static void _suffix_name_updates_tests_test_suffix_name_updates_folks_test_case_test_method (gpointer self) {
#line 43 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 41 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 39 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	return self;
...
void suffix_name_updates_tests_test_suffix_name_updates (SuffixNameUpdatesTests* self) {
	...
	gboolean _tmp13_;
	gboolean _tmp14_;
#line 46 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (self != NULL);
#line 48 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 48 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 48 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_main_loop = _tmp0_;
#line 49 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 60 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 62 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_initial_suffix_name_found = FALSE;
#line 63 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_updated_suffix_name_found = FALSE;
#line 64 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_deleted_suffix_name_found = FALSE;
#line 65 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp11_ = g_strdup ("");
#line 65 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_individual_id);
#line 65 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_individual_id = _tmp11_;
#line 67 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_suffix_name_updates_tests_test_suffix_name_updates_async (self, NULL, NULL);
#line 69 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp12_ = self->priv->_main_loop;
#line 69 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_utils_loop_run_with_timeout (_tmp12_, 5);
#line 71 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp13_ = self->priv->_initial_suffix_name_found;
#line 71 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_vala_assert (_tmp13_ == TRUE, "this._initial_suffix_name_found == true");
#line 72 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
static void _suffix_name_updates_tests_test_suffix_name_updates_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 26 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
static void _suffix_name_updates_tests_test_suffix_name_updates_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	SuffixNameUpdatesTestsTestSuffixNameUpdatesAsyncData* _data_;
#line 78 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_data_ = _user_data_;
#line 78 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
static void __suffix_name_updates_tests_individuals_changed_cb_folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
#line 80 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
static gboolean _suffix_name_updates_tests_test_suffix_name_updates_async_co (SuffixNameUpdatesTestsTestSuffixNameUpdatesAsyncData* _data_) {
#line 75 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 336 "suffix-name-updates.c"
	...
	_state_0:
#line 77 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 78 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	return FALSE;
#line 349 "suffix-name-updates.c"
	_state_1:
#line 78 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_backend_store_prepare_finish (_data_->store, _data_->_res_);
#line 79 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 363 "suffix-name-updates.c"
	{
#line 84 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 379 "suffix-name-updates.c"
	...
	__catch0_g_error:
	{
#line 82 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		_data_->e = _data_->_inner_error_;
#line 82 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		_data_->_inner_error_ = NULL;
#line 88 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 82 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		return FALSE;
#line 411 "suffix-name-updates.c"
	}
#line 75 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (_data_->store);
#line 75 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 419 "suffix-name-updates.c"
	} else {
#line 75 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 75 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	return FALSE;
#line 429 "suffix-name-updates.c"
}


static void __suffix_name_updates_tests_notify_suffix_name_cb_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
#line 107 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_suffix_name_updates_tests_notify_suffix_name_cb ((SuffixNameUpdatesTests*) self, _sender, pspec);
#line 436 "suffix-name-updates.c"
}
...
static void _suffix_name_updates_tests_individuals_changed_cb (SuffixNameUpdatesTests* self, GeeMultiMap* changes) {
	...
	gint _tmp34_;
	gint _tmp35_;
#line 92 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (self != NULL);
#line 92 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (changes != NULL);
#line 95 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp0_ = changes;
#line 95 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp1_ = gee_multi_map_get_values (_tmp0_);
#line 95 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	added = _tmp1_;
#line 96 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp2_ = changes;
#line 96 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp3_ = gee_multi_map_get_keys (_tmp2_);
#line 96 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	removed = _tmp3_;
#line 466 "suffix-name-updates.c"
	{
		GeeIterator* _i_it;
		GeeCollection* _tmp4_;
		GeeIterator* _tmp5_;
#line 98 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		_tmp4_ = added;
#line 98 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 98 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		while (TRUE) {
#line 479 "suffix-name-updates.c"
			GeeIterator* _tmp6_;
			gboolean _tmp7_;
			FolksIndividual* i;
			GeeIterator* _tmp8_;
...
#line 98 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				break;
#line 498 "suffix-name-updates.c"
			}
#line 98 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp8_ = _i_it;
#line 98 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 100 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp10_ = i;
#line 100 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
			_vala_assert (_tmp10_ != NULL, "i != null");
#line 102 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 520 "suffix-name-updates.c"
				gchar* suffix_name;
				...
				const gchar* _tmp21_;
				const gchar* _tmp22_;
#line 104 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				_tmp15_ = i;
#line 104 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 104 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				suffix_name = _tmp20_;
#line 105 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				_tmp21_ = suffix_name;
#line 105 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				_tmp22_ = self->priv->_initial_suffix_name;
#line 105 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				if (g_strcmp0 (_tmp21_, _tmp22_) == 0) {
#line 550 "suffix-name-updates.c"
...
#line 109 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
					_tmp26_ = i;
#line 109 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 110 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
					self->priv->_initial_suffix_name_found = TRUE;
#line 111 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 591 "suffix-name-updates.c"
				}
#line 102 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 117 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp33_ = removed;
#line 117 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 613 "suffix-name-updates.c"
	{
		GeeIterator* _i_it;
		GeeSet* _tmp36_;
		GeeIterator* _tmp37_;
#line 119 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		_tmp36_ = removed;
#line 119 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 119 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		while (TRUE) {
#line 626 "suffix-name-updates.c"
			GeeIterator* _tmp38_;
			gboolean _tmp39_;
			FolksIndividual* i;
			GeeIterator* _tmp40_;
...
#line 119 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
				break;
#line 641 "suffix-name-updates.c"
			}
#line 119 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp40_ = _i_it;
#line 119 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 121 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp42_ = i;
#line 121 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 665 "suffix-name-updates.c"
}
...
static void _suffix_name_updates_tests_notify_suffix_name_cb (SuffixNameUpdatesTests* self, GObject* individual_obj, GParamSpec* ps) {
	...
	const gchar* _tmp6_;
	const gchar* _tmp7_;
#line 125 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (self != NULL);
#line 125 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (individual_obj != NULL);
#line 125 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (ps != NULL);
#line 127 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 127 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	sname = _tmp1_;
#line 128 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp2_ = sname;
#line 128 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 128 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	suffix_name = _tmp5_;
#line 129 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp6_ = suffix_name;
#line 129 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp7_ = self->priv->_updated_suffix_name;
#line 129 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	if (g_strcmp0 (_tmp6_, _tmp7_) == 0) {
#line 708 "suffix-name-updates.c"
		GMainLoop* _tmp8_;
#line 131 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		self->priv->_updated_suffix_name_found = TRUE;
#line 132 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		_tmp8_ = self->priv->_main_loop;
#line 132 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
		g_main_loop_quit (_tmp8_);
#line 716 "suffix-name-updates.c"
	}
#line 125 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (suffix_name);
#line 125 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (sname);
#line 722 "suffix-name-updates.c"
}
...
#line 733 "suffix-name-updates.c"
}
...
#line 740 "suffix-name-updates.c"
}
...
#line 28 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 29 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (self->priv->_aggregator);
#line 33 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_updated_suffix_name);
#line 34 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_individual_id);
#line 35 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_initial_fullname);
#line 36 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_initial_suffix_name);
#line 37 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_contact_urn);
#line 26 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	G_OBJECT_CLASS (suffix_name_updates_tests_parent_class)->finalize (obj);
#line 764 "suffix-name-updates.c"
}
...
gint _vala_main (gchar** args, int args_length1) {
	gint result = 0;
	SuffixNameUpdatesTests* tests;
	SuffixNameUpdatesTests* _tmp0_;
#line 139 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_test_init (&args_length1, &args, NULL);
#line 141 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp0_ = suffix_name_updates_tests_new ();
#line 141 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	tests = _tmp0_;
#line 142 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 143 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	g_test_run ();
#line 144 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 146 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	result = 0;
#line 146 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (tests);
#line 146 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	return result;
#line 802 "suffix-name-updates.c"
}
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 137 "/opt/gnome/source/folks/tests/tracker/suffix-name-updates.vala"
	return _vala_main (argv, argc);
#line 812 "suffix-name-updates.c"
}
