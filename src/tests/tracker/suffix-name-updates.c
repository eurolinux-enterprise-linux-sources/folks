/* suffix-name-updates.c generated by valac 0.26.2.1-1f25, the Vala compiler
...
static void _suffix_name_updates_tests_test_suffix_name_updates_folks_test_case_test_method (gpointer self) {
#line 43 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	suffix_name_updates_tests_test_suffix_name_updates ((SuffixNameUpdatesTests*) self);
...
#line 41 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	self = (SuffixNameUpdatesTests*) tracker_test_test_case_construct (object_type, "SuffixNameUpdates");
#line 43 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "suffix name updates", _suffix_name_updates_tests_test_suffix_name_updates_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 39 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	return self;
#line 133 "suffix-name-updates.c"
}
...
#line 140 "suffix-name-updates.c"
}
...
#line 46 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (self != NULL);
#line 48 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 48 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 48 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_main_loop = _tmp0_;
#line 49 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 60 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 62 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_initial_suffix_name_found = FALSE;
#line 63 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_updated_suffix_name_found = FALSE;
#line 64 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_deleted_suffix_name_found = FALSE;
#line 65 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp11_ = g_strdup ("");
#line 65 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_individual_id);
#line 65 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	self->priv->_individual_id = _tmp11_;
#line 67 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_suffix_name_updates_tests_test_suffix_name_updates_async (self, NULL, NULL);
#line 69 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp12_ = self->priv->_main_loop;
#line 69 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_utils_loop_run_with_timeout (_tmp12_, 5);
#line 71 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp13_ = self->priv->_initial_suffix_name_found;
#line 71 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_vala_assert (_tmp13_ == TRUE, "this._initial_suffix_name_found == true");
#line 72 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp14_ = self->priv->_updated_suffix_name_found;
#line 72 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_vala_assert (_tmp14_ == TRUE, "this._updated_suffix_name_found == true");
#line 46 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (c1);
#line 245 "suffix-name-updates.c"
}
...
static void _suffix_name_updates_tests_test_suffix_name_updates_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 26 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (_data_->self);
#line 26 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_slice_free (SuffixNameUpdatesTestsTestSuffixNameUpdatesAsyncData, _data_);
#line 256 "suffix-name-updates.c"
}
...
#line 263 "suffix-name-updates.c"
}


static void _suffix_name_updates_tests_test_suffix_name_updates_async (SuffixNameUpdatesTests* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	SuffixNameUpdatesTestsTestSuffixNameUpdatesAsyncData* _data_;
	SuffixNameUpdatesTests* _tmp0_ = NULL;
#line 26 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 282 "suffix-name-updates.c"
}
...
#line 290 "suffix-name-updates.c"
}


static void _suffix_name_updates_tests_test_suffix_name_updates_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	SuffixNameUpdatesTestsTestSuffixNameUpdatesAsyncData* _data_;
#line 78 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_data_ = _user_data_;
#line 78 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 78 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_suffix_name_updates_tests_test_suffix_name_updates_async_co (_data_);
#line 304 "suffix-name-updates.c"
}


static void __suffix_name_updates_tests_individuals_changed_cb_folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
#line 80 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_suffix_name_updates_tests_individuals_changed_cb ((SuffixNameUpdatesTests*) self, changes);
#line 311 "suffix-name-updates.c"
}


static gboolean _suffix_name_updates_tests_test_suffix_name_updates_async_co (SuffixNameUpdatesTestsTestSuffixNameUpdatesAsyncData* _data_) {
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	switch (_data_->_state_) {
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		case 0:
#line 320 "suffix-name-updates.c"
		goto _state_0;
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		case 1:
#line 324 "suffix-name-updates.c"
		goto _state_1;
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		case 2:
#line 328 "suffix-name-updates.c"
		goto _state_2;
		default:
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 333 "suffix-name-updates.c"
	...
	_state_0:
#line 77 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_data_->_tmp0_ = NULL;
#line 77 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 78 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	return FALSE;
#line 348 "suffix-name-updates.c"
	_state_1:
#line 78 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_backend_store_prepare_finish (_data_->store, _data_->_res_);
#line 79 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_data_->_tmp1_ = NULL;
#line 79 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 366 "suffix-name-updates.c"
	{
#line 84 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_data_->_tmp3_ = NULL;
#line 84 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 384 "suffix-name-updates.c"
	...
	__catch0_g_error:
	{
#line 82 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_data_->e = _data_->_inner_error_;
#line 82 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_data_->_inner_error_ = NULL;
#line 88 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_data_->_tmp4_ = NULL;
#line 88 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 88 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		g_warning ("suffix-name-updates.vala:88: Error when calling prepare: %s\n", _data_->_tmp5_);
#line 82 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_g_error_free0 (_data_->e);
#line 407 "suffix-name-updates.c"
	}
	__finally0:
#line 82 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
#line 82 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		return FALSE;
#line 420 "suffix-name-updates.c"
	}
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (_data_->store);
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 428 "suffix-name-updates.c"
	} else {
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 432 "suffix-name-updates.c"
	}
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_object_unref (_data_->_async_result);
#line 75 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	return FALSE;
#line 438 "suffix-name-updates.c"
}


static void __suffix_name_updates_tests_notify_suffix_name_cb_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
#line 107 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_suffix_name_updates_tests_notify_suffix_name_cb ((SuffixNameUpdatesTests*) self, _sender, pspec);
#line 445 "suffix-name-updates.c"
}
...
static void _suffix_name_updates_tests_individuals_changed_cb (SuffixNameUpdatesTests* self, GeeMultiMap* changes) {
	...
	gint _tmp34_ = 0;
	gint _tmp35_ = 0;
#line 92 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (self != NULL);
#line 92 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (changes != NULL);
#line 95 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp0_ = changes;
#line 95 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp1_ = gee_multi_map_get_values (_tmp0_);
#line 95 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	added = _tmp1_;
#line 96 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp2_ = changes;
#line 96 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_tmp4_ = added;
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		while (TRUE) {
#line 488 "suffix-name-updates.c"
...
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				break;
#line 507 "suffix-name-updates.c"
			}
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp8_ = _i_it;
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 100 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp10_ = i;
#line 100 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_vala_assert (_tmp10_ != NULL, "i != null");
#line 102 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 529 "suffix-name-updates.c"
...
#line 104 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				_tmp15_ = i;
#line 104 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 104 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				suffix_name = _tmp20_;
#line 105 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				_tmp21_ = suffix_name;
#line 105 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				_tmp22_ = self->priv->_initial_suffix_name;
#line 105 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				if (g_strcmp0 (_tmp21_, _tmp22_) == 0) {
#line 559 "suffix-name-updates.c"
...
#line 109 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
					_tmp26_ = i;
#line 109 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 110 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
					self->priv->_initial_suffix_name_found = TRUE;
#line 111 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 600 "suffix-name-updates.c"
				}
#line 102 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				_g_free0 (suffix_name);
#line 604 "suffix-name-updates.c"
			}
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_g_object_unref0 (i);
#line 608 "suffix-name-updates.c"
		}
#line 98 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_g_object_unref0 (_i_it);
#line 612 "suffix-name-updates.c"
	}
#line 117 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp33_ = removed;
#line 117 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 622 "suffix-name-updates.c"
	{
		GeeIterator* _i_it = NULL;
		GeeSet* _tmp36_ = NULL;
		GeeIterator* _tmp37_ = NULL;
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_tmp36_ = removed;
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		while (TRUE) {
#line 635 "suffix-name-updates.c"
...
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
				break;
#line 650 "suffix-name-updates.c"
			}
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp40_ = _i_it;
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 121 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_tmp42_ = i;
#line 121 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_vala_assert (_tmp42_ == NULL, "i == null");
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
			_g_object_unref0 (i);
#line 664 "suffix-name-updates.c"
		}
#line 119 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_g_object_unref0 (_i_it);
#line 668 "suffix-name-updates.c"
	}
#line 92 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (removed);
#line 92 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (added);
#line 674 "suffix-name-updates.c"
}
...
static void _suffix_name_updates_tests_notify_suffix_name_cb (SuffixNameUpdatesTests* self, GObject* individual_obj, GParamSpec* ps) {
	...
	const gchar* _tmp6_ = NULL;
	const gchar* _tmp7_ = NULL;
#line 125 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (self != NULL);
#line 125 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (individual_obj != NULL);
#line 125 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_return_if_fail (ps != NULL);
#line 127 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 127 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	sname = _tmp1_;
#line 128 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp2_ = sname;
#line 128 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
...
#line 128 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	suffix_name = _tmp5_;
#line 129 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp6_ = suffix_name;
#line 129 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp7_ = self->priv->_updated_suffix_name;
#line 129 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	if (g_strcmp0 (_tmp6_, _tmp7_) == 0) {
#line 717 "suffix-name-updates.c"
		GMainLoop* _tmp8_ = NULL;
#line 131 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		self->priv->_updated_suffix_name_found = TRUE;
#line 132 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		_tmp8_ = self->priv->_main_loop;
#line 132 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
		g_main_loop_quit (_tmp8_);
#line 725 "suffix-name-updates.c"
	}
#line 125 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (suffix_name);
#line 125 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (sname);
#line 731 "suffix-name-updates.c"
}
...
#line 742 "suffix-name-updates.c"
}
...
#line 749 "suffix-name-updates.c"
}
...
#line 28 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 29 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (self->priv->_aggregator);
#line 33 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_updated_suffix_name);
#line 34 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_individual_id);
#line 35 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_initial_fullname);
#line 36 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_initial_suffix_name);
#line 37 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_free0 (self->priv->_contact_urn);
#line 26 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	G_OBJECT_CLASS (suffix_name_updates_tests_parent_class)->finalize (obj);
#line 773 "suffix-name-updates.c"
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	SuffixNameUpdatesTests* _tmp0_ = NULL;
#line 139 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_test_init (&args_length1, &args, NULL);
#line 141 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_tmp0_ = suffix_name_updates_tests_new ();
#line 141 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	tests = _tmp0_;
#line 142 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 143 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	g_test_run ();
#line 144 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 146 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	result = 0;
#line 146 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	_g_object_unref0 (tests);
#line 146 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	return result;
#line 811 "suffix-name-updates.c"
}
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 137 "/opt/gnome3/source/folks/tests/tracker/suffix-name-updates.vala"
	return _vala_main (argv, argc);
#line 821 "suffix-name-updates.c"
}
