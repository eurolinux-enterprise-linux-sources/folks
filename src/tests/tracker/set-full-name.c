/* set-full-name.c generated by valac 0.20.1.30-1b1d, the Vala compiler
...
static void _set_full_name_tests_test_set_full_name_folks_test_case_test_method (gpointer self) {
#line 39 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	set_full_name_tests_test_set_full_name (self);
...
#line 37 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	self = (SetFullNameTests*) tracker_test_test_case_construct (object_type, "SetFullNameTests");
#line 39 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "test setting structured name ", _set_full_name_tests_test_set_full_name_folks_test_case_test_method, self);
#line 35 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	return self;
...
void set_full_name_tests_test_set_full_name (SetFullNameTests* self) {
	...
	GMainLoop* _tmp8_;
	gboolean _tmp9_;
#line 43 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_return_if_fail (self != NULL);
#line 45 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 45 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 45 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	self->priv->_main_loop = _tmp0_;
#line 46 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 54 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 56 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	self->priv->_found_changed_full_name = FALSE;
#line 58 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_set_full_name_tests_test_set_full_name_async (self, NULL, NULL);
#line 60 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp8_ = self->priv->_main_loop;
#line 60 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	folks_test_utils_loop_run_with_timeout (_tmp8_, 5);
#line 62 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
static void _set_full_name_tests_test_set_full_name_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 26 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
static void _set_full_name_tests_test_set_full_name_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	SetFullNameTestsTestSetFullNameAsyncData* _data_;
#line 68 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_data_ = _user_data_;
#line 68 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
static void __set_full_name_tests_individuals_changed_cb_folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
#line 70 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_set_full_name_tests_individuals_changed_cb (self, changes);
#line 274 "set-full-name.c"
}


static gboolean _set_full_name_tests_test_set_full_name_async_co (SetFullNameTestsTestSetFullNameAsyncData* _data_) {
#line 65 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 296 "set-full-name.c"
	...
	_state_0:
#line 67 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_data_->_tmp0_ = NULL;
#line 67 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 69 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 325 "set-full-name.c"
	{
#line 74 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 341 "set-full-name.c"
	...
	__catch0_g_error:
	{
#line 72 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_data_->e = _data_->_inner_error_;
#line 72 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_data_->_inner_error_ = NULL;
#line 78 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 381 "set-full-name.c"
	} else {
#line 65 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 385 "set-full-name.c"
	}
#line 65 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
static void __set_full_name_tests_notify_full_name_cb_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
#line 95 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_set_full_name_tests_notify_full_name_cb (self, _sender, pspec);
#line 398 "set-full-name.c"
}
...
static void _set_full_name_tests_individuals_changed_cb (SetFullNameTests* self, GeeMultiMap* changes) {
	...
	gint _tmp31_;
	gint _tmp32_;
#line 82 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_return_if_fail (self != NULL);
#line 82 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_return_if_fail (changes != NULL);
#line 85 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp0_ = changes;
#line 85 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp1_ = gee_multi_map_get_values (_tmp0_);
#line 85 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	added = _tmp1_;
#line 86 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp2_ = changes;
#line 86 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp3_ = gee_multi_map_get_keys (_tmp2_);
#line 86 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	removed = _tmp3_;
#line 428 "set-full-name.c"
	{
		GeeIterator* _i_it = NULL;
		GeeCollection* _tmp4_;
		GeeIterator* _tmp5_ = NULL;
#line 88 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_tmp4_ = added;
#line 88 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 90 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_tmp10_ = i;
#line 90 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_vala_assert (_tmp10_ != NULL, "i != null");
#line 92 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_tmp11_ = i;
#line 92 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 482 "set-full-name.c"
				FolksIndividual* _tmp15_;
				const gchar* _tmp16_;
				const gchar* _tmp17_;
				gchar* _tmp18_;
				FolksIndividual* _tmp19_;
#line 94 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
				_tmp15_ = i;
#line 94 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 97 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
					_tmp20_ = i;
#line 97 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 99 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
						_tmp28_ = p;
#line 99 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 97 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
						_g_object_unref0 (p);
#line 555 "set-full-name.c"
					}
#line 97 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
					_g_object_unref0 (_p_it);
#line 559 "set-full-name.c"
				}
			}
#line 88 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_g_object_unref0 (i);
#line 564 "set-full-name.c"
		}
#line 88 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_g_object_unref0 (_i_it);
#line 568 "set-full-name.c"
	}
#line 104 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp30_ = removed;
#line 104 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 106 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_tmp33_ = removed;
#line 106 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 108 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_tmp39_ = i;
#line 108 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_vala_assert (_tmp39_ == NULL, "i == null");
#line 106 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
			_g_object_unref0 (i);
#line 620 "set-full-name.c"
		}
#line 106 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_g_object_unref0 (_i_it);
#line 624 "set-full-name.c"
	}
#line 82 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
static void _set_full_name_tests_notify_full_name_cb (SetFullNameTests* self, GObject* individual, GParamSpec* ps) {
	...
	const gchar* _tmp6_;
	gboolean _tmp11_;
#line 112 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_return_if_fail (self != NULL);
#line 112 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_return_if_fail (individual != NULL);
#line 112 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_return_if_fail (ps != NULL);
#line 114 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp0_ = individual;
#line 114 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp1_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, FOLKS_TYPE_INDIVIDUAL, FolksIndividual));
#line 114 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	i = _tmp1_;
#line 115 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp3_ = i;
#line 115 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 666 "set-full-name.c"
		FolksIndividual* _tmp7_;
		const gchar* _tmp8_;
		const gchar* _tmp9_;
		const gchar* _tmp10_;
#line 116 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_tmp7_ = i;
#line 116 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
...
#line 681 "set-full-name.c"
	} else {
#line 115 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_tmp2_ = FALSE;
#line 685 "set-full-name.c"
	}
#line 115 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp11_ = _tmp2_;
#line 115 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	if (_tmp11_) {
#line 691 "set-full-name.c"
		GMainLoop* _tmp12_;
#line 118 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		self->priv->_found_changed_full_name = TRUE;
#line 119 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		_tmp12_ = self->priv->_main_loop;
#line 119 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
		g_main_loop_quit (_tmp12_);
#line 699 "set-full-name.c"
	}
#line 112 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_object_unref0 (i);
#line 703 "set-full-name.c"
}
...
#line 28 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 29 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_object_unref0 (self->priv->_aggregator);
#line 30 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_free0 (self->priv->_persona_fullname);
#line 32 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_free0 (self->priv->_individual_id);
#line 33 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_free0 (self->priv->_modified_fullname);
#line 26 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	G_OBJECT_CLASS (set_full_name_tests_parent_class)->finalize (obj);
#line 741 "set-full-name.c"
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	SetFullNameTests* _tmp0_;
#line 126 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_test_init (&args_length1, &args, NULL);
#line 128 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_tmp0_ = set_full_name_tests_new ();
#line 128 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	tests = _tmp0_;
#line 129 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 130 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_test_run ();
#line 131 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 133 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	result = 0;
#line 133 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	_g_object_unref0 (tests);
#line 133 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	return result;
#line 779 "set-full-name.c"
}


int main (int argc, char ** argv) {
#line 124 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	g_type_init ();
#line 124 "/home/treitter/collabora/folks/tests/tracker/set-full-name.vala"
	return _vala_main (argv, argc);
#line 788 "set-full-name.c"
}
