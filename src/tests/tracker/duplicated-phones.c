/* duplicated-phones.c generated by valac 0.26.2.1-1f25, the Vala compiler
...
static void _duplicated_phones_tests_test_duplicated_phones_folks_test_case_test_method (gpointer self) {
#line 42 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	duplicated_phones_tests_test_duplicated_phones ((DuplicatedPhonesTests*) self);
#line 254 "duplicated-phones.c"
}


DuplicatedPhonesTests* duplicated_phones_tests_construct (GType object_type) {
	DuplicatedPhonesTests * self = NULL;
#line 40 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self = (DuplicatedPhonesTests*) tracker_test_test_case_construct (object_type, "DuplicatedPhonesTests");
#line 42 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_case_add_test ((FolksTestCase*) self, "test adding 2 personas with the same phone number ", _duplicated_phones_tests_test_duplicated_phones_folks_test_case_test_method, g_object_ref (self), g_object_unref);
#line 38 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return self;
#line 266 "duplicated-phones.c"
}
...
#line 46 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (self != NULL);
#line 48 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 48 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 48 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_main_loop = _tmp0_;
#line 50 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_test_duplicated_phones_async (self, NULL, NULL);
#line 52 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp1_ = self->priv->_main_loop;
#line 52 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_utils_loop_run_with_timeout (_tmp1_, 5);
#line 53 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp2_ = self->priv->_individual_id_1;
#line 53 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_vala_assert (g_strcmp0 (_tmp2_, "") != 0, "this._individual_id_1 != \"\"");
#line 54 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp3_ = self->priv->_individual_id_2;
#line 54 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_vala_assert (g_strcmp0 (_tmp3_, "") != 0, "this._individual_id_2 != \"\"");
#line 304 "duplicated-phones.c"
}
...
static void _duplicated_phones_tests_test_duplicated_phones_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 26 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_g_object_unref0 (_data_->self);
#line 26 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_slice_free (DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData, _data_);
#line 315 "duplicated-phones.c"
}
...
#line 322 "duplicated-phones.c"
}


static void _duplicated_phones_tests_test_duplicated_phones_async (DuplicatedPhonesTests* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData* _data_;
	DuplicatedPhonesTests* _tmp0_ = NULL;
#line 26 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 349 "duplicated-phones.c"
}


static void _duplicated_phones_tests_test_duplicated_phones_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData* _data_;
#line 60 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = _user_data_;
#line 60 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
static void __duplicated_phones_tests_individuals_changed_cb_folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
#line 62 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_individuals_changed_cb ((DuplicatedPhonesTests*) self, changes);
#line 370 "duplicated-phones.c"
}


static void __duplicated_phones_tests_notify_pstore_cb_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
#line 76 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_notify_pstore_cb ((DuplicatedPhonesTests*) self, _sender, pspec);
#line 377 "duplicated-phones.c"
}


static gboolean _duplicated_phones_tests_test_duplicated_phones_async_co (DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData* _data_) {
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	switch (_data_->_state_) {
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		case 0:
#line 386 "duplicated-phones.c"
		goto _state_0;
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		case 1:
#line 390 "duplicated-phones.c"
		goto _state_1;
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		case 2:
#line 394 "duplicated-phones.c"
		goto _state_2;
		default:
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		g_assert_not_reached ();
#line 399 "duplicated-phones.c"
	}
	_state_0:
#line 59 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp0_ = NULL;
#line 59 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 60 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return FALSE;
#line 414 "duplicated-phones.c"
	_state_1:
#line 60 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	folks_backend_store_prepare_finish (_data_->store, _data_->_res_);
#line 61 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp1_ = NULL;
#line 61 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 432 "duplicated-phones.c"
	{
#line 66 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp3_ = NULL;
#line 66 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 66 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		return FALSE;
#line 444 "duplicated-phones.c"
		_state_2:
#line 66 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		folks_individual_aggregator_prepare_finish (_data_->_tmp3_, _data_->_res_, &_data_->_inner_error_);
#line 66 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
#line 450 "duplicated-phones.c"
			goto __catch0_g_error;
		}
#line 67 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_g_object_unref0 (_data_->self->priv->_pstore);
#line 67 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->self->priv->_pstore = NULL;
#line 457 "duplicated-phones.c"
		{
#line 68 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			_data_->_tmp4_ = NULL;
#line 68 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 70 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				_data_->_tmp15_ = NULL;
#line 70 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 72 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				_data_->_tmp19_ = NULL;
#line 72 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				_data_->_tmp19_ = _data_->self->priv->_pstore;
#line 72 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				if (_data_->_tmp19_ != NULL) {
#line 73 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
					_g_object_unref0 (_data_->backend);
#line 73 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
					break;
#line 547 "duplicated-phones.c"
				}
#line 68 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				_g_object_unref0 (_data_->backend);
#line 551 "duplicated-phones.c"
			}
#line 68 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			_g_object_unref0 (_data_->_backend_it);
#line 555 "duplicated-phones.c"
		}
#line 75 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp20_ = NULL;
#line 75 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 77 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_duplicated_phones_tests_try_to_add (_data_->self, NULL, NULL);
#line 571 "duplicated-phones.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
#line 64 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->e = _data_->_inner_error_;
#line 64 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_inner_error_ = NULL;
#line 81 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp22_ = NULL;
#line 81 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 617 "duplicated-phones.c"
	}
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_object_unref (_data_->_async_result);
#line 57 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return FALSE;
#line 623 "duplicated-phones.c"
}
...
static void _duplicated_phones_tests_individuals_changed_cb (DuplicatedPhonesTests* self, GeeMultiMap* changes) {
	...
	gint _tmp32_ = 0;
	gint _tmp33_ = 0;
#line 85 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (self != NULL);
#line 85 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (changes != NULL);
#line 88 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = changes;
#line 88 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp1_ = gee_multi_map_get_values (_tmp0_);
#line 88 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	added = _tmp1_;
#line 89 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp2_ = changes;
#line 89 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp3_ = gee_multi_map_get_keys (_tmp2_);
#line 89 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	removed = _tmp3_;
#line 655 "duplicated-phones.c"
	{
		GeeIterator* _i_it = NULL;
		GeeCollection* _tmp4_ = NULL;
		GeeIterator* _tmp5_ = NULL;
#line 91 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp4_ = added;
#line 91 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 93 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			_tmp10_ = i;
#line 93 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			_vala_assert (_tmp10_ != NULL, "i != null");
#line 95 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			_tmp11_ = i;
#line 95 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 709 "duplicated-phones.c"
				...
				gchar* _tmp18_ = NULL;
#line 97 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				_tmp15_ = i;
#line 97 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 726 "duplicated-phones.c"
			} else {
				FolksIndividual* _tmp19_ = NULL;
				const gchar* _tmp20_ = NULL;
				const gchar* _tmp21_ = NULL;
				const gchar* _tmp22_ = NULL;
#line 99 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
				_tmp19_ = i;
#line 99 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 742 "duplicated-phones.c"
					FolksIndividual* _tmp23_ = NULL;
					const gchar* _tmp24_ = NULL;
					const gchar* _tmp25_ = NULL;
					gchar* _tmp26_ = NULL;
#line 101 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
					_tmp23_ = i;
#line 101 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 768 "duplicated-phones.c"
	}
#line 105 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp28_ = self->priv->_individual_id_1;
#line 105 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	if (g_strcmp0 (_tmp28_, "") != 0) {
#line 774 "duplicated-phones.c"
		const gchar* _tmp29_ = NULL;
#line 106 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp29_ = self->priv->_individual_id_2;
#line 106 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp27_ = g_strcmp0 (_tmp29_, "") != 0;
#line 780 "duplicated-phones.c"
	} else {
#line 105 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp27_ = FALSE;
#line 784 "duplicated-phones.c"
	}
#line 105 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	if (_tmp27_) {
#line 788 "duplicated-phones.c"
		GMainLoop* _tmp30_ = NULL;
#line 108 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp30_ = self->priv->_main_loop;
#line 108 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		g_main_loop_quit (_tmp30_);
#line 794 "duplicated-phones.c"
	}
#line 111 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp31_ = removed;
#line 111 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 804 "duplicated-phones.c"
	{
		GeeIterator* _i_it = NULL;
		GeeSet* _tmp34_ = NULL;
		GeeIterator* _tmp35_ = NULL;
#line 113 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp34_ = removed;
#line 113 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 115 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			_tmp40_ = i;
#line 115 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
static void _duplicated_phones_tests_notify_pstore_cb (DuplicatedPhonesTests* self, GObject* _pstore, GParamSpec* ps) {
#line 119 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (self != NULL);
#line 119 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (_pstore != NULL);
#line 119 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (ps != NULL);
#line 121 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_try_to_add (self, NULL, NULL);
#line 869 "duplicated-phones.c"
}
...
#line 26 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 907 "duplicated-phones.c"
}


static void _duplicated_phones_tests_try_to_add_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	DuplicatedPhonesTestsTryToAddData* _data_;
#line 129 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = _user_data_;
#line 129 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_source_object_ = source_object;
#line 129 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 129 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_try_to_add_co (_data_);
#line 921 "duplicated-phones.c"
}


static gboolean _duplicated_phones_tests_try_to_add_co (DuplicatedPhonesTestsTryToAddData* _data_) {
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	switch (_data_->_state_) {
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		case 0:
#line 930 "duplicated-phones.c"
		goto _state_0;
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		case 1:
#line 934 "duplicated-phones.c"
		goto _state_1;
		default:
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		g_assert_not_reached ();
#line 939 "duplicated-phones.c"
	}
	_state_0:
#line 126 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp1_ = NULL;
#line 126 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 962 "duplicated-phones.c"
	} else {
#line 126 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp0_ = FALSE;
#line 966 "duplicated-phones.c"
	}
#line 126 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	if (_data_->_tmp0_) {
#line 128 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 992 "duplicated-phones.c"
	}
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_object_unref (_data_->_async_result);
#line 124 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return FALSE;
#line 998 "duplicated-phones.c"
}
...
/**
   ...
   */
static void _g_free0_ (gpointer var) {
#line 142 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	var = (g_free (var), NULL);
#line 1050 "duplicated-phones.c"
}
...
#line 1066 "duplicated-phones.c"
}


static GValue* _g_value_dup (GValue* self) {
#line 148 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return g_boxed_copy (G_TYPE_VALUE, self);
#line 1073 "duplicated-phones.c"
}
...
#line 154 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return result;
...
static void _duplicated_phones_tests_add_personas_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	DuplicatedPhonesTestsAddPersonasData* _data_;
#line 182 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = _user_data_;
#line 182 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_source_object_ = source_object;
#line 182 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
static gboolean _duplicated_phones_tests_add_personas_co (DuplicatedPhonesTestsAddPersonasData* _data_) {
#line 140 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	switch (_data_->_state_) {
#line 140 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		case 0:
...
#line 144 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp3_ = NULL;
#line 144 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 149 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp9_ = NULL;
#line 149 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 150 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp11_ = NULL;
#line 150 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 153 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 157 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp19_ = NULL;
#line 157 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 158 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp21_ = NULL;
#line 158 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 159 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp23_ = NULL;
#line 159 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 160 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp25_ = NULL;
#line 160 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 164 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 165 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp32_ = NULL;
#line 165 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 166 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp34_ = NULL;
#line 166 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 169 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 170 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp41_ = NULL;
#line 170 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 173 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp42_ = NULL;
#line 173 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 174 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp44_ = NULL;
#line 174 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 175 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp46_ = NULL;
#line 175 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 176 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp48_ = NULL;
#line 176 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 182 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
			return FALSE;
#line 1468 "duplicated-phones.c"
		}
#line 185 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp57_ = NULL;
#line 185 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 1527 "duplicated-phones.c"
	...
	{
#line 180 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->e = _data_->_inner_error_;
#line 180 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_inner_error_ = NULL;
#line 190 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp62_ = NULL;
#line 190 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 140 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1594 "duplicated-phones.c"
	} else {
#line 140 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1598 "duplicated-phones.c"
	}
#line 140 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_object_unref (_data_->_async_result);
#line 140 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return FALSE;
#line 1604 "duplicated-phones.c"
}
...
#line 30 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = g_strdup ("persona #1");
#line 30 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_persona_fullname_1 = _tmp0_;
#line 31 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp1_ = g_strdup ("persona #2");
#line 31 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_persona_fullname_2 = _tmp1_;
#line 32 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp2_ = g_strdup ("1-800-123-456");
#line 32 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_phone_1 = _tmp2_;
#line 33 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_added_personas = FALSE;
#line 34 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp3_ = g_strdup ("");
#line 34 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_individual_id_1 = _tmp3_;
#line 35 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp4_ = g_strdup ("");
#line 35 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_individual_id_2 = _tmp4_;
#line 1649 "duplicated-phones.c"
}
...
#line 28 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 29 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
...
gint _vala_main (gchar** args, int args_length1) {
	...
	DuplicatedPhonesTests* _tmp0_ = NULL;
#line 198 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_test_init (&args_length1, &args, NULL);
#line 200 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = duplicated_phones_tests_new ();
#line 200 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	tests = _tmp0_;
#line 201 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 202 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	g_test_run ();
#line 203 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 205 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	result = 0;
#line 205 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	_g_object_unref0 (tests);
#line 205 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return result;
#line 1713 "duplicated-phones.c"
}
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 196 "/opt/gnome3/source/folks/tests/tracker/duplicated-phones.vala"
	return _vala_main (argv, argc);
#line 1723 "duplicated-phones.c"
}
