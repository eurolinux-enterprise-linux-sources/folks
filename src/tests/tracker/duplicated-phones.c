/* duplicated-phones.c generated by valac 0.35.3.10-6b27, the Vala compiler
...
static void _duplicated_phones_tests_test_duplicated_phones_folks_test_case_test_method (gpointer self) {
#line 42 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	duplicated_phones_tests_test_duplicated_phones ((DuplicatedPhonesTests*) self);
#line 257 "duplicated-phones.c"
}


DuplicatedPhonesTests* duplicated_phones_tests_construct (GType object_type) {
	DuplicatedPhonesTests * self = NULL;
#line 40 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 38 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return self;
#line 269 "duplicated-phones.c"
}
...
void duplicated_phones_tests_test_duplicated_phones (DuplicatedPhonesTests* self) {
	...
	const gchar* _tmp2_;
	const gchar* _tmp3_;
#line 46 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (self != NULL);
#line 48 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = g_main_loop_new (NULL, FALSE);
#line 48 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 48 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_main_loop = _tmp0_;
#line 50 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_test_duplicated_phones_async (self, NULL, NULL);
#line 52 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp1_ = self->priv->_main_loop;
#line 52 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_utils_loop_run_with_timeout (_tmp1_, 5);
#line 53 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp2_ = self->priv->_individual_id_1;
#line 53 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_vala_assert (g_strcmp0 (_tmp2_, "") != 0, "this._individual_id_1 != \"\"");
#line 54 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp3_ = self->priv->_individual_id_2;
#line 54 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_vala_assert (g_strcmp0 (_tmp3_, "") != 0, "this._individual_id_2 != \"\"");
#line 307 "duplicated-phones.c"
}
...
static void _duplicated_phones_tests_test_duplicated_phones_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 26 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_g_object_unref0 (_data_->self);
#line 26 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_slice_free (DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData, _data_);
#line 318 "duplicated-phones.c"
}
...
#line 352 "duplicated-phones.c"
}


static void _duplicated_phones_tests_test_duplicated_phones_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData* _data_;
#line 60 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = _user_data_;
#line 60 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 60 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_test_duplicated_phones_async_co (_data_);
#line 366 "duplicated-phones.c"
}


static void __duplicated_phones_tests_individuals_changed_cb_folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
#line 62 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_individuals_changed_cb ((DuplicatedPhonesTests*) self, changes);
#line 373 "duplicated-phones.c"
}


static void __duplicated_phones_tests_notify_pstore_cb_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
#line 76 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_notify_pstore_cb ((DuplicatedPhonesTests*) self, _sender, pspec);
#line 380 "duplicated-phones.c"
}


static gboolean _duplicated_phones_tests_test_duplicated_phones_async_co (DuplicatedPhonesTestsTestDuplicatedPhonesAsyncData* _data_) {
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	switch (_data_->_state_) {
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		case 0:
#line 389 "duplicated-phones.c"
		goto _state_0;
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		case 1:
#line 393 "duplicated-phones.c"
		goto _state_1;
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		case 2:
#line 397 "duplicated-phones.c"
		goto _state_2;
		default:
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_assert_not_reached ();
#line 402 "duplicated-phones.c"
	}
	_state_0:
#line 59 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 61 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 429 "duplicated-phones.c"
	{
#line 66 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 67 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_g_object_unref0 (_data_->self->priv->_pstore);
#line 67 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->self->priv->_pstore = NULL;
#line 452 "duplicated-phones.c"
		{
#line 68 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 70 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 72 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
				_data_->_tmp19_ = _data_->self->priv->_pstore;
#line 72 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
				if (_data_->_tmp19_ != NULL) {
#line 73 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 68 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
				_g_object_unref0 (_data_->backend);
#line 514 "duplicated-phones.c"
			}
#line 68 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_g_object_unref0 (_data_->_backend_it);
#line 518 "duplicated-phones.c"
		}
#line 75 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 77 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_duplicated_phones_tests_try_to_add (_data_->self, NULL, NULL);
#line 530 "duplicated-phones.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
#line 64 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->e = _data_->_inner_error_;
#line 64 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_inner_error_ = NULL;
#line 81 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 572 "duplicated-phones.c"
	}
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_object_unref (_data_->_async_result);
#line 57 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return FALSE;
#line 578 "duplicated-phones.c"
}
...
static void _duplicated_phones_tests_individuals_changed_cb (DuplicatedPhonesTests* self, GeeMultiMap* changes) {
	...
	gint _tmp32_;
	gint _tmp33_;
#line 85 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (self != NULL);
#line 85 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (changes != NULL);
#line 88 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = changes;
#line 88 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp1_ = gee_multi_map_get_values (_tmp0_);
#line 88 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	added = _tmp1_;
#line 89 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp2_ = changes;
#line 89 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp3_ = gee_multi_map_get_keys (_tmp2_);
#line 89 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	removed = _tmp3_;
#line 610 "duplicated-phones.c"
	{
		GeeIterator* _i_it;
		GeeCollection* _tmp4_;
		GeeIterator* _tmp5_;
#line 91 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp4_ = added;
#line 91 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 93 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_tmp10_ = i;
#line 93 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_vala_assert (_tmp10_ != NULL, "i != null");
#line 95 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_tmp11_ = i;
#line 95 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 664 "duplicated-phones.c"
				FolksIndividual* _tmp15_;
				const gchar* _tmp16_;
				const gchar* _tmp17_;
				gchar* _tmp18_;
#line 97 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
				_tmp15_ = i;
#line 97 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 681 "duplicated-phones.c"
			} else {
				FolksIndividual* _tmp19_;
				const gchar* _tmp20_;
				const gchar* _tmp21_;
				const gchar* _tmp22_;
#line 99 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
				_tmp19_ = i;
#line 99 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 697 "duplicated-phones.c"
					FolksIndividual* _tmp23_;
					const gchar* _tmp24_;
					const gchar* _tmp25_;
					gchar* _tmp26_;
#line 101 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
					_tmp23_ = i;
#line 101 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 714 "duplicated-phones.c"
				}
			}
#line 91 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_g_object_unref0 (i);
#line 719 "duplicated-phones.c"
		}
#line 91 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_g_object_unref0 (_i_it);
#line 723 "duplicated-phones.c"
	}
#line 105 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp28_ = self->priv->_individual_id_1;
#line 105 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	if (g_strcmp0 (_tmp28_, "") != 0) {
#line 729 "duplicated-phones.c"
		const gchar* _tmp29_;
#line 106 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp29_ = self->priv->_individual_id_2;
#line 106 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp27_ = g_strcmp0 (_tmp29_, "") != 0;
#line 735 "duplicated-phones.c"
	} else {
#line 105 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp27_ = FALSE;
#line 739 "duplicated-phones.c"
	}
#line 105 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	if (_tmp27_) {
#line 743 "duplicated-phones.c"
		GMainLoop* _tmp30_;
#line 108 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp30_ = self->priv->_main_loop;
#line 108 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_main_loop_quit (_tmp30_);
#line 749 "duplicated-phones.c"
	}
#line 111 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp31_ = removed;
#line 111 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 759 "duplicated-phones.c"
	{
		...
		GeeSet* _tmp34_;
		GeeIterator* _tmp35_;
#line 113 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_tmp34_ = removed;
#line 113 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 115 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_tmp40_ = i;
#line 115 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_vala_assert (_tmp40_ == NULL, "i == null");
#line 113 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			_g_object_unref0 (i);
#line 801 "duplicated-phones.c"
		}
#line 113 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_g_object_unref0 (_i_it);
#line 805 "duplicated-phones.c"
	}
#line 85 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_g_object_unref0 (removed);
#line 85 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_g_object_unref0 (added);
#line 811 "duplicated-phones.c"
}


static void _duplicated_phones_tests_notify_pstore_cb (DuplicatedPhonesTests* self, GObject* _pstore, GParamSpec* ps) {
#line 119 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (self != NULL);
#line 119 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (_pstore != NULL);
#line 119 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_return_if_fail (ps != NULL);
#line 121 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_try_to_add (self, NULL, NULL);
#line 824 "duplicated-phones.c"
}
...
#line 26 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 862 "duplicated-phones.c"
}


static void _duplicated_phones_tests_try_to_add_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	DuplicatedPhonesTestsTryToAddData* _data_;
#line 129 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = _user_data_;
#line 129 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_source_object_ = source_object;
#line 129 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 129 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_duplicated_phones_tests_try_to_add_co (_data_);
#line 876 "duplicated-phones.c"
}


static gboolean _duplicated_phones_tests_try_to_add_co (DuplicatedPhonesTestsTryToAddData* _data_) {
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	switch (_data_->_state_) {
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		case 0:
#line 885 "duplicated-phones.c"
		goto _state_0;
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		case 1:
#line 889 "duplicated-phones.c"
		goto _state_1;
		default:
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_assert_not_reached ();
#line 894 "duplicated-phones.c"
	}
	_state_0:
#line 126 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 909 "duplicated-phones.c"
	} else {
#line 126 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_tmp0_ = FALSE;
#line 913 "duplicated-phones.c"
	}
#line 126 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	if (_data_->_tmp0_) {
#line 128 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 129 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		return FALSE;
#line 925 "duplicated-phones.c"
		_state_1:
#line 129 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_duplicated_phones_tests_add_personas_finish (_data_->self, _data_->_res_);
#line 929 "duplicated-phones.c"
	}
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	if (_data_->_state_ == 0) {
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 935 "duplicated-phones.c"
	} else {
#line 124 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete (_data_->_async_result);
...
/**
   ...
   */
static void _g_free0_ (gpointer var) {
#line 142 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	var = (g_free (var), NULL);
#line 997 "duplicated-phones.c"
}
...
#line 1013 "duplicated-phones.c"
}


static GValue* _g_value_dup (GValue* self) {
#line 148 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return g_boxed_copy (G_TYPE_VALUE, self);
#line 1020 "duplicated-phones.c"
}
...
#line 154 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return result;
...
#line 154 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return result;
#line 1045 "duplicated-phones.c"
}


static void _duplicated_phones_tests_add_personas_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	DuplicatedPhonesTestsAddPersonasData* _data_;
#line 182 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_ = _user_data_;
#line 182 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_source_object_ = source_object;
#line 182 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
static gboolean _duplicated_phones_tests_add_personas_co (DuplicatedPhonesTestsAddPersonasData* _data_) {
#line 140 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	switch (_data_->_state_) {
#line 140 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		case 0:
...
#line 144 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 149 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 150 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 153 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 157 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 158 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 159 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp23_ = _data_->val;
#line 159 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp24_ = _data_->phones1;
#line 159 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_value_set_object (_data_->_tmp23_, (GObject*) _data_->_tmp24_);
#line 160 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 164 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 165 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 166 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 169 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 170 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 173 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 174 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 175 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp46_ = _data_->val;
#line 175 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_data_->_tmp47_ = _data_->phones2;
#line 175 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_value_set_object (_data_->_tmp46_, (GObject*) _data_->_tmp47_);
#line 176 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 185 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 185 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
			return FALSE;
#line 1358 "duplicated-phones.c"
		}
	}
	goto __finally1;
	__catch1_folks_individual_aggregator_error:
	{
#line 180 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->e = _data_->_inner_error_;
#line 180 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		_data_->_inner_error_ = NULL;
#line 190 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
#line 140 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1421 "duplicated-phones.c"
	} else {
#line 140 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1425 "duplicated-phones.c"
	}
#line 140 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_object_unref (_data_->_async_result);
#line 140 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return FALSE;
#line 1431 "duplicated-phones.c"
}
...
#line 30 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = g_strdup ("persona #1");
#line 30 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_persona_fullname_1 = _tmp0_;
#line 31 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp1_ = g_strdup ("persona #2");
#line 31 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_persona_fullname_2 = _tmp1_;
#line 32 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp2_ = g_strdup ("1-800-123-456");
#line 32 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_phone_1 = _tmp2_;
#line 33 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_added_personas = FALSE;
#line 34 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp3_ = g_strdup ("");
#line 34 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_individual_id_1 = _tmp3_;
#line 35 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp4_ = g_strdup ("");
#line 35 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	self->priv->_individual_id_2 = _tmp4_;
#line 1476 "duplicated-phones.c"
}
...
#line 28 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_g_main_loop_unref0 (self->priv->_main_loop);
#line 29 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
...
gint _vala_main (gchar** args, int args_length1) {
	gint result = 0;
	DuplicatedPhonesTests* tests;
	DuplicatedPhonesTests* _tmp0_;
#line 198 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_test_init (&args_length1, &args, NULL);
#line 200 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_tmp0_ = duplicated_phones_tests_new ();
#line 200 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	tests = _tmp0_;
#line 201 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_case_register ((FolksTestCase*) tests);
#line 202 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	g_test_run ();
#line 203 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	folks_test_case_final_tear_down ((FolksTestCase*) tests);
#line 205 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	result = 0;
#line 205 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	_g_object_unref0 (tests);
#line 205 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return result;
#line 1540 "duplicated-phones.c"
}
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 196 "/opt/gnome/source/folks/tests/tracker/duplicated-phones.vala"
	return _vala_main (argv, argc);
#line 1550 "duplicated-phones.c"
}
