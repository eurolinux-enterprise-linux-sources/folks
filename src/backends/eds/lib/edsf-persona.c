/* edsf-persona.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static GRecMutex __lock_edsf_persona__im_eds_map = {0};
...
gchar* edsf_persona_build_iid_from_contact (const gchar* store_id, EContact* contact) {
	...
	_tmp4_ = store_id;
	_tmp5_ = edsf_persona_build_iid (_tmp4_, (const gchar*) _tmp2_);
	result = _tmp5_;
	_g_free0 (contact_id);
	return result;
}
...
EdsfPersona* edsf_persona_construct (GType object_type, EdsfPersonaStore* store, EContact* contact) {
	...
	_tmp4_ = g_strdup ((const gchar*) _tmp2_);
	contact_id = _tmp4_;
	_tmp5_ = store;
	_tmp6_ = folks_persona_store_get_id ((FolksPersonaStore*) _tmp5_);
	_tmp7_ = _tmp6_;
	_tmp8_ = folks_persona_build_uid (BACKEND_NAME, _tmp7_, contact_id);
	uid = _tmp8_;
	_tmp9_ = store;
	_tmp10_ = folks_persona_store_get_id ((FolksPersonaStore*) _tmp9_);
	_tmp11_ = _tmp10_;
	_tmp12_ = edsf_persona_build_iid (_tmp11_, contact_id);
	iid = _tmp12_;
	_tmp13_ = contact;
	...
	_tmp15_ = store;
	_tmp16_ = contact;
	self = (EdsfPersona*) g_object_new (object_type, "display-id", iid, "uid", uid, "iid", iid, "store", _tmp15_, "is-user", is_user, "contact-id", contact_id, "contact", _tmp16_, NULL);
	_g_free0 (iid);
	_g_free0 (uid);
	_g_free0 (contact_id);
		...
		if (g_strcmp0 (_tmp18_, "local-ids") == 0) {
			{
				...
				while (TRUE) {
					...
					FolksPersonaLinkablePropertyCallback _tmp26_ = NULL;
			...
			if (g_strcmp0 (_tmp28_, "web-service-addresses") == 0) {
				...
				while (TRUE) {
					...
					FolksPersonaLinkablePropertyCallback _tmp34_ = NULL;
					...
					FolksWebServiceFieldDetails* _tmp42_ = NULL;
				...
				if (g_strcmp0 (_tmp47_, "email-addresses") == 0) {
					{
						...
						while (TRUE) {
							...
							FolksPersonaLinkablePropertyCallback _tmp60_ = NULL;
							void* _tmp60__target = NULL;
					...
					FolksPersonaLinkablePropertyCallback _tmp65_ = NULL;
...
static void _edsf_persona_update_gender (EdsfPersona* self) {
	...
	FolksGender _tmp13_ = 0;
	FolksGender _tmp14_ = 0;
	g_return_if_fail (self != NULL);
...
static void _edsf_persona_update_birthday (EdsfPersona* self) {
	...
	if (_tmp1_ != NULL) {
		...
		EContactDate* _tmp2_ = NULL;
		EContactDate* _tmp3_ = NULL;
		GDateTime* d = NULL;
		GTimeZone* _tmp4_ = NULL;
		EContactDate* _tmp5_ = NULL;
		guint _tmp6_ = 0U;
		EContactDate* _tmp7_ = NULL;
		guint _tmp8_ = 0U;
	...
	_tmp18_ = e_vcard_get_attributes (_tmp17_);
	{
		...
		for (attr_it = attr_collection; attr_it != NULL; attr_it = attr_it->next) {
			...
			attr = (EVCardAttribute*) attr_it->data;
			{
				...
				FolksRole* _tmp29_ = NULL;
				FolksRoleFieldDetails* _tmp30_ = NULL;
				EVCardAttribute* _tmp31_ = NULL;
				GList* _tmp32_ = NULL;
				FolksSmallSet* _tmp51_ = NULL;
				FolksRoleFieldDetails* _tmp52_ = NULL;
				_tmp19_ = attr;
					...
					for (param_it = param_collection; param_it != NULL; param_it = param_it->next) {
						...
						param = (EVCardAttributeParam*) param_it->data;
						{
							...
							if (g_strcmp0 (_tmp36_, "organisation_name") == 0) {
								EVCardAttributeParam* _tmp37_ = NULL;
								GList* _tmp38_ = NULL;
								_tmp37_ = param;
								...
								if (g_strcmp0 (_tmp41_, "title") == 0) {
									EVCardAttributeParam* _tmp42_ = NULL;
									GList* _tmp43_ = NULL;
									_tmp42_ = param;
									...
									EVCardAttributeParam* _tmp46_ = NULL;
									GList* _tmp47_ = NULL;
									_tmp46_ = param;
									_tmp47_ = e_vcard_attribute_param_get_values (_tmp46_);
									{
										...
										for (param_value_it = param_value_collection; param_value_it != NULL; param_value_it = param_value_it->next) {
											...
											param_value = (const gchar*) param_value_it->data;
											{
												FolksRoleFieldDetails* _tmp48_ = NULL;
...
static FolksRoleFieldDetails* _edsf_persona_get_default_role (EdsfPersona* self) {
	...
	if (_tmp7_) {
		...
		if (!_tmp29_) {
			...
			if (_tmp32_) {
				FolksRoleFieldDetails* _tmp35_ = NULL;
				const gchar* _tmp36_ = NULL;
			...
			if (_tmp42_) {
				FolksRoleFieldDetails* _tmp45_ = NULL;
					...
					_tmp13_ = e_vcard_attribute_param_get_values (_tmp12_);
					{
						...
						for (service_id_it = service_id_collection; service_id_it != NULL; service_id_it = service_id_it->next) {
							...
							service_id = _tmp14_;
							{
								...
								const gchar* _tmp17_ = NULL;
								const gchar* _tmp18_ = NULL;
								FolksWebServiceFieldDetails* _tmp19_ = NULL;
								FolksWebServiceFieldDetails* _tmp20_ = NULL;
								_tmp15_ = service_id;
...
static void _edsf_persona_update_names (EdsfPersona* self) {
	...
	if (_tmp19_ != NULL) {
		...
		EContactName* _tmp20_ = NULL;
		EContactName* _tmp21_ = NULL;
		gchar* family_name = NULL;
		EContactName* _tmp22_ = NULL;
		const gchar* _tmp23_ = NULL;
		gchar* _tmp24_ = NULL;
		gchar* given_name = NULL;
		EContactName* _tmp25_ = NULL;
		const gchar* _tmp26_ = NULL;
		gchar* _tmp27_ = NULL;
		gchar* additional_names = NULL;
		EContactName* _tmp28_ = NULL;
	...
	if (_tmp43_) {
		...
		FolksStructuredName* _tmp48_ = NULL;
...
static GLoadableIcon* _edsf_persona_contact_photo_to_loadable_icon (EdsfPersona* self, EContactPhoto* _p) {
	...
	EContactPhoto* _tmp0_ = NULL;
	EContactPhoto* p = NULL;
	EContactPhoto* _tmp1_ = NULL;
	EContactPhoto* _tmp2_ = NULL;
	EContactPhoto* _tmp3_ = NULL;
	EContactPhotoType _tmp4_ = 0;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = _p;
	if (_tmp0_ == NULL) {
		result = NULL;
	...
	switch (_tmp4_) {
		case E_CONTACT_PHOTO_TYPE_URI:
		{
			...
			if (_tmp11_) {
				const gchar* _tmp14_ = NULL;
				_tmp14_ = uri;
				g_warning ("Ignoring contact photo with URI ‘%s’ because it’s " "not a local file.", _tmp14_);
				result = NULL;
				_g_free0 (scheme);
				_g_free0 (uri);
				__vala_EContactPhoto_free0 (p);
...
static void _edsf_persona_update_urls (EdsfPersona* self, gboolean create_if_not_exist, gboolean emit_notification) {
	...
	FolksSmallSet* _tmp9_ = NULL;
	EVCard* vcard = NULL;
	EContact* _tmp27_ = NULL;
	EContact* _tmp28_ = NULL;
	EVCard* _tmp29_ = NULL;
	EVCard* _tmp30_ = NULL;
	GList* _tmp31_ = NULL;
	FolksSmallSet* _tmp45_ = NULL;
	FolksSmallSet* _tmp46_ = NULL;
	gboolean _tmp47_ = FALSE;
	g_return_if_fail (self != NULL);
	...
	new_urls = _tmp9_;
	{
		...
		for (mapping_it = 0; mapping_it < G_N_ELEMENTS (EDSF_PERSONA__url_properties); mapping_it = mapping_it + 1) {
			...
			mapping = mapping_collection[mapping_it];
			{
				...
				EdsfPersonaUrlTypeMapping _tmp10_ = {0};
				const gchar* _tmp11_ = NULL;
				gchar* _tmp12_ = NULL;
				gchar* folks_type = NULL;
				EdsfPersonaUrlTypeMapping _tmp13_ = {0};
				const gchar* _tmp14_ = NULL;
				gchar* _tmp15_ = NULL;
				gchar* u = NULL;
				const gchar* _tmp16_ = NULL;
...
static void _edsf_persona_update_im_addresses (EdsfPersona* self) {
	...
	GList* _tmp3_ = NULL;
	GeeHashMultiMap* _tmp77_ = NULL;
	GeeHashMultiMap* _tmp78_ = NULL;
					...
					for (attr_it = attr_collection; attr_it != NULL; attr_it = attr_it->next) {
						...
						attr = _tmp11_;
						{
							...
							__catch0_folks_im_details_error:
							{
								...
								g_warning ("edsf-persona.vala:1710: Problem when trying to normalise address: %s\n", _tmp27_);
								_g_error_free0 (e);
							}
							__finally0:
							if (G_UNLIKELY (_inner_error_ != NULL)) {
		...
		while (TRUE) {
			...
			if (_tmp44_ != NULL) {
				...
				if (_tmp50_ != NULL) {
					{
						...
						while (TRUE) {
							...
							FolksImFieldDetails* _tmp57_ = NULL;
							gconstpointer _tmp58_ = NULL;
				...
				}
				{
					...
					FolksImFieldDetails* _tmp70_ = NULL;
					FolksImFieldDetails* _tmp71_ = NULL;
					GeeHashMultiMap* _tmp72_ = NULL;
					const gchar* _tmp73_ = NULL;
					FolksImFieldDetails* _tmp74_ = NULL;
					_tmp64_ = email;
				...
				__catch1_folks_im_details_error:
				{
					...
					g_warning ("edsf-persona.vala:1767: Problem when trying to normalise address: %s\n", _tmp76_);
					_g_error_free0 (e);
				}
				__finally1:
				if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	if (!_tmp79_) {
		GeeHashMultiMap* _tmp80_ = NULL;
		GeeHashMultiMap* _tmp81_ = NULL;
...
static void _edsf_persona_update_groups (EdsfPersona* self, gboolean create_if_not_exist, gboolean emit_notification) {
	...
	FolksPersonaStore* _tmp48_ = NULL;
	EdsfPersonaStore* _tmp49_ = NULL;
	gboolean in_google_personal_group = FALSE;
	gboolean should_notify_sysgroups = FALSE;
	EdsfPersonaStore* _tmp50_ = NULL;
	gboolean _tmp51_ = FALSE;
	gboolean old_is_favourite = FALSE;
	gboolean _tmp100_ = FALSE;
	EdsfPersonaStore* _tmp101_ = NULL;
	...
	if (_tmp51_) {
		EVCard* vcard = NULL;
		EContact* _tmp52_ = NULL;
		EContact* _tmp53_ = NULL;
		EVCard* _tmp54_ = NULL;
		EVCardAttribute* attr = NULL;
		EVCard* _tmp55_ = NULL;
		EVCardAttribute* _tmp56_ = NULL;
		EVCardAttribute* _tmp57_ = NULL;
		...
		if (_tmp57_ != NULL) {
			...
			FolksSmallSet* _tmp70_ = NULL;
			FolksSmallSet* _tmp86_ = NULL;
			gboolean _tmp87_ = FALSE;
			FolksSmallSet* _tmp88_ = NULL;
			...
			if (_tmp70_ != NULL) {
				{
					...
					FolksSmallSet* _tmp71_ = NULL;
					FolksSmallSet* _tmp72_ = NULL;
					gint _system_group_id_size = 0;
					FolksSmallSet* _tmp73_ = NULL;
					gint _tmp74_ = 0;
					gint _tmp75_ = 0;
...
GHashTable* _edsf_persona_get_im_eds_map (void) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		g_rec_mutex_lock (&__lock_edsf_persona__im_eds_map);
		{
		...
		__finally2:
		{
			...
			g_rec_mutex_unlock (&__lock_edsf_persona__im_eds_map);
		}
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			_g_hash_table_unref0 (retval);
			g_critical ("file %s: line %d: uncaught error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
...
static void _edsf_persona_update_location (EdsfPersona* self) {
	...
	if (_tmp1_ != NULL) {
		...
		if (_tmp3_ == NULL) {
			...
			EContactGeo* _tmp5_ = NULL;
			gdouble _tmp6_ = 0.0;
			EContactGeo* _tmp7_ = NULL;
			gdouble _tmp8_ = 0.0;
			gboolean _tmp9_ = FALSE;
		...
		if (_tmp2_) {
			...
			if (_tmp10_ != NULL) {
				...
				EContactGeo* _tmp12_ = NULL;
				gdouble _tmp13_ = 0.0;
				FolksLocation* _tmp14_ = NULL;
				EContactGeo* _tmp15_ = NULL;
				gdouble _tmp16_ = 0.0;
				...
				EContactGeo* _tmp17_ = NULL;
				gdouble _tmp18_ = 0.0;
				EContactGeo* _tmp19_ = NULL;
				gdouble _tmp20_ = 0.0;
				FolksLocation* _tmp21_ = NULL;
				_tmp17_ = _geo;
...
static GObject * edsf_persona_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_tmp1_ = _tmp0_;
	g_debug ("edsf-persona.vala:1012: Creating new Edsf.Persona with IID '%s'", _tmp1_);
...
static void edsf_persona_class_init (EdsfPersonaClass * klass) {
	...
	g_rec_mutex_init (&__lock_edsf_persona__im_eds_map);
...
static void edsf_persona_finalize (GObject* obj) {
	...
	_tmp1_ = _tmp0_;
	g_debug ("edsf-persona.vala:1101: Destroying Edsf.Persona '%s': %p", _tmp1_, self);
	_g_object_unref0 (self->priv->_contact);
	_g_object_unref0 (self->priv->_web_service_addresses);
	_g_object_unref0 (self->priv->_local_ids);
	_g_object_unref0 (self->priv->_local_ids_ro);
