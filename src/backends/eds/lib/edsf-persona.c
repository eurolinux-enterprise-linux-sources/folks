/* edsf-persona.c generated by valac 0.27.1.3-6129, the Vala compiler
					...
					for (attr_it = attr_collection; attr_it != NULL; attr_it = attr_it->next) {
						...
						attr = _tmp11_;
						{
							...
							__catch0_folks_im_details_error:
							{
								...
								g_warning ("edsf-persona.vala:1678: Problem when trying to normalise address: %s\n", _tmp27_);
								_g_error_free0 (e);
							}
							__finally0:
							if (G_UNLIKELY (_inner_error_ != NULL)) {
		...
		while (TRUE) {
			...
			if (_tmp44_ != NULL) {
				...
				__catch1_folks_im_details_error:
				{
					...
					g_warning ("edsf-persona.vala:1735: Problem when trying to normalise address: %s\n", _tmp76_);
					_g_error_free0 (e);
				}
				__finally1:
				if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static GObject * edsf_persona_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_tmp1_ = _tmp0_;
	g_debug ("edsf-persona.vala:980: Creating new Edsf.Persona with IID '%s'", _tmp1_);
...
static void edsf_persona_finalize (GObject* obj) {
	...
	_tmp1_ = _tmp0_;
	g_debug ("edsf-persona.vala:1069: Destroying Edsf.Persona '%s': %p", _tmp1_, self);
	_g_object_unref0 (self->priv->_contact);
	_g_object_unref0 (self->priv->_web_service_addresses);
	_g_object_unref0 (self->priv->_local_ids);
	_g_object_unref0 (self->priv->_local_ids_ro);
