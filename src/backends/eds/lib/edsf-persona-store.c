/* edsf-persona-store.c generated by valac 0.27.1.3-6129, the Vala compiler
...
struct _EdsfPersonaStorePrepareData {
	...
	gboolean got_view;
	gboolean _tmp118_;
	EBookClient* _tmp119_;
	const gchar* _tmp120_;
	EBookClientView* _tmp121_;
	gboolean _tmp122_;
	const gchar* _tmp123_;
...
static void ___lambda9_ (Block2Data* _data2_, GObject* obj, GParamSpec* pspec);
...
static gboolean edsf_persona_store_create_address_book_co (EdsfPersonaStoreCreateAddressBookData* _data_) {
	...
	g_debug ("edsf-persona-store.vala:95: Creating addressbook %s", _data_->_tmp0_);
	_data_->_tmp1_ = NULL;
...
static gboolean edsf_persona_store_real_add_persona_from_details_co (EdsfPersonaStoreAddPersonaFromDetailsData* _data_) {
				...
				if (g_strcmp0 (_data_->_tmp30_, _data_->_tmp31_) == 0) {
					...
					if (g_strcmp0 (_data_->_tmp36_, _data_->_tmp37_) == 0) {
						...
						__catch4_folks_property_error:
						{
							...
							g_warning ("edsf-persona-store.vala:473: Couldn't set avatar on the EContact: %s", _data_->_tmp43_);
	...
	_data_->_persona = NULL;
	{
		...
		_data_->_tmp130_ = _data_->self->priv->_addressbook;
		_data_->_tmp131_ = NULL;
		_data_->_tmp131_ = _data_->contact;
		_data_->_tmp132_ = NULL;
		_data_->_state_ = 2;
		e_book_client_add_contact (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp130_, e_book_client_get_type (), EBookClient), _data_->_tmp131_, NULL, edsf_persona_store_add_persona_from_details_ready, _data_);
		return FALSE;
		_state_2:
		_data_->_tmp133_ = FALSE;
		_data_->_tmp133_ = e_book_client_add_contact_finish (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp130_, e_book_client_get_type (), EBookClient), _data_->_res_, &_data_->_tmp132_, &_data_->_inner_error_);
		_g_free0 (_data_->added_uid);
		_data_->added_uid = _data_->_tmp132_;
		_data_->_result_ = _data_->_tmp133_;
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
			_g_free0 (_data_->added_uid);
			goto __catch5_g_error;
		}
		_data_->_tmp134_ = FALSE;
		_data_->_tmp134_ = _data_->_result_;
		if (_data_->_tmp134_) {
			_data_->_tmp135_ = NULL;
			_data_->_tmp135_ = _data_->added_uid;
			g_debug ("edsf-persona-store.vala:579: Created contact with uid: %s\n", _data_->_tmp135_);
			{
				_data_->_tmp136_ = NULL;
				_data_->_tmp136_ = _data_->self->priv->_personas;
				g_static_rec_mutex_lock (&_data_->self->priv->__lock__personas);
				{
					_data_->_tmp137_ = NULL;
					_data_->_tmp137_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
					_data_->_tmp138_ = NULL;
					_data_->_tmp138_ = _data_->_tmp137_;
					_data_->_tmp139_ = NULL;
					_data_->_tmp139_ = _data_->added_uid;
					_data_->_tmp140_ = NULL;
					_data_->_tmp140_ = edsf_persona_build_iid (_data_->_tmp138_, _data_->_tmp139_);
					_data_->iid = _data_->_tmp140_;
					_data_->_tmp141_ = NULL;
					_data_->_tmp141_ = _data_->self->priv->_personas;
					_data_->_tmp142_ = NULL;
					_data_->_tmp142_ = _data_->iid;
					_data_->_tmp143_ = NULL;
					_data_->_tmp143_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp141_, _data_->_tmp142_);
					_g_object_unref0 (_data_->_persona);
					_data_->_persona = (EdsfPersona*) _data_->_tmp143_;
					_data_->_tmp144_ = NULL;
					_data_->_tmp144_ = _data_->_persona;
					if (_data_->_tmp144_ == NULL) {
						_data_->_tmp145_ = NULL;
						_data_->_tmp145_ = _data_->contact;
						_data_->_tmp146_ = 0;
						_data_->_tmp146_ = e_contact_field_id ("id");
						_data_->_tmp147_ = NULL;
						_data_->_tmp147_ = _data_->added_uid;
						e_contact_set (_data_->_tmp145_, _data_->_tmp146_, _data_->_tmp147_);
						_data_->_tmp148_ = NULL;
						_data_->_tmp148_ = _data_->contact;
						_data_->_tmp149_ = NULL;
						_data_->_tmp149_ = edsf_persona_new (_data_->self, _data_->_tmp148_);
						_g_object_unref0 (_data_->persona);
						_data_->persona = _data_->_tmp149_;
						_data_->_tmp150_ = NULL;
						_data_->_tmp150_ = _data_->self->priv->_personas;
						_data_->_tmp151_ = NULL;
						_data_->_tmp151_ = _data_->persona;
						_data_->_tmp152_ = NULL;
						_data_->_tmp152_ = folks_persona_get_iid ((FolksPersona*) _data_->_tmp151_);
						_data_->_tmp153_ = NULL;
						_data_->_tmp153_ = _data_->_tmp152_;
						_data_->_tmp154_ = NULL;
						_data_->_tmp154_ = _data_->persona;
						gee_abstract_map_set ((GeeAbstractMap*) _data_->_tmp150_, _data_->_tmp153_, _data_->_tmp154_);
						_data_->_tmp155_ = NULL;
						_data_->_tmp155_ = folks_small_set_new (EDSF_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
						_data_->added_personas = _data_->_tmp155_;
						_data_->_tmp156_ = NULL;
						_data_->_tmp156_ = _data_->added_personas;
						_data_->_tmp157_ = NULL;
						_data_->_tmp157_ = _data_->persona;
						gee_abstract_collection_add ((GeeAbstractCollection*) _data_->_tmp156_, _data_->_tmp157_);
						_data_->_tmp158_ = NULL;
						_data_->_tmp158_ = _data_->added_personas;
						_folks_persona_store_emit_personas_changed ((FolksPersonaStore*) _data_->self, (GeeSet*) _data_->_tmp158_, NULL, NULL, NULL, FOLKS_GROUP_DETAILS_CHANGE_REASON_NONE);
						_data_->_tmp159_ = NULL;
						_data_->_tmp159_ = _data_->persona;
						_data_->_tmp160_ = NULL;
						_data_->_tmp160_ = _g_object_ref0 (_data_->_tmp159_);
						_g_object_unref0 (_data_->_persona);
						_data_->_persona = _data_->_tmp160_;
				...
				__finally6:
				{
					...
					_data_->_tmp161_ = _data_->self->priv->_personas;
			...
			_data_->_tmp162_ = g_error_new_literal (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_CREATE_FAILED, "BookClient.add_contact () failed.");
			_data_->_inner_error_ = _data_->_tmp162_;
			_g_free0 (_data_->added_uid);
			goto __catch5_g_error;
		}
		_g_free0 (_data_->added_uid);
	...
	__catch5_g_error:
	{
		...
		_data_->_tmp163_ = _data_->e;
		_data_->_tmp164_ = NULL;
		_data_->_tmp164_ = _data_->_tmp163_->message;
		g_warning ("edsf-persona-store.vala:607: add_persona_from_details: %s\n", _data_->_tmp164_);
	...
	}
	{
		...
		}
		{
			...
			if (_data_->_tmp57_ != NULL) {
				...
				_data_->_tmp71_ = _data_->fields;
				_data_->_tmp71__length1 = _data_->fields_length1;
				{
					_data_->field_collection_length1 = 0;
					_data_->_field_collection_size_ = 0;
					_data_->field_collection = _data_->_tmp71_;
					_data_->field_collection_length1 = _data_->_tmp71__length1;
					for (_data_->field_it = 0; _data_->field_it < _data_->_tmp71__length1; _data_->field_it = _data_->field_it + 1) {
						_data_->field = _data_->field_collection[_data_->field_it];
						{
							_data_->_tmp72_ = NULL;
							_data_->_tmp72_ = _data_->field;
							_data_->_tmp73_ = 0;
							_data_->_tmp73_ = _edsf_persona_store_eds_field_name_to_folks_persona_detail (_data_->self, _data_->_tmp72_);
							_data_->_tmp74_ = NULL;
							_data_->_tmp74_ = folks_persona_store_detail_key (_data_->_tmp73_);
							_data_->_tmp75_ = NULL;
							_data_->_tmp75_ = g_strdup (_data_->_tmp74_);
							_data_->prop = _data_->_tmp75_;
							_data_->_tmp76_ = NULL;
							_data_->_tmp76_ = _data_->prop;
							if (_data_->_tmp76_ != NULL) {
								_data_->_tmp77_ = NULL;
								_data_->_tmp77_ = _data_->prop_set;
								_data_->_tmp78_ = NULL;
								_data_->_tmp78_ = _data_->prop;
								_data_->prop = NULL;
								_data_->_tmp79_ = NULL;
								_data_->_tmp79_ = (gchar*) _data_->_tmp78_;
								gee_abstract_collection_add ((GeeAbstractCollection*) _data_->_tmp77_, _data_->_tmp79_);
			...
			_data_->_tmp81_ = 0;
			_data_->_tmp81_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp80_);
			_data_->_tmp82_ = 0;
			_data_->_tmp82_ = _data_->_tmp81_;
			_data_->_tmp83_ = NULL;
			_data_->_tmp83_ = g_new0 (gchar*, _data_->_tmp82_ + 1);
			...
			_data_->self->priv->_always_writeable_properties = _data_->_tmp83_;
			_data_->self->priv->_always_writeable_properties_length1 = _data_->_tmp82_;
			_data_->self->priv->__always_writeable_properties_size_ = _data_->self->priv->_always_writeable_properties_length1;
			_data_->i = (guint) 0;
			{
				_data_->_tmp84_ = NULL;
				_data_->_tmp84_ = _data_->prop_set;
				_data_->_tmp85_ = NULL;
				_data_->_tmp85_ = _g_object_ref0 (_data_->_tmp84_);
				_data_->_final_prop_list = _data_->_tmp85_;
				_data_->_tmp86_ = NULL;
				_data_->_tmp86_ = _data_->_final_prop_list;
				_data_->_tmp87_ = 0;
				_data_->_tmp87_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp86_);
				_data_->_tmp88_ = 0;
				_data_->_tmp88_ = _data_->_tmp87_;
				_data_->_final_prop_size = _data_->_tmp88_;
				_data_->_final_prop_index = -1;
				while (TRUE) {
					_data_->_tmp89_ = 0;
					_data_->_tmp89_ = _data_->_final_prop_index;
					_data_->_final_prop_index = _data_->_tmp89_ + 1;
					_data_->_tmp90_ = 0;
					_data_->_tmp90_ = _data_->_final_prop_index;
					_data_->_tmp91_ = 0;
					_data_->_tmp91_ = _data_->_final_prop_size;
					if (!(_data_->_tmp90_ < _data_->_tmp91_)) {
						break;
					}
					_data_->_tmp92_ = NULL;
					_data_->_tmp92_ = _data_->_final_prop_list;
					_data_->_tmp93_ = 0;
					_data_->_tmp93_ = _data_->_final_prop_index;
					_data_->_tmp94_ = NULL;
					_data_->_tmp94_ = folks_small_set_get (_data_->_tmp92_, _data_->_tmp93_);
					_data_->_tmp95_ = NULL;
					_data_->_tmp95_ = g_strdup ((const gchar*) _data_->_tmp94_);
					_data_->final_prop = _data_->_tmp95_;
					_data_->_tmp96_ = NULL;
					_data_->_tmp96__length1 = 0;
					_data_->_tmp96_ = _data_->self->priv->_always_writeable_properties;
					_data_->_tmp96__length1 = _data_->self->priv->_always_writeable_properties_length1;
					_data_->_tmp97_ = 0U;
					_data_->_tmp97_ = _data_->i;
					_data_->i = _data_->_tmp97_ + 1;
					_data_->_tmp98_ = NULL;
					_data_->_tmp98_ = _data_->final_prop;
					_data_->_tmp99_ = NULL;
					_data_->_tmp99_ = g_strdup (_data_->_tmp98_);
					_g_free0 (_data_->_tmp96_[_data_->_tmp97_]);
					_data_->_tmp96_[_data_->_tmp97_] = _data_->_tmp99_;
					_data_->_tmp100_ = NULL;
					_data_->_tmp100_ = _data_->_tmp96_[_data_->_tmp97_];
		...
		__catch10_g_error:
		{
			...
			g_signal_emit_by_name ((FolksPersonaStore*) _data_->self, "removed");
			_data_->_tmp101_ = NULL;
			_data_->_tmp101_ = _ ("Couldn't get address book capabilities: %s");
			_data_->_tmp102_ = NULL;
			_data_->_tmp102_ = _data_->e2;
			_data_->_tmp103_ = NULL;
			_data_->_tmp103_ = _data_->_tmp102_->message;
			_data_->_tmp104_ = NULL;
			_data_->_tmp104_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp101_, _data_->_tmp103_);
			_data_->_inner_error_ = _data_->_tmp104_;
		...
		_data_->do_initial_query = FALSE;
		{
			...
			_data_->_tmp105_ = NULL;
			_data_->_tmp105_ = _data_->self->priv->_addressbook;
			_data_->_tmp106_ = NULL;
			_data_->_state_ = 4;
			e_client_get_backend_property ((EClient*) G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp105_, e_book_client_get_type (), EBookClient), "capabilities", NULL, edsf_persona_store_prepare_ready, _data_);
			return FALSE;
			_state_4:
			e_client_get_backend_property_finish ((EClient*) G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp105_, e_book_client_get_type (), EBookClient), _data_->_res_, &_data_->_tmp106_, &_data_->_inner_error_);
			_g_free0 (_data_->capabilities);
			_data_->capabilities = _data_->_tmp106_;
			if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
				_g_free0 (_data_->capabilities);
				goto __catch11_g_error;
			}
			_data_->_tmp107_ = NULL;
			_data_->_tmp107_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
			_data_->_tmp108_ = NULL;
			_data_->_tmp108_ = _data_->_tmp107_;
			folks_internal_profiling_point ("got capabilities in " "Edsf.PersonaStore (ID: %s)", _data_->_tmp108_);
			_data_->_tmp109_ = NULL;
			_data_->_tmp109_ = _data_->capabilities;
			if (_data_->_tmp109_ != NULL) {
				_data_->_tmp110_ = NULL;
				_data_->_tmp110_ = _data_->capabilities;
				_data_->_tmp111_ = NULL;
				_data_->_tmp112_ = NULL;
				_data_->_tmp112_ = _data_->_tmp111_ = g_strsplit ((const gchar*) _data_->_tmp110_, ",", 0);
				_data_->caps_length1 = 0;
				_data_->_caps_size_ = 0;
				_data_->caps = _data_->_tmp112_;
				_data_->caps_length1 = _vala_array_length (_data_->_tmp111_);
				_data_->_caps_size_ = _data_->caps_length1;
				_data_->_tmp113_ = NULL;
				_data_->_tmp113__length1 = 0;
				_data_->_tmp113_ = _data_->caps;
				_data_->_tmp113__length1 = _data_->caps_length1;
				_data_->do_initial_query = _vala_string_array_contains (_data_->_tmp113_, _data_->_tmp113__length1, "do-initial-query");
		...
		__catch11_g_error:
		{
			...
			g_signal_emit_by_name ((FolksPersonaStore*) _data_->self, "removed");
			_data_->_tmp114_ = NULL;
			_data_->_tmp114_ = _ ("Couldn't get address book capabilities: %s");
			_data_->_tmp115_ = NULL;
			_data_->_tmp115_ = _data_->e4;
			_data_->_tmp116_ = NULL;
			_data_->_tmp116_ = _data_->_tmp115_->message;
			_data_->_tmp117_ = NULL;
			_data_->_tmp117_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp114_, _data_->_tmp116_);
			_data_->_inner_error_ = _data_->_tmp117_;
		...
		{
			_data_->_tmp119_ = NULL;
			_data_->_tmp119_ = _data_->self->priv->_addressbook;
			_data_->_tmp120_ = NULL;
			_data_->_tmp120_ = _data_->self->priv->_query_str;
			_data_->_tmp121_ = NULL;
			_data_->_state_ = 5;
			e_book_client_get_view (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp119_, e_book_client_get_type (), EBookClient), _data_->_tmp120_, NULL, edsf_persona_store_prepare_ready, _data_);
			return FALSE;
			_state_5:
			_data_->_tmp122_ = FALSE;
			_data_->_tmp122_ = e_book_client_get_view_finish (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp119_, e_book_client_get_type (), EBookClient), _data_->_res_, &_data_->_tmp121_, &_data_->_inner_error_);
			_g_object_unref0 (_data_->self->priv->_ebookview);
			_data_->self->priv->_ebookview = _data_->_tmp121_;
			_data_->_tmp118_ = _data_->_tmp122_;
			if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
				goto __catch12_g_error;
			}
			_data_->got_view = _data_->_tmp118_;
			_data_->_tmp123_ = NULL;
			...
			folks_internal_profiling_point ("opened book view in " "Edsf.PersonaStore (ID: %s)", _data_->_tmp124_);
			_data_->_tmp125_ = FALSE;
			_data_->_tmp125_ = _data_->got_view;
			if (_data_->_tmp125_ == FALSE) {
				_data_->_tmp126_ = NULL;
				_data_->_tmp126_ = _ ("Couldn't get view for address book ‘%s’.");
				_data_->_tmp127_ = NULL;
				_data_->_tmp127_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
				_data_->_tmp128_ = NULL;
				_data_->_tmp128_ = _data_->_tmp127_;
				_data_->_tmp129_ = NULL;
				_data_->_tmp129_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp126_, _data_->_tmp128_);
				_data_->_inner_error_ = _data_->_tmp129_;
				goto __catch12_g_error;
			}
			_data_->_tmp130_ = NULL;
			_data_->_tmp130_ = _data_->self->priv->_ebookview;
			g_signal_connect_object (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp130_, e_book_client_view_get_type (), EBookClientView), "objects-added", (GCallback) __edsf_persona_store_contacts_added_cb_e_book_client_view_objects_added, _data_->self, 0);
			_data_->_tmp131_ = NULL;
			_data_->_tmp131_ = _data_->self->priv->_ebookview;
			g_signal_connect_object (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp131_, e_book_client_view_get_type (), EBookClientView), "objects-removed", (GCallback) __edsf_persona_store_contacts_removed_cb_e_book_client_view_objects_removed, _data_->self, 0);
			_data_->_tmp132_ = NULL;
			_data_->_tmp132_ = _data_->self->priv->_ebookview;
			g_signal_connect_object (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp132_, e_book_client_view_get_type (), EBookClientView), "objects-modified", (GCallback) __edsf_persona_store_contacts_changed_cb_e_book_client_view_objects_modified, _data_->self, 0);
			_data_->_tmp133_ = NULL;
			_data_->_tmp133_ = _data_->self->priv->_ebookview;
			g_signal_connect_object (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp133_, e_book_client_view_get_type (), EBookClientView), "complete", (GCallback) __edsf_persona_store_contacts_complete_cb_e_book_client_view_complete, _data_->self, 0);
			_data_->_tmp134_ = NULL;
			_data_->_tmp134_ = _data_->self->priv->_ebookview;
			e_book_client_view_start (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp134_, e_book_client_view_get_type (), EBookClientView), &_data_->_inner_error_);
			if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
				goto __catch12_g_error;
			}
		}
		...
		__catch12_g_error:
		{
			...
			g_signal_emit_by_name ((FolksPersonaStore*) _data_->self, "removed");
			_data_->_tmp135_ = NULL;
			_data_->_tmp135_ = _data_->e3;
			if (_data_->_tmp135_->domain == E_BOOK_CLIENT_ERROR) {
				_data_->_tmp140_ = NULL;
				_data_->_tmp140_ = _data_->e3;
				if (g_error_matches (_data_->_tmp140_, E_BOOK_CLIENT_ERROR, E_BOOK_CLIENT_ERROR_NO_SUCH_BOOK)) {
					_data_->_tmp139_ = TRUE;
				} else {
					_data_->_tmp141_ = NULL;
					_data_->_tmp141_ = _data_->e3;
					_data_->_tmp139_ = g_error_matches (_data_->_tmp141_, E_BOOK_CLIENT_ERROR, E_BOOK_CLIENT_ERROR_NO_SUCH_SOURCE);
				}
				if (_data_->_tmp139_) {
					...
					_data_->_tmp138_ = g_error_matches (_data_->_tmp142_, E_BOOK_CLIENT_ERROR, E_BOOK_CLIENT_ERROR_CONTACT_NOT_FOUND);
				}
				if (_data_->_tmp138_) {
					_data_->_tmp137_ = TRUE;
				} else {
					_data_->_tmp143_ = NULL;
					_data_->_tmp143_ = _data_->e3;
					_data_->_tmp137_ = g_error_matches (_data_->_tmp143_, E_BOOK_CLIENT_ERROR, E_BOOK_CLIENT_ERROR_CONTACT_ID_ALREADY_EXISTS);
				}
				if (_data_->_tmp137_) {
					_data_->_tmp136_ = TRUE;
				} else {
					_data_->_tmp144_ = NULL;
					_data_->_tmp144_ = _data_->e3;
					_data_->_tmp136_ = g_error_matches (_data_->_tmp144_, E_BOOK_CLIENT_ERROR, E_BOOK_CLIENT_ERROR_NO_SPACE);
				}
				if (_data_->_tmp136_) {
				}
			} else {
				...
				_data_->_tmp146_ = 0U;
				_data_->_tmp146_ = _data_->_tmp145_->domain;
				_data_->_tmp147_ = 0U;
				_data_->_tmp147_ = e_client_error_quark ();
				if (_data_->_tmp146_ == _data_->_tmp147_) {
					_data_->_tmp148_ = NULL;
					_data_->_tmp148_ = _data_->e3;
					_data_->_tmp149_ = 0;
					_data_->_tmp149_ = _data_->_tmp148_->code;
					switch ((EClientError) _data_->_tmp149_) {
						case E_CLIENT_ERROR_REPOSITORY_OFFLINE:
						{
							_data_->_tmp150_ = NULL;
							_data_->_tmp150_ = _ ("Address book ‘%s’ is offline.");
							_data_->_tmp151_ = NULL;
							_data_->_tmp151_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
							_data_->_tmp152_ = NULL;
							_data_->_tmp152_ = _data_->_tmp151_;
							_data_->_tmp153_ = NULL;
							_data_->_tmp153_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _data_->_tmp150_, _data_->_tmp152_);
						...
						{
							_data_->_tmp154_ = NULL;
							_data_->_tmp154_ = _ ("Permission denied to open address book ‘%s’: %s");
							_data_->_tmp155_ = NULL;
							_data_->_tmp155_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
							_data_->_tmp156_ = NULL;
							_data_->_tmp156_ = _data_->_tmp155_;
							_data_->_tmp157_ = NULL;
							_data_->_tmp157_ = _data_->e3;
							_data_->_tmp158_ = NULL;
							_data_->_tmp158_ = _data_->_tmp157_->message;
							_data_->_tmp159_ = NULL;
							_data_->_tmp159_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_PERMISSION_DENIED, _data_->_tmp154_, _data_->_tmp156_, _data_->_tmp158_);
							_data_->_inner_error_ = _data_->_tmp159_;
							_g_error_free0 (_data_->e3);
							goto __finally12;
						}
						default:
			...
			_data_->_tmp160_ = NULL;
			_data_->_tmp160_ = _ ("Couldn't get view for address book ‘%s’: %s");
			_data_->_tmp161_ = NULL;
			_data_->_tmp161_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
			_data_->_tmp162_ = NULL;
			_data_->_tmp162_ = _data_->_tmp161_;
			_data_->_tmp163_ = NULL;
			_data_->_tmp163_ = _data_->e3;
			_data_->_tmp164_ = NULL;
			_data_->_tmp164_ = _data_->_tmp163_->message;
			_data_->_tmp165_ = NULL;
			_data_->_tmp165_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp160_, _data_->_tmp162_, _data_->_tmp164_);
		...
		_data_->_tmp167_ = _data_->do_initial_query;
		if (_data_->_tmp167_ == FALSE) {
			_data_->_tmp168_ = FALSE;
			_data_->_tmp168_ = _data_->self->priv->_is_quiescent;
			_data_->_tmp166_ = _data_->_tmp168_ == FALSE;
		} else {
			_data_->_tmp166_ = FALSE;
		}
		if (_data_->_tmp166_) {
			_data_->_tmp169_ = NULL;
			_data_->_tmp169_ = _data_->self->priv->_pending_personas;
			_vala_assert (_data_->_tmp169_ == NULL, "this._pending_personas == null");
...
static FolksPersonaDetail _edsf_persona_store_eds_field_name_to_folks_persona_detail (EdsfPersonaStore* self, const gchar* eds_field_name) {
	...
	switch (_tmp2_) {
		...
		case E_CONTACT_X509_CERT:
		{
			...
			g_debug ("edsf-persona-store.vala:1215: Unsupported/Unknown EDS field name '%s'.", _tmp3_);
			result = FOLKS_PERSONA_DETAIL_INVALID;
			return result;
		}
	}
...
static void ___lambda9_ (Block2Data* _data2_, GObject* obj, GParamSpec* pspec) {
	...
	g_return_if_fail (pspec != NULL);
	_data2_->received_notification = TRUE;
	_tmp0_ = _data2_->has_yielded;
	if (_tmp0_ == TRUE) {
		_edsf_persona_store_commit_modified_property_co (_data1_->_async_data_);
	}
}
...
static gboolean _edsf_persona_store_commit_modified_property_co (EdsfPersonaStoreCommitModifiedPropertyData* _data_) {
	...
	if (_data_->_tmp4_ == TRUE) {
		...
		g_debug ("edsf-persona-store.vala:1235: Committing modified property ‘%s’ to per" \
"sona %p (UID: %s).", _data_->_tmp5_, _data_->_tmp6_, _data_->_tmp9_);
		...
		g_debug ("edsf-persona-store.vala:1238: Modified vCard: %s", _data_->_tmp14_);
	...
	_data_->timeout_id = (guint) 0;
	{
		...
		_data_->_tmp21_ = NULL;
		_data_->_tmp21_ = g_strconcat ("notify::", _data_->_tmp20_, NULL);
		_data_->_tmp22_ = 0UL;
		_data_->_tmp22_ = g_signal_connect_data ((GObject*) _data_->_tmp19_, _data_->_tmp21_, (GCallback) ____lambda9__g_object_notify, block2_data_ref (_data_->_data2_), (GClosureNotify) block2_data_unref, 0);
		_data_->signal_id = _data_->_tmp22_;
		_g_free0 (_data_->_tmp21_);
		_data_->_tmp23_ = NULL;
		_data_->_tmp23_ = _data_->self->priv->_addressbook;
		_data_->_tmp24_ = NULL;
		_data_->_tmp24_ = _data_->contact;
		_data_->_state_ = 1;
		e_book_client_modify_contact (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp23_, e_book_client_get_type (), EBookClient), _data_->_tmp24_, NULL, _edsf_persona_store_commit_modified_property_ready, _data_);
		return FALSE;
		_state_1:
		e_book_client_modify_contact_finish (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp23_, e_book_client_get_type (), EBookClient), _data_->_res_, &_data_->_inner_error_);
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
		...
		_data_->_tmp25_ = 0U;
		_data_->_tmp25_ = g_timeout_add_seconds_full (G_PRIORITY_LOW, EDSF_PERSONA_STORE__property_change_timeout, ____lambda10__gsource_func, block2_data_ref (_data_->_data2_), block2_data_unref);
		_data_->timeout_id = _data_->_tmp25_;
		_data_->_tmp26_ = FALSE;
		_data_->_tmp26_ = _data_->_data2_->received_notification;
		if (_data_->_tmp26_ == FALSE) {
			g_debug ("edsf-persona-store.vala:1287: Yielding.");
		...
		_data_->_tmp28_ = _data_->_data2_->received_notification;
		if (_data_->_tmp28_) {
			_data_->_tmp27_ = "yes";
		} else {
			_data_->_tmp27_ = "no";
		...
		_data_->_tmp30_ = _data_->_data2_->has_yielded;
		if (_data_->_tmp30_) {
			_data_->_tmp29_ = "yes";
		} else {
			_data_->_tmp29_ = "no";
		}
		g_debug ("edsf-persona-store.vala:1292: Finished: received_notification = %s, ha" \
"s_yielded = %s", _data_->_tmp27_, _data_->_tmp29_);
		_data_->_tmp31_ = FALSE;
		_data_->_tmp31_ = _data_->_data2_->received_notification;
		if (_data_->_tmp31_ == FALSE) {
			_data_->_tmp32_ = NULL;
			_data_->_tmp32_ = _ ("Changing the ‘%s’ property failed due to reaching the timeout.");
			_data_->_tmp33_ = NULL;
			_data_->_tmp33_ = _data_->property_name;
			_data_->_tmp34_ = NULL;
			_data_->_tmp34_ = g_error_new (FOLKS_PROPERTY_ERROR, FOLKS_PROPERTY_ERROR_UNKNOWN_ERROR, _data_->_tmp32_, _data_->_tmp33_);
	...
	__catch13_g_error:
	{
		...
		_data_->_tmp37_ = NULL;
		_data_->_tmp37_ = edsf_persona_store_e_client_error_to_property_error (_data_->self, _data_->_tmp35_, _data_->_tmp36_);
		_data_->_inner_error_ = _data_->_tmp37_;
		_g_error_free0 (_data_->e);
		goto __finally13;
	}
	__finally13:
	{
		...
		if (_data_->_tmp38_ != ((gulong) 0)) {
			_data_->_tmp39_ = NULL;
			_data_->_tmp39_ = _data_->persona;
			_data_->_tmp40_ = 0UL;
			_data_->_tmp40_ = _data_->signal_id;
			g_signal_handler_disconnect ((GObject*) _data_->_tmp39_, _data_->_tmp40_);
		}
		_data_->_tmp41_ = 0U;
		_data_->_tmp41_ = _data_->timeout_id;
		if (_data_->_tmp41_ != ((guint) 0)) {
			_data_->_tmp42_ = 0U;
			_data_->_tmp42_ = _data_->timeout_id;
			g_source_remove (_data_->_tmp42_);
		}
	}
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
		if (_data_->_inner_error_->domain == FOLKS_PROPERTY_ERROR) {
...
static void _edsf_persona_store_set_contact_system_groups (EdsfPersonaStore* self, EContact* contact, GeeSet* system_groups) {
	...
	_tmp10_ = e_vcard_attribute_new ("", _tmp9_);
	new_attr = _tmp10_;
	{
		GeeIterator* _group_it = NULL;
		GeeSet* _tmp11_ = NULL;
...
static gboolean __lambda6_ (Block3Data* _data3_) {
	...
	gboolean _tmp0_ = FALSE;
	self = _data3_->self;
	_tmp0_ = _edsf_persona_store_contacts_added_idle (self, (GeeList*) _data3_->copy);
	result = _tmp0_;
	return result;
}
...
static void _edsf_persona_store_contacts_added_cb (EdsfPersonaStore* self, GList* contacts) {
	...
	_data3_->copy = _tmp1_;
	_edsf_persona_store_idle_queue (self, ___lambda6__gsource_func, block3_data_ref (_data3_), block3_data_unref);
...
static gboolean _edsf_persona_store_contacts_added_idle (EdsfPersonaStore* self, GeeList* contacts) {
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp23_ == FALSE) {
				...
				EContact* _tmp24_ = NULL;
				EdsfPersona* _tmp25_ = NULL;
				GeeHashMap* _tmp26_ = NULL;
				EdsfPersona* _tmp27_ = NULL;
				const gchar* _tmp28_ = NULL;
				const gchar* _tmp29_ = NULL;
				EdsfPersona* _tmp30_ = NULL;
				GeeHashSet* _tmp31_ = NULL;
				EdsfPersona* _tmp32_ = NULL;
				_tmp24_ = c;
	...
	if (_tmp33_) {
		...
		_tmp38_ = added_personas;
		_folks_persona_store_emit_personas_changed ((FolksPersonaStore*) self, (GeeSet*) _tmp38_, NULL, NULL, NULL, FOLKS_GROUP_DETAILS_CHANGE_REASON_NONE);
	}
	result = FALSE;
	_g_object_unref0 (added_personas);
	return result;
...
static gboolean __lambda8_ (Block4Data* _data4_) {
	...
	gboolean _tmp0_ = FALSE;
	self = _data4_->self;
	_tmp0_ = _edsf_persona_store_contacts_changed_idle (self, (GeeList*) _data4_->copy);
	result = _tmp0_;
	return result;
}
...
static void _edsf_persona_store_contacts_changed_cb (EdsfPersonaStore* self, GList* contacts) {
	...
	_tmp1_ = _edsf_persona_store_copy_contacts (self, _tmp0_);
	_data4_->copy = _tmp1_;
	_edsf_persona_store_idle_queue (self, ___lambda8__gsource_func, block4_data_ref (_data4_), block4_data_unref);
...
static gboolean __lambda7_ (Block5Data* _data5_) {
	...
	gboolean _tmp0_ = FALSE;
	self = _data5_->self;
	_tmp0_ = _edsf_persona_store_contacts_removed_idle (self, (GeeList*) _data5_->copy);
	result = _tmp0_;
	return result;
}
...
static void _edsf_persona_store_contacts_removed_cb (EdsfPersonaStore* self, GList* contacts_ids) {
	...
	_data5_->copy = _tmp1_;
	_edsf_persona_store_idle_queue (self, ___lambda7__gsource_func, block5_data_ref (_data5_), block5_data_unref);
...
static void _edsf_persona_store_contacts_complete_cb (EdsfPersonaStore* self, GError* err) {
	...
	if (_tmp2_ != NULL) {
		...
		g_warning ("edsf-persona-store.vala:2409: Error in address book view query: %s", _tmp4_);
	}
	...
	_edsf_persona_store_idle_queue (self, ___lambda11__gsource_func, block6_data_ref (_data6_), block6_data_unref);
...
static gboolean _edsf_persona_store_contacts_complete_idle_cb (EdsfPersonaStore* self, GError* err) {
	...
	if (_tmp0_ == FALSE) {
		...
		_tmp1_ = err;
		if (_tmp1_ != NULL) {
			g_warning ("edsf-persona-store.vala:2429: %s", "Error is considered unrecoverable. " "Removing persona store.");
...
static void edsf_persona_store_finalize (GObject* obj) {
	...
	__catch3_g_error:
	{
		...
		if (_tmp19_) {
			...
			_tmp22_ = e;
			_tmp23_ = _tmp22_->message;
			g_warning ("edsf-persona-store.vala:371: ~PersonaStore: %s\n", _tmp23_);
		}
		_g_error_free0 (e);
	}
	__finally3:
