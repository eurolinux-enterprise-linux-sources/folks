/* dummy-persona-store.c generated by valac 0.26.2.1-1f25, the Vala compiler
...
static gboolean folks_dummy_persona_store_real_remove_persona_co (FolksDummyPersonaStoreRemovePersonaData* _data_) {
	...
	g_return_val_if_fail (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp0_, FOLKS_DUMMY_TYPE_PERSONA), FALSE);
	_data_->_tmp1_ = FALSE;
