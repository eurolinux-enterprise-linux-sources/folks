/* dummy-persona-store.c generated by valac 0.35.3.10-6b27, the Vala compiler
...
void folks_dummy_persona_store_register_personas (FolksDummyPersonaStore* self, GeeSet* personas) {
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp29_ == TRUE) {
				GeeHashMap* _tmp30_;
				FolksDummyPersona* _tmp31_;
				const gchar* _tmp32_;
				const gchar* _tmp33_;
				FolksDummyPersona* _tmp34_;
...
FolksDummyPersonaStoreAddPersonaFromDetailsMock folks_dummy_persona_store_get_add_persona_from_details_mock (FolksDummyPersonaStore* self, gpointer* result_target) {
	...
	FolksDummyPersonaStoreAddPersonaFromDetailsMock _tmp0_;
	void* _tmp0__target;
	FolksDummyPersonaStoreAddPersonaFromDetailsMock _tmp1_;
	void* _tmp1__target;
...
FolksDummyPersonaStoreRemovePersonaMock folks_dummy_persona_store_get_remove_persona_mock (FolksDummyPersonaStore* self, gpointer* result_target) {
	...
	FolksDummyPersonaStoreRemovePersonaMock _tmp0_;
	void* _tmp0__target;
...
FolksDummyPersonaStorePrepareMock folks_dummy_persona_store_get_prepare_mock (FolksDummyPersonaStore* self, gpointer* result_target) {
	...
	FolksDummyPersonaStorePrepareMock _tmp0_;
	void* _tmp0__target;
	FolksDummyPersonaStorePrepareMock _tmp1_;
	void* _tmp1__target;
	g_return_val_if_fail (self != NULL, NULL);
...
void folks_dummy_persona_store_set_persona_type (FolksDummyPersonaStore* self, GType value) {
	g_return_if_fail (self != NULL);
	if (folks_dummy_persona_store_get_persona_type (self) != value) {
		GType _tmp0_;
		gboolean _tmp1_;
		GType _tmp2_;
		GType _tmp3_;
