/* trf-persona.c generated by valac 0.35.3.10-6b27, the Vala compiler
...
static void _trf_persona_update_postal_addresses (TrfPersona* self) {
	...
	gchar* _tmp2_;
	const gchar* _tmp3_;
	FolksSmallSet* postal_addresses;
		...
		for (a_it = 0; a_it < _tmp8__length1; a_it = a_it + 1) {
			...
			a = _tmp9_;
			{
				...
				if (!_tmp41_) {
					...
					FolksPostalAddressFieldDetails* _tmp48_;
					_tmp42_ = pa;
...
static void trf_persona_set_tracker_id (TrfPersona* self, const gchar* value) {
	g_return_if_fail (self != NULL);
	if (g_strcmp0 (value, trf_persona_get_tracker_id (self)) != 0) {
		const gchar* _tmp0_;
		gchar* _tmp1_;
		_tmp0_ = value;
...
static void trf_persona_set_cursor (TrfPersona* self, TrackerSparqlCursor* value) {
	g_return_if_fail (self != NULL);
	if (trf_persona_get_cursor (self) != value) {
		TrackerSparqlCursor* _tmp0_;
		_tmp0_ = value;
