/* trf-persona-store.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
struct _TrfPersonaStoreDoUpdateData {
	...
	TrfPersona* _tmp173_;
	TrfAfflInfo* _tmp174_;
	const gchar* _tmp175_;
	const gchar* _tmp176_;
	TrfAfflInfo* _tmp177_;
	const gchar* _tmp178_;
	const gchar* _tmp179_;
	TrfAfflInfo* _tmp180_;
	const gchar* _tmp181_;
	const gchar* _tmp182_;
	TrfAfflInfo* _tmp183_;
	const gchar* _tmp184_;
	const gchar* _tmp185_;
	TrfAfflInfo* _tmp186_;
	FolksPostalAddressFieldDetails* _tmp187_;
	TrfPersona* _tmp188_;
	TrfAfflInfo* _tmp189_;
	FolksPostalAddressFieldDetails* _tmp190_;
	TrfAfflInfo* _tmp191_;
	const gchar* _tmp192_;
	const gchar* _tmp193_;
	TrfPersona* _tmp194_;
	TrfAfflInfo* _tmp195_;
	...
	gchar* _tmp200_;
	gchar* _tmp201_;
	TrfAfflInfo* _tmp202_;
	const gchar* _tmp203_;
	const gchar* _tmp204_;
	TrfPersona* _tmp205_;
	TrfAfflInfo* _tmp206_;
...
struct _TrfPersonaStoreSetAttribSetData {
	...
	gboolean _tmp81_;
	FolksAbstractFieldDetails* _tmp82_;
	gconstpointer _tmp83_;
	const gchar* _tmp84_;
	gchar* _tmp85_;
	GObject* _tmp86_;
	...
	gint _tmp88_;
	gchar* _tmp89_;
	TrackerSparqlBuilder* _tmp90_;
	const gchar* _tmp91_;
	TrackerSparqlBuilder* _tmp92_;
	TrackerSparqlBuilder* _tmp93_;
	const gchar* _tmp94_;
	...
	gchar* _tmp132_;
	TrackerSparqlBuilder* _tmp133_;
	TrackerSparqlBuilder* _tmp134_;
...
static const gchar* TRF_PERSONA_STORE__always_writeable_properties[16] = {"alias", "phone-numbers", "email-addresses", "avatar", "structured-name", "full-name", "gender", "birthday", "roles", "notes", "urls", "im-addresses", "is-favourite", "local-ids", "web-service-addresses", NULL};
	...
	if (_data_->_tmp361_ != NULL) {
		...
		_data_->ret_personas = _data_->_tmp367_;
		{
			...
			while (TRUE) {
				...
				_data_->_tmp374_ = NULL;
				_data_->_tmp374_ = _data_->p;
				_data_->_tmp375_ = NULL;
		...
		g_debug ("trf-persona-store.vala:767: Failed to inserting the new persona  into " \
"Tracker.");
	}
	_data_->_tmp377_ = NULL;
	_data_->_tmp377_ = _data_->ret;
	if (_data_->_tmp377_ != NULL) {
		_data_->_tmp378_ = NULL;
	...
	if (_data_->_tmp376_) {
		_data_->_tmp379_ = NULL;
		_data_->_tmp379_ = _data_->ret;
		_data_->_tmp380_ = NULL;
		_data_->_tmp380_ = _data_->avatar;
		_data_->_state_ = 5;
		_trf_persona_store_set_avatar (_data_->self, (FolksPersona*) _data_->_tmp379_, _data_->_tmp380_, trf_persona_store_add_persona_from_details_ready, _data_);
		return FALSE;
		_state_5:
		...
		while (TRUE) {
			...
			first = TRUE;
			{
				...
				while (TRUE) {
					...
					FolksWebServiceFieldDetails* _tmp31_ = NULL;
	...
	_tmp4__length1 = services_length1;
	{
		...
		for (service_line_it = 0; service_line_it < _tmp4__length1; service_line_it = service_line_it + 1) {
			...
			service_line = _tmp5_;
			{
				...
				gchar** _tmp7_ = NULL;
				gchar** _tmp8_ = NULL;
				gint service_t_length1 = 0;
				gint _service_t_size_ = 0;
				...
				_tmp16__length1 = addrs_length1;
				{
					...
					for (a_it = 0; a_it < _tmp16__length1; a_it = a_it + 1) {
						...
						a = _tmp17_;
						{
							...
							FolksWebServiceFieldDetails* _tmp21_ = NULL;
							FolksWebServiceFieldDetails* _tmp22_ = NULL;
							_tmp18_ = ret;
	...
	_data_->affiliations = _data_->_tmp1_;
	{
		...
		while (TRUE) {
			...
			if (_data_->_tmp14_) {
				...
				_data_->_state_ = 2;
				_trf_persona_store_phones_from_affiliation (_data_->self, _data_->_tmp17_, _trf_persona_store_remove_attributes_ready, _data_);
				return FALSE;
				_state_2:
				_data_->_tmp18_ = NULL;
				_data_->_tmp18_ = _trf_persona_store_phones_from_affiliation_finish (_data_->self, _data_->_res_);
				_data_->phones = _data_->_tmp18_;
				{
					_data_->_tmp19_ = NULL;
					_data_->_tmp19_ = _data_->phones;
					_data_->_tmp20_ = NULL;
					_data_->_tmp20_ = _g_object_ref0 (_data_->_tmp19_);
					_data_->_phone_list = _data_->_tmp20_;
					_data_->_tmp21_ = NULL;
					_data_->_tmp21_ = _data_->_phone_list;
					_data_->_tmp22_ = 0;
					_data_->_tmp22_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp21_);
					_data_->_tmp23_ = 0;
					_data_->_tmp23_ = _data_->_tmp22_;
					_data_->_phone_size = _data_->_tmp23_;
					_data_->_phone_index = -1;
					while (TRUE) {
						_data_->_tmp24_ = 0;
						_data_->_tmp24_ = _data_->_phone_index;
						_data_->_phone_index = _data_->_tmp24_ + 1;
						_data_->_tmp25_ = 0;
						_data_->_tmp25_ = _data_->_phone_index;
						_data_->_tmp26_ = 0;
						_data_->_tmp26_ = _data_->_phone_size;
						if (!(_data_->_tmp25_ < _data_->_tmp26_)) {
							break;
						}
						_data_->_tmp27_ = NULL;
						_data_->_tmp27_ = _data_->_phone_list;
						_data_->_tmp28_ = 0;
						_data_->_tmp28_ = _data_->_phone_index;
						_data_->_tmp29_ = NULL;
						_data_->_tmp29_ = folks_small_set_get (_data_->_tmp27_, _data_->_tmp28_);
						_data_->_tmp30_ = NULL;
						_data_->_tmp30_ = g_strdup ((const gchar*) _data_->_tmp29_);
						_data_->phone = _data_->_tmp30_;
						_data_->got_attrib = TRUE;
						_data_->_tmp31_ = NULL;
						_data_->_tmp31_ = _data_->phone;
						_data_->_state_ = 3;
						_trf_persona_store_delete_resource (_data_->self, _data_->_tmp31_, TRUE, _trf_persona_store_remove_attributes_ready, _data_);
						return FALSE;
						_state_3:
			...
			_data_->_tmp33_ = '\0';
			_data_->_tmp33_ = _data_->remove_flag;
			if ((_data_->_tmp33_ & _REMOVE_ALL_ATTRIBS) == _REMOVE_ALL_ATTRIBS) {
				_data_->_tmp32_ = TRUE;
			} else {
				_data_->_tmp34_ = '\0';
				_data_->_tmp34_ = _data_->remove_flag;
				_data_->_tmp32_ = (_data_->_tmp34_ & _REMOVE_POSTALS) == _REMOVE_POSTALS;
			}
			if (_data_->_tmp32_) {
				_data_->_tmp35_ = NULL;
				_data_->_tmp35_ = _data_->affl;
				_data_->_state_ = 4;
				_trf_persona_store_postals_from_affiliation (_data_->self, _data_->_tmp35_, _trf_persona_store_remove_attributes_ready, _data_);
				return FALSE;
				_state_4:
				_data_->_tmp36_ = NULL;
				_data_->_tmp36_ = _trf_persona_store_postals_from_affiliation_finish (_data_->self, _data_->_res_);
				_data_->postals = _data_->_tmp36_;
				{
					_data_->_tmp37_ = NULL;
					_data_->_tmp37_ = _data_->postals;
					_data_->_tmp38_ = NULL;
					_data_->_tmp38_ = _g_object_ref0 (_data_->_tmp37_);
					_data_->_postal_list = _data_->_tmp38_;
					_data_->_tmp39_ = NULL;
					_data_->_tmp39_ = _data_->_postal_list;
					_data_->_tmp40_ = 0;
					_data_->_tmp40_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp39_);
					_data_->_tmp41_ = 0;
					_data_->_tmp41_ = _data_->_tmp40_;
					_data_->_postal_size = _data_->_tmp41_;
					_data_->_postal_index = -1;
					while (TRUE) {
						_data_->_tmp42_ = 0;
						_data_->_tmp42_ = _data_->_postal_index;
						_data_->_postal_index = _data_->_tmp42_ + 1;
						_data_->_tmp43_ = 0;
						_data_->_tmp43_ = _data_->_postal_index;
						_data_->_tmp44_ = 0;
						_data_->_tmp44_ = _data_->_postal_size;
						if (!(_data_->_tmp43_ < _data_->_tmp44_)) {
							break;
						}
						_data_->_tmp45_ = NULL;
						_data_->_tmp45_ = _data_->_postal_list;
						_data_->_tmp46_ = 0;
						_data_->_tmp46_ = _data_->_postal_index;
						_data_->_tmp47_ = NULL;
						_data_->_tmp47_ = folks_small_set_get (_data_->_tmp45_, _data_->_tmp46_);
						_data_->_tmp48_ = NULL;
						_data_->_tmp48_ = g_strdup ((const gchar*) _data_->_tmp47_);
						_data_->postal = _data_->_tmp48_;
						_data_->got_attrib = TRUE;
						_data_->_tmp49_ = NULL;
						_data_->_tmp49_ = _data_->postal;
						_data_->_state_ = 5;
						_trf_persona_store_delete_resource (_data_->self, _data_->_tmp49_, TRUE, _trf_persona_store_remove_attributes_ready, _data_);
						return FALSE;
						_state_5:
						_trf_persona_store_delete_resource_finish (_data_->self, _data_->_res_);
						_g_free0 (_data_->postal);
			...
			_data_->_tmp51_ = '\0';
			_data_->_tmp51_ = _data_->remove_flag;
			if ((_data_->_tmp51_ & _REMOVE_ALL_ATTRIBS) == _REMOVE_ALL_ATTRIBS) {
				_data_->_tmp50_ = TRUE;
			} else {
				_data_->_tmp52_ = '\0';
				_data_->_tmp52_ = _data_->remove_flag;
				_data_->_tmp50_ = (_data_->_tmp52_ & _REMOVE_IM_ADDRS) == _REMOVE_IM_ADDRS;
			}
			if (_data_->_tmp50_) {
				_data_->_tmp53_ = NULL;
				_data_->_tmp53_ = _data_->affl;
				_data_->_state_ = 6;
				_trf_persona_store_imaddrs_from_affiliation (_data_->self, _data_->_tmp53_, _trf_persona_store_remove_attributes_ready, _data_);
				return FALSE;
				_state_6:
				_data_->_tmp54_ = NULL;
				_data_->_tmp54_ = _trf_persona_store_imaddrs_from_affiliation_finish (_data_->self, _data_->_res_);
				_data_->im_addrs = _data_->_tmp54_;
				{
					_data_->_tmp55_ = NULL;
					_data_->_tmp55_ = _data_->im_addrs;
					_data_->_tmp56_ = NULL;
					_data_->_tmp56_ = _g_object_ref0 (_data_->_tmp55_);
					_data_->_im_addr_list = _data_->_tmp56_;
					_data_->_tmp57_ = NULL;
					_data_->_tmp57_ = _data_->_im_addr_list;
					_data_->_tmp58_ = 0;
					_data_->_tmp58_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp57_);
					_data_->_tmp59_ = 0;
					_data_->_tmp59_ = _data_->_tmp58_;
					_data_->_im_addr_size = _data_->_tmp59_;
					_data_->_im_addr_index = -1;
					while (TRUE) {
						_data_->_tmp60_ = 0;
						_data_->_tmp60_ = _data_->_im_addr_index;
						_data_->_im_addr_index = _data_->_tmp60_ + 1;
						_data_->_tmp61_ = 0;
						_data_->_tmp61_ = _data_->_im_addr_index;
						_data_->_tmp62_ = 0;
						_data_->_tmp62_ = _data_->_im_addr_size;
						if (!(_data_->_tmp61_ < _data_->_tmp62_)) {
							break;
						}
						_data_->_tmp63_ = NULL;
						_data_->_tmp63_ = _data_->_im_addr_list;
						_data_->_tmp64_ = 0;
						_data_->_tmp64_ = _data_->_im_addr_index;
						_data_->_tmp65_ = NULL;
						_data_->_tmp65_ = folks_small_set_get (_data_->_tmp63_, _data_->_tmp64_);
						_data_->_tmp66_ = NULL;
						_data_->_tmp66_ = g_strdup ((const gchar*) _data_->_tmp65_);
						_data_->im_addr = _data_->_tmp66_;
						_data_->got_attrib = TRUE;
						_data_->_tmp67_ = NULL;
						_data_->_tmp67_ = _data_->im_addr;
						_data_->_state_ = 7;
						_trf_persona_store_delete_resource (_data_->self, _data_->_tmp67_, TRUE, _trf_persona_store_remove_attributes_ready, _data_);
						return FALSE;
						_state_7:
						_trf_persona_store_delete_resource_finish (_data_->self, _data_->_res_);
			...
			_data_->_tmp69_ = '\0';
			_data_->_tmp69_ = _data_->remove_flag;
			if ((_data_->_tmp69_ & _REMOVE_ALL_ATTRIBS) == _REMOVE_ALL_ATTRIBS) {
				_data_->_tmp68_ = TRUE;
			} else {
				_data_->_tmp70_ = '\0';
				_data_->_tmp70_ = _data_->remove_flag;
				_data_->_tmp68_ = (_data_->_tmp70_ & _REMOVE_EMAILS) == _REMOVE_EMAILS;
			}
			if (_data_->_tmp68_) {
				_data_->_tmp71_ = NULL;
				_data_->_tmp71_ = _data_->affl;
				_data_->_state_ = 8;
				_trf_persona_store_emails_from_affiliation (_data_->self, _data_->_tmp71_, _trf_persona_store_remove_attributes_ready, _data_);
				return FALSE;
				_state_8:
				_data_->_tmp72_ = NULL;
				_data_->_tmp72_ = _trf_persona_store_emails_from_affiliation_finish (_data_->self, _data_->_res_);
				_data_->emails = _data_->_tmp72_;
				{
					_data_->_tmp73_ = NULL;
					_data_->_tmp73_ = _data_->emails;
					_data_->_tmp74_ = NULL;
					_data_->_tmp74_ = _g_object_ref0 (_data_->_tmp73_);
					_data_->_email_list = _data_->_tmp74_;
					_data_->_tmp75_ = NULL;
					_data_->_tmp75_ = _data_->_email_list;
					_data_->_tmp76_ = 0;
					_data_->_tmp76_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp75_);
					_data_->_tmp77_ = 0;
					_data_->_tmp77_ = _data_->_tmp76_;
					_data_->_email_size = _data_->_tmp77_;
					_data_->_email_index = -1;
					while (TRUE) {
						_data_->_tmp78_ = 0;
						_data_->_tmp78_ = _data_->_email_index;
						_data_->_email_index = _data_->_tmp78_ + 1;
						_data_->_tmp79_ = 0;
						_data_->_tmp79_ = _data_->_email_index;
						_data_->_tmp80_ = 0;
						_data_->_tmp80_ = _data_->_email_size;
						if (!(_data_->_tmp79_ < _data_->_tmp80_)) {
							break;
						}
						_data_->_tmp81_ = NULL;
						_data_->_tmp81_ = _data_->_email_list;
						_data_->_tmp82_ = 0;
						_data_->_tmp82_ = _data_->_email_index;
						_data_->_tmp83_ = NULL;
						_data_->_tmp83_ = folks_small_set_get (_data_->_tmp81_, _data_->_tmp82_);
						_data_->_tmp84_ = NULL;
						_data_->_tmp84_ = g_strdup ((const gchar*) _data_->_tmp83_);
						_data_->email = _data_->_tmp84_;
						_data_->got_attrib = TRUE;
						_data_->_tmp85_ = NULL;
						_data_->_tmp85_ = _data_->email;
						_data_->_state_ = 9;
						_trf_persona_store_delete_resource (_data_->self, _data_->_tmp85_, TRUE, _trf_persona_store_remove_attributes_ready, _data_);
						return FALSE;
						_state_9:
						_trf_persona_store_delete_resource_finish (_data_->self, _data_->_res_);
			...
			_data_->_tmp87_ = _data_->got_attrib;
			if (_data_->_tmp87_) {
				_data_->_tmp86_ = TRUE;
			} else {
				_data_->_tmp88_ = '\0';
				_data_->_tmp88_ = _data_->remove_flag;
				_data_->_tmp86_ = (_data_->_tmp88_ & _REMOVE_ALL_ATTRIBS) == _REMOVE_ALL_ATTRIBS;
			}
			if (_data_->_tmp86_) {
				_data_->_tmp89_ = NULL;
				_data_->_tmp89_ = _data_->affl;
				_data_->_state_ = 10;
...
static void __trf_persona_store_graph_updated_cb_gd_bus_signal_callback (GDBusConnection* connection, const gchar* sender_name, const gchar* object_path, const gchar* interface_name, const gchar* signal_name, GVariant* parameters, gpointer self) {
	_trf_persona_store_graph_updated_cb ((TrfPersonaStore*) self, connection, sender_name, object_path, interface_name, signal_name, parameters);
}
...
static gboolean trf_persona_store_real_prepare_co (TrfPersonaStorePrepareData* _data_) {
	...
	}
	{
		_data_->self->priv->_prepare_pending = TRUE;
		{
			...
			_state_1:
			_data_->_tmp6_ = NULL;
			_data_->_tmp6_ = tracker_sparql_connection_get_finish (_data_->_res_, &_data_->_inner_error_);
			...
			_data_->self->priv->_connection = _data_->_tmp7_;
			_data_->_tmp8_ = NULL;
			_data_->_tmp8_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
			_data_->_tmp9_ = NULL;
			_data_->_tmp9_ = _data_->_tmp8_;
			folks_internal_profiling_point ("got connection in " "Trf.PersonaStore (ID: %s)", _data_->_tmp9_);
			_data_->_state_ = 2;
			...
			folks_internal_profiling_point ("build predicates table in " "Trf.PersonaStore (ID: %s)", _data_->_tmp11_);
			_data_->_tmp12_ = NULL;
			...
			_data_->self->priv->_resources_object = _data_->_tmp20_;
			_data_->_tmp21_ = NULL;
			_data_->_tmp21_ = _data_->self->priv->_resources_object;
			_data_->_tmp22_ = NULL;
			g_object_get ((GDBusProxy*) _data_->_tmp21_, "g-connection", &_data_->_tmp22_, NULL);
			_data_->_tmp23_ = NULL;
			_data_->_tmp23_ = _data_->_tmp22_;
			_data_->_tmp24_ = NULL;
			_data_->_tmp24_ = _data_->_tmp23_;
			g_dbus_connection_signal_subscribe (_data_->_tmp24_, TRF_PERSONA_STORE__OBJECT_NAME, TRF_PERSONA_STORE__OBJECT_IFACE, "GraphUpdated", TRF_PERSONA_STORE__OBJECT_PATH, TRF_ONTOLOGY_DEFS_PERSON_CLASS, G_DBUS_SIGNAL_FLAGS_NONE, __trf_persona_store_graph_updated_cb_gd_bus_signal_callback, g_object_ref (_data_->self), g_object_unref);
			_g_object_unref0 (_data_->_tmp24_);
			_data_->_tmp25_ = NULL;
			_data_->_tmp25_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
			_data_->_tmp26_ = NULL;
			_data_->_tmp26_ = _data_->_tmp25_;
			folks_internal_profiling_point ("got resources proxy in " "Trf.PersonaStore (ID: %s)", _data_->_tmp26_);
		...
		__catch2_g_io_error:
		{
			...
			if (!g_error_matches (_data_->_tmp27_, G_IO_ERROR, G_IO_ERROR_CLOSED)) {
				_data_->_tmp28_ = NULL;
				_data_->_tmp28_ = _data_->e1;
				_data_->_tmp29_ = NULL;
				_data_->_tmp29_ = _data_->_tmp28_->message;
				g_warning ("trf-persona-store.vala:1140: Could not connect to D-Bus service: %s", _data_->_tmp29_);
			}
			...
			_data_->_tmp32_ = NULL;
			_data_->_tmp32_ = g_error_new_literal (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp31_);
		...
		__catch2_tracker_sparql_error:
		{
			...
			g_warning ("trf-persona-store.vala:1149: Error fetching SPARQL connection handler:" \
" %s", _data_->_tmp34_);
			g_signal_emit_by_name ((FolksPersonaStore*) _data_->self, "removed");
			_data_->_tmp35_ = NULL;
			_data_->_tmp35_ = _data_->e2;
			_data_->_tmp36_ = NULL;
			_data_->_tmp36_ = _data_->_tmp35_->message;
			_data_->_tmp37_ = NULL;
			_data_->_tmp37_ = g_error_new_literal (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp36_);
		...
		__catch2_g_dbus_error:
		{
			...
			g_warning ("trf-persona-store.vala:1156: Could not connect to D-Bus service: %s", _data_->_tmp39_);
			g_signal_emit_by_name ((FolksPersonaStore*) _data_->self, "removed");
			_data_->_tmp40_ = NULL;
			_data_->_tmp40_ = _data_->e3;
			_data_->_tmp41_ = NULL;
			_data_->_tmp41_ = _data_->_tmp40_->message;
			_data_->_tmp42_ = NULL;
			_data_->_tmp42_ = g_error_new_literal (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_INVALID_ARGUMENT, _data_->_tmp41_);
	...
	_data_->_tmp43_ = NULL;
	_data_->_tmp43_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
	_data_->_tmp44_ = NULL;
	_data_->_tmp44_ = _data_->_tmp43_;
	folks_internal_profiling_end ("preparing Trf.PersonaStore (ID: %s)", _data_->_tmp44_, NULL);
	if (_data_->_state_ == 0) {
		g_simple_async_result_complete_in_idle (_data_->_async_result);
	} else {
		g_simple_async_result_complete (_data_->_async_result);
...
static gboolean _trf_persona_store_build_predicates_table_co (TrfPersonaStoreBuildPredicatesTableData* _data_) {
	...
	__catch3_tracker_sparql_error:
	{
		...
		g_warning ("trf-persona-store.vala:1225: Couldn't build predicates table: %s %s", _data_->_tmp51_, _data_->_tmp53_);
		_g_error_free0 (_data_->e1);
	}
	goto __finally3;
	__catch3_g_error:
	{
		...
		g_warning ("trf-persona-store.vala:1229: Couldn't build predicates table: %s %s", _data_->_tmp54_, _data_->_tmp56_);
		_g_error_free0 (_data_->e2);
	}
	__finally3:
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
static gboolean _trf_persona_store_handle_delete_events_co (TrfPersonaStoreHandleDeleteEventsData* _data_) {
	...
	while (TRUE) {
		...
		_data_->_tmp8_ = NULL;
		_data_->_tmp8_ = _data_->_tmp7_;
		memset (&_data_->_tmp9_, 0, sizeof (Event));
		...
		memset (&_data_->_tmp16_, 0, sizeof (Event));
		...
		if (_data_->_tmp17_ == _data_->_tmp18_) {
			memset (&_data_->_tmp19_, 0, sizeof (Event));
		...
		if (_data_->_tmp15_) {
			...
			_data_->_tmp24_ = NULL;
			_data_->_tmp24_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp22_, _data_->_tmp23_);
			_data_->removed_p = (TrfPersona*) _data_->_tmp24_;
			_data_->_tmp25_ = NULL;
			_data_->_tmp25_ = _data_->removed_p;
			if (_data_->_tmp25_ != NULL) {
				_data_->_tmp26_ = NULL;
				_data_->_tmp26_ = _data_->removed_personas;
				_data_->_tmp27_ = NULL;
				_data_->_tmp27_ = _data_->removed_p;
				gee_abstract_collection_add ((GeeAbstractCollection*) _data_->_tmp26_, _data_->_tmp27_);
				_data_->_tmp28_ = NULL;
				_data_->_tmp28_ = _data_->self->priv->_personas;
				_data_->_tmp29_ = NULL;
				_data_->_tmp29_ = _data_->removed_p;
				_data_->_tmp30_ = NULL;
				_data_->_tmp30_ = folks_persona_get_iid ((FolksPersona*) _data_->_tmp29_);
				_data_->_tmp31_ = NULL;
				_data_->_tmp31_ = _data_->_tmp30_;
				gee_abstract_map_unset ((GeeAbstractMap*) _data_->_tmp28_, _data_->_tmp31_, NULL);
			}
			_g_object_unref0 (_data_->removed_p);
		} else {
			_data_->_tmp32_ = NULL;
			_data_->_tmp32_ = _data_->self->priv->_personas;
			_data_->_tmp33_ = NULL;
			_data_->_tmp33_ = _data_->p_id;
			_data_->_tmp34_ = NULL;
			_data_->_tmp34_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp32_, _data_->_tmp33_);
			_data_->persona = (TrfPersona*) _data_->_tmp34_;
			_data_->_tmp35_ = NULL;
			_data_->_tmp35_ = _data_->persona;
			if (_data_->_tmp35_ != NULL) {
				_data_->_tmp36_ = NULL;
				_data_->_tmp36_ = _data_->persona;
				memset (&_data_->_tmp37_, 0, sizeof (Event));
				_data_->_tmp37_ = _data_->e;
				_data_->_state_ = 1;
				_trf_persona_store_do_update (_data_->self, _data_->_tmp36_, &_data_->_tmp37_, FALSE, _trf_persona_store_handle_delete_events_ready, _data_);
				return FALSE;
				_state_1:
	...
	_data_->_tmp38_ = NULL;
	_data_->_tmp38_ = _data_->removed_personas;
	_data_->_tmp39_ = 0;
	...
	if (_data_->_tmp40_ > 0) {
		_data_->_tmp41_ = NULL;
		_data_->_tmp41_ = _data_->removed_personas;
		_folks_persona_store_emit_personas_changed ((FolksPersonaStore*) _data_->self, NULL, (GeeSet*) _data_->_tmp41_, NULL, NULL, FOLKS_GROUP_DETAILS_CHANGE_REASON_NONE);
	}
...
static gboolean _trf_persona_store_handle_insert_events_co (TrfPersonaStoreHandleInsertEventsData* _data_) {
	...
	while (TRUE) {
		...
		memset (&_data_->_tmp3_, 0, sizeof (Event));
		...
		memset (&_data_->_tmp24_, 0, sizeof (Event));
...
static gboolean _trf_persona_store_do_add_contacts_co (TrfPersonaStoreDoAddContactsData* _data_) {
	...
	__catch4_g_error:
	{
		...
		g_warning ("trf-persona-store.vala:1419: Couldn't perform queries: %s %s", _data_->_tmp38_, _data_->_tmp40_);
...
static gboolean _trf_persona_store_do_update_co (TrfPersonaStoreDoUpdateData* _data_) {
	...
	_state_0:
	memset (&_data_->_tmp0_, 0, sizeof (Event));
	...
	if (_data_->_tmp1_ == ((gint) ((gintptr) _data_->_tmp3_))) {
		...
		if (_data_->_tmp5_) {
			memset (&_data_->_tmp6_, 0, sizeof (Event));
		...
		memset (&_data_->_tmp11_, 0, sizeof (Event));
		...
		if (_data_->_tmp12_ == ((gint) ((gintptr) _data_->_tmp14_))) {
			...
			if (_data_->_tmp16_) {
				memset (&_data_->_tmp17_, 0, sizeof (Event));
			...
			memset (&_data_->_tmp22_, 0, sizeof (Event));
			...
			if (_data_->_tmp23_ == ((gint) ((gintptr) _data_->_tmp25_))) {
				...
				if (_data_->_tmp27_) {
					memset (&_data_->_tmp28_, 0, sizeof (Event));
				...
				memset (&_data_->_tmp33_, 0, sizeof (Event));
				...
				if (_data_->_tmp34_ == ((gint) ((gintptr) _data_->_tmp36_))) {
					...
					if (_data_->_tmp38_) {
						memset (&_data_->_tmp39_, 0, sizeof (Event));
						_data_->_tmp39_ = _data_->e;
						_data_->_tmp40_ = 0;
					...
					memset (&_data_->_tmp44_, 0, sizeof (Event));
					...
					if (_data_->_tmp45_ == ((gint) ((gintptr) _data_->_tmp47_))) {
						...
						if (_data_->_tmp49_) {
							memset (&_data_->_tmp50_, 0, sizeof (Event));
						...
						memset (&_data_->_tmp55_, 0, sizeof (Event));
						...
						if (_data_->_tmp56_ == ((gint) ((gintptr) _data_->_tmp58_))) {
							...
							if (_data_->_tmp60_) {
								memset (&_data_->_tmp61_, 0, sizeof (Event));
							...
							memset (&_data_->_tmp66_, 0, sizeof (Event));
							...
							if (_data_->_tmp67_ == ((gint) ((gintptr) _data_->_tmp69_))) {
								...
								if (_data_->_tmp71_) {
									memset (&_data_->_tmp72_, 0, sizeof (Event));
								...
								memset (&_data_->_tmp77_, 0, sizeof (Event));
								...
								if (_data_->_tmp78_ == ((gint) ((gintptr) _data_->_tmp80_))) {
									memset (&_data_->_tmp81_, 0, sizeof (Event));
									...
									memset (&_data_->_tmp87_, 0, sizeof (Event));
									...
									if (_data_->_tmp88_ == ((gint) ((gintptr) _data_->_tmp90_))) {
										...
										if (_data_->_tmp91_) {
											memset (&_data_->_tmp92_, 0, sizeof (Event));
											...
											memset (&_data_->_tmp97_, 0, sizeof (Event));
											...
											memset (&_data_->_tmp102_, 0, sizeof (Event));
										...
										memset (&_data_->_tmp106_, 0, sizeof (Event));
										...
										if (_data_->_tmp107_ == ((gint) ((gintptr) _data_->_tmp109_))) {
											...
											if (_data_->_tmp110_) {
												memset (&_data_->_tmp111_, 0, sizeof (Event));
												...
												memset (&_data_->_tmp116_, 0, sizeof (Event));
												...
												memset (&_data_->_tmp121_, 0, sizeof (Event));
											...
											memset (&_data_->_tmp125_, 0, sizeof (Event));
											...
											if (_data_->_tmp126_ == ((gint) ((gintptr) _data_->_tmp128_))) {
												...
												if (_data_->_tmp129_) {
													memset (&_data_->_tmp130_, 0, sizeof (Event));
													...
													memset (&_data_->_tmp134_, 0, sizeof (Event));
													...
													g_debug ("trf-persona-store.vala:1563: affl_info : %s", _data_->_tmp142_);
													...
													if (_data_->_tmp165_ != NULL) {
														...
														if (_data_->_tmp166_) {
															_data_->_tmp173_ = NULL;
															_data_->_tmp173_ = _data_->p;
															_data_->_tmp174_ = NULL;
															_data_->_tmp174_ = _data_->affl_info;
															_data_->_tmp175_ = NULL;
															_data_->_tmp175_ = trf_affl_info_get_affl_tracker_id (_data_->_tmp174_);
															_data_->_tmp176_ = NULL;
															_data_->_tmp176_ = _data_->_tmp175_;
															_data_->_tmp177_ = NULL;
															_data_->_tmp177_ = _data_->affl_info;
															_data_->_tmp178_ = NULL;
															_data_->_tmp178_ = trf_affl_info_get_role (_data_->_tmp177_);
															_data_->_tmp179_ = NULL;
															_data_->_tmp179_ = _data_->_tmp178_;
															_data_->_tmp180_ = NULL;
															_data_->_tmp180_ = _data_->affl_info;
															_data_->_tmp181_ = NULL;
															_data_->_tmp181_ = trf_affl_info_get_title (_data_->_tmp180_);
															_data_->_tmp182_ = NULL;
															_data_->_tmp182_ = _data_->_tmp181_;
															_data_->_tmp183_ = NULL;
															_data_->_tmp183_ = _data_->affl_info;
															_data_->_tmp184_ = NULL;
															_data_->_tmp184_ = trf_affl_info_get_org (_data_->_tmp183_);
															_data_->_tmp185_ = NULL;
															_data_->_tmp185_ = _data_->_tmp184_;
															_trf_persona_add_role (_data_->_tmp173_, _data_->_tmp176_, _data_->_tmp179_, _data_->_tmp182_, _data_->_tmp185_);
														}
													}
													_data_->_tmp186_ = NULL;
													_data_->_tmp186_ = _data_->affl_info;
													_data_->_tmp187_ = NULL;
													_data_->_tmp187_ = _data_->_tmp186_->postal_address_fd;
													if (_data_->_tmp187_ != NULL) {
														_data_->_tmp188_ = NULL;
														_data_->_tmp188_ = _data_->p;
														_data_->_tmp189_ = NULL;
														_data_->_tmp189_ = _data_->affl_info;
														_data_->_tmp190_ = NULL;
														_data_->_tmp190_ = _data_->_tmp189_->postal_address_fd;
														_trf_persona_add_postal_address (_data_->_tmp188_, _data_->_tmp190_);
													}
													_data_->_tmp191_ = NULL;
													_data_->_tmp191_ = _data_->affl_info;
													_data_->_tmp192_ = NULL;
													_data_->_tmp192_ = trf_affl_info_get_phone (_data_->_tmp191_);
													_data_->_tmp193_ = NULL;
													_data_->_tmp193_ = _data_->_tmp192_;
													if (_data_->_tmp193_ != NULL) {
														_data_->_tmp194_ = NULL;
														_data_->_tmp194_ = _data_->p;
														_data_->_tmp195_ = NULL;
														_data_->_tmp195_ = _data_->affl_info;
														_data_->_tmp196_ = NULL;
														_data_->_tmp196_ = trf_affl_info_get_phone (_data_->_tmp195_);
														_data_->_tmp197_ = NULL;
														_data_->_tmp197_ = _data_->_tmp196_;
														memset (&_data_->_tmp198_, 0, sizeof (Event));
														_data_->_tmp198_ = _data_->e;
														_data_->_tmp199_ = 0;
														_data_->_tmp199_ = _data_->_tmp198_.object_id;
														_data_->_tmp200_ = NULL;
														_data_->_tmp200_ = g_strdup_printf ("%i", _data_->_tmp199_);
														_data_->_tmp201_ = NULL;
														_data_->_tmp201_ = _data_->_tmp200_;
														_trf_persona_add_phone (_data_->_tmp194_, _data_->_tmp197_, _data_->_tmp201_);
														_g_free0 (_data_->_tmp201_);
													}
													_data_->_tmp202_ = NULL;
													_data_->_tmp202_ = _data_->affl_info;
													_data_->_tmp203_ = NULL;
													_data_->_tmp203_ = trf_affl_info_get_email (_data_->_tmp202_);
													_data_->_tmp204_ = NULL;
													_data_->_tmp204_ = _data_->_tmp203_;
													if (_data_->_tmp204_ != NULL) {
														_data_->_tmp205_ = NULL;
														_data_->_tmp205_ = _data_->p;
														_data_->_tmp206_ = NULL;
														_data_->_tmp206_ = _data_->affl_info;
														_data_->_tmp207_ = NULL;
														_data_->_tmp207_ = trf_affl_info_get_email (_data_->_tmp206_);
														_data_->_tmp208_ = NULL;
														_data_->_tmp208_ = _data_->_tmp207_;
														memset (&_data_->_tmp209_, 0, sizeof (Event));
														_data_->_tmp209_ = _data_->e;
														_data_->_tmp210_ = 0;
														_data_->_tmp210_ = _data_->_tmp209_.object_id;
														_data_->_tmp211_ = NULL;
														_data_->_tmp211_ = g_strdup_printf ("%i", _data_->_tmp210_);
														_data_->_tmp212_ = NULL;
														_data_->_tmp212_ = _data_->_tmp211_;
														_trf_persona_add_email (_data_->_tmp205_, _data_->_tmp208_, _data_->_tmp212_);
														_g_free0 (_data_->_tmp212_);
													}
													_data_->_tmp213_ = NULL;
													_data_->_tmp213_ = _data_->affl_info;
													_data_->_tmp214_ = NULL;
													_data_->_tmp214_ = trf_affl_info_get_website (_data_->_tmp213_);
													_data_->_tmp215_ = NULL;
													_data_->_tmp215_ = _data_->_tmp214_;
													if (_data_->_tmp215_ != NULL) {
														_data_->_tmp216_ = NULL;
														_data_->_tmp216_ = _data_->p;
														_data_->_tmp217_ = NULL;
														_data_->_tmp217_ = _data_->affl_info;
														_data_->_tmp218_ = NULL;
														_data_->_tmp218_ = trf_affl_info_get_website (_data_->_tmp217_);
														_data_->_tmp219_ = NULL;
														_data_->_tmp219_ = _data_->_tmp218_;
														_data_->_tmp220_ = NULL;
														_data_->_tmp220_ = _data_->affl_info;
														_data_->_tmp221_ = NULL;
														_data_->_tmp221_ = trf_affl_info_get_affl_tracker_id (_data_->_tmp220_);
														_data_->_tmp222_ = NULL;
														_data_->_tmp222_ = _data_->_tmp221_;
														_trf_persona_add_url (_data_->_tmp216_, _data_->_tmp219_, _data_->_tmp222_, FOLKS_URL_FIELD_DETAILS_PARAM_TYPE_HOME_PAGE);
													}
													_data_->_tmp223_ = NULL;
													_data_->_tmp223_ = _data_->affl_info;
													_data_->_tmp224_ = NULL;
													_data_->_tmp224_ = trf_affl_info_get_blog (_data_->_tmp223_);
													_data_->_tmp225_ = NULL;
													_data_->_tmp225_ = _data_->_tmp224_;
													if (_data_->_tmp225_ != NULL) {
														_data_->_tmp226_ = NULL;
														_data_->_tmp226_ = _data_->p;
														_data_->_tmp227_ = NULL;
														_data_->_tmp227_ = _data_->affl_info;
														_data_->_tmp228_ = NULL;
														_data_->_tmp228_ = trf_affl_info_get_blog (_data_->_tmp227_);
														_data_->_tmp229_ = NULL;
														_data_->_tmp229_ = _data_->_tmp228_;
														_data_->_tmp230_ = NULL;
														_data_->_tmp230_ = _data_->affl_info;
														_data_->_tmp231_ = NULL;
														_data_->_tmp231_ = trf_affl_info_get_affl_tracker_id (_data_->_tmp230_);
														_data_->_tmp232_ = NULL;
														_data_->_tmp232_ = _data_->_tmp231_;
														_trf_persona_add_url (_data_->_tmp226_, _data_->_tmp229_, _data_->_tmp232_, FOLKS_URL_FIELD_DETAILS_PARAM_TYPE_BLOG);
													}
													_data_->_tmp233_ = NULL;
													_data_->_tmp233_ = _data_->affl_info;
													_data_->_tmp234_ = NULL;
													_data_->_tmp234_ = trf_affl_info_get_url (_data_->_tmp233_);
													_data_->_tmp235_ = NULL;
													_data_->_tmp235_ = _data_->_tmp234_;
													if (_data_->_tmp235_ != NULL) {
														_data_->_tmp236_ = NULL;
														_data_->_tmp236_ = _data_->p;
														_data_->_tmp237_ = NULL;
														_data_->_tmp237_ = _data_->affl_info;
														_data_->_tmp238_ = NULL;
														_data_->_tmp238_ = trf_affl_info_get_url (_data_->_tmp237_);
														_data_->_tmp239_ = NULL;
														_data_->_tmp239_ = _data_->_tmp238_;
														_data_->_tmp240_ = NULL;
														_data_->_tmp240_ = _data_->affl_info;
														_data_->_tmp241_ = NULL;
														_data_->_tmp241_ = trf_affl_info_get_affl_tracker_id (_data_->_tmp240_);
														_data_->_tmp242_ = NULL;
														_data_->_tmp242_ = _data_->_tmp241_;
														_trf_persona_add_url (_data_->_tmp236_, _data_->_tmp239_, _data_->_tmp242_, NULL);
													}
													_g_object_unref0 (_data_->affl_info);
												} else {
													_data_->_tmp243_ = NULL;
													_data_->_tmp243_ = _data_->p;
													memset (&_data_->_tmp244_, 0, sizeof (Event));
													_data_->_tmp244_ = _data_->e;
													_data_->_tmp245_ = 0;
													_data_->_tmp245_ = _data_->_tmp244_.object_id;
													_data_->_tmp246_ = NULL;
													_data_->_tmp246_ = g_strdup_printf ("%i", _data_->_tmp245_);
													_data_->_tmp247_ = NULL;
													_data_->_tmp247_ = _data_->_tmp246_;
													_trf_persona_remove_im_address (_data_->_tmp243_, _data_->_tmp247_, TRUE);
													_g_free0 (_data_->_tmp247_);
													_data_->_tmp248_ = NULL;
													_data_->_tmp248_ = _data_->p;
													memset (&_data_->_tmp249_, 0, sizeof (Event));
													_data_->_tmp249_ = _data_->e;
													_data_->_tmp250_ = 0;
													_data_->_tmp250_ = _data_->_tmp249_.object_id;
													_data_->_tmp251_ = NULL;
													_data_->_tmp251_ = g_strdup_printf ("%i", _data_->_tmp250_);
													_data_->_tmp252_ = NULL;
													_data_->_tmp252_ = _data_->_tmp251_;
													_trf_persona_remove_role (_data_->_tmp248_, _data_->_tmp252_);
													_g_free0 (_data_->_tmp252_);
													_data_->_tmp253_ = NULL;
													_data_->_tmp253_ = _data_->p;
													memset (&_data_->_tmp254_, 0, sizeof (Event));
													_data_->_tmp254_ = _data_->e;
													_data_->_tmp255_ = 0;
													_data_->_tmp255_ = _data_->_tmp254_.object_id;
													_data_->_tmp256_ = NULL;
													_data_->_tmp256_ = g_strdup_printf ("%i", _data_->_tmp255_);
													_data_->_tmp257_ = NULL;
													_data_->_tmp257_ = _data_->_tmp256_;
													_trf_persona_remove_postal_address (_data_->_tmp253_, _data_->_tmp257_);
													_g_free0 (_data_->_tmp257_);
													_data_->_tmp258_ = NULL;
													_data_->_tmp258_ = _data_->p;
													memset (&_data_->_tmp259_, 0, sizeof (Event));
													_data_->_tmp259_ = _data_->e;
													_data_->_tmp260_ = 0;
													_data_->_tmp260_ = _data_->_tmp259_.object_id;
													_data_->_tmp261_ = NULL;
													_data_->_tmp261_ = g_strdup_printf ("%i", _data_->_tmp260_);
													_data_->_tmp262_ = NULL;
													_data_->_tmp262_ = _data_->_tmp261_;
													_trf_persona_remove_phone (_data_->_tmp258_, _data_->_tmp262_);
													_g_free0 (_data_->_tmp262_);
													_data_->_tmp263_ = NULL;
													_data_->_tmp263_ = _data_->p;
													memset (&_data_->_tmp264_, 0, sizeof (Event));
													_data_->_tmp264_ = _data_->e;
													_data_->_tmp265_ = 0;
													_data_->_tmp265_ = _data_->_tmp264_.object_id;
													_data_->_tmp266_ = NULL;
													_data_->_tmp266_ = g_strdup_printf ("%i", _data_->_tmp265_);
													_data_->_tmp267_ = NULL;
													_data_->_tmp267_ = _data_->_tmp266_;
													_trf_persona_remove_email (_data_->_tmp263_, _data_->_tmp267_);
													_g_free0 (_data_->_tmp267_);
													_data_->_tmp268_ = NULL;
													_data_->_tmp268_ = _data_->p;
													memset (&_data_->_tmp269_, 0, sizeof (Event));
													_data_->_tmp269_ = _data_->e;
													_data_->_tmp270_ = 0;
													_data_->_tmp270_ = _data_->_tmp269_.object_id;
													_data_->_tmp271_ = NULL;
													_data_->_tmp271_ = g_strdup_printf ("%i", _data_->_tmp270_);
													_data_->_tmp272_ = NULL;
													_data_->_tmp272_ = _data_->_tmp271_;
													_trf_persona_remove_url (_data_->_tmp268_, _data_->_tmp272_);
													_g_free0 (_data_->_tmp272_);
												}
											} else {
												memset (&_data_->_tmp273_, 0, sizeof (Event));
												_data_->_tmp273_ = _data_->e;
												_data_->_tmp274_ = 0;
												_data_->_tmp274_ = _data_->_tmp273_.pred_id;
												_data_->_tmp275_ = NULL;
												_data_->_tmp275_ = trf_persona_store__prefix_tracker_id;
												_data_->_tmp276_ = NULL;
												_data_->_tmp276_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp275_, TRF_ONTOLOGY_DEFS_NCO_BIRTHDAY);
												if (_data_->_tmp274_ == ((gint) ((gintptr) _data_->_tmp276_))) {
													_data_->_tmp277_ = NULL;
													_data_->_tmp277_ = g_strdup ("");
													_data_->bday = _data_->_tmp277_;
													_data_->_tmp278_ = FALSE;
													_data_->_tmp278_ = _data_->adding;
													if (_data_->_tmp278_) {
														memset (&_data_->_tmp279_, 0, sizeof (Event));
														_data_->_tmp279_ = _data_->e;
														_data_->_tmp280_ = 0;
														_data_->_tmp280_ = _data_->_tmp279_.subject_id;
														_data_->_state_ = 11;
														_trf_persona_store_get_property (_data_->self, _data_->_tmp280_, TRF_ONTOLOGY_DEFS_NCO_BIRTHDAY, TRF_ONTOLOGY_DEFS_NCO_PERSON, _trf_persona_store_do_update_ready, _data_);
														return FALSE;
														_state_11:
														_data_->_tmp281_ = NULL;
														_data_->_tmp281_ = _trf_persona_store_get_property_finish (_data_->self, _data_->_res_);
														_g_free0 (_data_->bday);
														_data_->bday = _data_->_tmp281_;
													}
													_data_->_tmp282_ = NULL;
													_data_->_tmp282_ = _data_->p;
													_data_->_tmp283_ = NULL;
													_data_->_tmp283_ = _data_->bday;
													_trf_persona_set_birthday (_data_->_tmp282_, _data_->_tmp283_);
													_g_free0 (_data_->bday);
												} else {
													memset (&_data_->_tmp284_, 0, sizeof (Event));
													_data_->_tmp284_ = _data_->e;
													_data_->_tmp285_ = 0;
													_data_->_tmp285_ = _data_->_tmp284_.pred_id;
													_data_->_tmp286_ = NULL;
													_data_->_tmp286_ = trf_persona_store__prefix_tracker_id;
													_data_->_tmp287_ = NULL;
													_data_->_tmp287_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp286_, TRF_ONTOLOGY_DEFS_NCO_NOTE);
													if (_data_->_tmp285_ == ((gint) ((gintptr) _data_->_tmp287_))) {
														_data_->_tmp288_ = NULL;
														_data_->_tmp288_ = g_strdup ("");
														_data_->note = _data_->_tmp288_;
														_data_->_tmp289_ = FALSE;
														_data_->_tmp289_ = _data_->adding;
														if (_data_->_tmp289_) {
															memset (&_data_->_tmp290_, 0, sizeof (Event));
															_data_->_tmp290_ = _data_->e;
															_data_->_tmp291_ = 0;
															_data_->_tmp291_ = _data_->_tmp290_.subject_id;
															_data_->_state_ = 12;
															_trf_persona_store_get_property (_data_->self, _data_->_tmp291_, TRF_ONTOLOGY_DEFS_NCO_NOTE, TRF_ONTOLOGY_DEFS_NCO_PERSON, _trf_persona_store_do_update_ready, _data_);
															return FALSE;
															_state_12:
															_data_->_tmp292_ = NULL;
															_data_->_tmp292_ = _trf_persona_store_get_property_finish (_data_->self, _data_->_res_);
															_g_free0 (_data_->note);
															_data_->note = _data_->_tmp292_;
														}
														_data_->_tmp293_ = NULL;
														_data_->_tmp293_ = _data_->p;
														_data_->_tmp294_ = NULL;
														_data_->_tmp294_ = _data_->note;
														_trf_persona_set_note (_data_->_tmp293_, _data_->_tmp294_);
														_g_free0 (_data_->note);
													} else {
														memset (&_data_->_tmp295_, 0, sizeof (Event));
														_data_->_tmp295_ = _data_->e;
														_data_->_tmp296_ = 0;
														_data_->_tmp296_ = _data_->_tmp295_.pred_id;
														_data_->_tmp297_ = NULL;
														_data_->_tmp297_ = trf_persona_store__prefix_tracker_id;
														_data_->_tmp298_ = NULL;
														_data_->_tmp298_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp297_, TRF_ONTOLOGY_DEFS_NCO_GENDER);
														if (_data_->_tmp296_ == ((gint) ((gintptr) _data_->_tmp298_))) {
															_data_->_tmp299_ = FALSE;
															_data_->_tmp299_ = _data_->adding;
															if (_data_->_tmp299_) {
																_data_->_tmp300_ = NULL;
																_data_->_tmp300_ = _data_->p;
																memset (&_data_->_tmp301_, 0, sizeof (Event));
																_data_->_tmp301_ = _data_->e;
																_data_->_tmp302_ = 0;
																_data_->_tmp302_ = _data_->_tmp301_.object_id;
																_trf_persona_set_gender (_data_->_tmp300_, _data_->_tmp302_);
															} else {
																_data_->_tmp303_ = NULL;
																_data_->_tmp303_ = _data_->p;
																_trf_persona_set_gender (_data_->_tmp303_, 0);
															}
														} else {
															memset (&_data_->_tmp304_, 0, sizeof (Event));
															_data_->_tmp304_ = _data_->e;
															_data_->_tmp305_ = 0;
															_data_->_tmp305_ = _data_->_tmp304_.pred_id;
															_data_->_tmp306_ = NULL;
															_data_->_tmp306_ = trf_persona_store__prefix_tracker_id;
															_data_->_tmp307_ = NULL;
															_data_->_tmp307_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp306_, TRF_ONTOLOGY_DEFS_NCO_PHOTO);
															if (_data_->_tmp305_ == ((gint) ((gintptr) _data_->_tmp307_))) {
																_data_->_tmp308_ = NULL;
																_data_->_tmp308_ = g_strdup ("");
																_data_->avatar_url = _data_->_tmp308_;
																_data_->_tmp309_ = FALSE;
																_data_->_tmp309_ = _data_->adding;
																if (_data_->_tmp309_) {
																	memset (&_data_->_tmp310_, 0, sizeof (Event));
																	_data_->_tmp310_ = _data_->e;
																	_data_->_tmp311_ = 0;
																	_data_->_tmp311_ = _data_->_tmp310_.object_id;
																	_data_->_state_ = 13;
																	_trf_persona_store_get_property (_data_->self, _data_->_tmp311_, TRF_ONTOLOGY_DEFS_NIE_URL, TRF_ONTOLOGY_DEFS_NFO_IMAGE, _trf_persona_store_do_update_ready, _data_);
																	return FALSE;
																	_state_13:
																	_data_->_tmp312_ = NULL;
																	_data_->_tmp312_ = _trf_persona_store_get_property_finish (_data_->self, _data_->_res_);
																	_g_free0 (_data_->avatar_url);
																	_data_->avatar_url = _data_->_tmp312_;
																}
																_data_->_tmp313_ = NULL;
																_data_->_tmp313_ = _data_->p;
																_data_->_tmp314_ = NULL;
																_data_->_tmp314_ = _data_->avatar_url;
																_trf_persona_set_avatar_from_uri (_data_->_tmp313_, _data_->_tmp314_);
																_g_free0 (_data_->avatar_url);
															} else {
																memset (&_data_->_tmp315_, 0, sizeof (Event));
																_data_->_tmp315_ = _data_->e;
																_data_->_tmp316_ = 0;
																_data_->_tmp316_ = _data_->_tmp315_.pred_id;
																_data_->_tmp317_ = NULL;
																_data_->_tmp317_ = trf_persona_store__prefix_tracker_id;
																_data_->_tmp318_ = NULL;
																_data_->_tmp318_ = gee_abstract_map_get ((GeeAbstractMap*) _data_->_tmp317_, TRF_ONTOLOGY_DEFS_NAO_PROPERTY);
																if (_data_->_tmp316_ == ((gint) ((gintptr) _data_->_tmp318_))) {
																	_data_->_tmp319_ = FALSE;
																	_data_->_tmp319_ = _data_->adding;
																	if (_data_->_tmp319_) {
																		memset (&_data_->_tmp320_, 0, sizeof (Event));
																		_data_->_tmp320_ = _data_->e;
																		_data_->_tmp321_ = 0;
																		_data_->_tmp321_ = _data_->_tmp320_.object_id;
																		_data_->_tmp322_ = 0;
																		_data_->_state_ = 14;
																		_trf_persona_store_get_nao_property_by_prop_id (_data_->self, _data_->_tmp321_, _trf_persona_store_do_update_ready, _data_);
																		return FALSE;
																		_state_14:
																		_data_->_tmp323_ = NULL;
																		_data_->_tmp323_ = _trf_persona_store_get_nao_property_by_prop_id_finish (_data_->self, _data_->_res_, &_data_->_tmp322_);
																		_data_->prop_info_length1 = 0;
																		_data_->_prop_info_size_ = 0;
																		_data_->prop_info = _data_->_tmp323_;
																		_data_->prop_info_length1 = _data_->_tmp322_;
																		_data_->_prop_info_size_ = _data_->prop_info_length1;
																		_data_->_tmp324_ = NULL;
																		_data_->_tmp324__length1 = 0;
																		_data_->_tmp324_ = _data_->prop_info;
																		_data_->_tmp324__length1 = _data_->prop_info_length1;
																		_data_->_tmp325_ = NULL;
																		_data_->_tmp325_ = _data_->_tmp324_[0];
																		if (g_strcmp0 (_data_->_tmp325_, TRF_PERSONA_STORE__LOCAL_ID_PROPERTY_NAME) == 0) {
																			_data_->_tmp326_ = NULL;
																			_data_->_tmp326_ = _data_->p;
																			_data_->_tmp327_ = NULL;
																			_data_->_tmp327__length1 = 0;
																			_data_->_tmp327_ = _data_->prop_info;
																			_data_->_tmp327__length1 = _data_->prop_info_length1;
																			_data_->_tmp328_ = NULL;
																			_data_->_tmp328_ = _data_->_tmp327_[1];
																			_trf_persona_set_local_ids (_data_->_tmp326_, _data_->_tmp328_);
																		} else {
																			_data_->_tmp329_ = NULL;
																			_data_->_tmp329__length1 = 0;
																			_data_->_tmp329_ = _data_->prop_info;
																			_data_->_tmp329__length1 = _data_->prop_info_length1;
																			_data_->_tmp330_ = NULL;
																			_data_->_tmp330_ = _data_->_tmp329_[0];
																			if (g_strcmp0 (_data_->_tmp330_, TRF_PERSONA_STORE__WSD_PROPERTY_NAME) == 0) {
																				_data_->_tmp331_ = NULL;
																				_data_->_tmp331_ = _data_->p;
																				_data_->_tmp332_ = NULL;
																				_data_->_tmp332__length1 = 0;
																				_data_->_tmp332_ = _data_->prop_info;
																				_data_->_tmp332__length1 = _data_->prop_info_length1;
																				_data_->_tmp333_ = NULL;
																				_data_->_tmp333_ = _data_->_tmp332_[1];
																				_trf_persona_set_web_service_addrs (_data_->_tmp331_, _data_->_tmp333_);
																			}
																		}
																		_data_->prop_info = (_vala_array_free (_data_->prop_info, _data_->prop_info_length1, (GDestroyNotify) g_free), NULL);
																	} else {
																		memset (&_data_->_tmp334_, 0, sizeof (Event));
																		_data_->_tmp334_ = _data_->e;
																		_data_->_tmp335_ = 0;
																		_data_->_tmp335_ = _data_->_tmp334_.subject_id;
																		_data_->_state_ = 15;
																		_trf_persona_store_get_nao_property_by_person_id (_data_->self, _data_->_tmp335_, TRF_PERSONA_STORE__LOCAL_ID_PROPERTY_NAME, _trf_persona_store_do_update_ready, _data_);
																		return FALSE;
																		_state_15:
																		_data_->_tmp336_ = NULL;
																		_data_->_tmp336_ = _trf_persona_store_get_nao_property_by_person_id_finish (_data_->self, _data_->_res_);
																		_data_->local_ids = _data_->_tmp336_;
																		memset (&_data_->_tmp337_, 0, sizeof (Event));
																		_data_->_tmp337_ = _data_->e;
																		_data_->_tmp338_ = 0;
																		_data_->_tmp338_ = _data_->_tmp337_.subject_id;
																		_data_->_state_ = 16;
																		_trf_persona_store_get_nao_property_by_person_id (_data_->self, _data_->_tmp338_, TRF_PERSONA_STORE__WSD_PROPERTY_NAME, _trf_persona_store_do_update_ready, _data_);
																		return FALSE;
																		_state_16:
																		_data_->_tmp339_ = NULL;
																		_data_->_tmp339_ = _trf_persona_store_get_nao_property_by_person_id_finish (_data_->self, _data_->_res_);
																		_data_->ws_addrs = _data_->_tmp339_;
																		_data_->_tmp340_ = NULL;
																		_data_->_tmp340_ = _data_->p;
																		_data_->_tmp341_ = NULL;
																		_data_->_tmp341_ = _data_->local_ids;
																		_trf_persona_set_local_ids (_data_->_tmp340_, _data_->_tmp341_);
																		_data_->_tmp342_ = NULL;
																		_data_->_tmp342_ = _data_->p;
																		_data_->_tmp343_ = NULL;
																		_data_->_tmp343_ = _data_->ws_addrs;
																		_trf_persona_set_web_service_addrs (_data_->_tmp342_, _data_->_tmp343_);
																		_g_free0 (_data_->ws_addrs);
...
static gboolean _trf_persona_store_get_affl_info_co (TrfPersonaStoreGetAfflInfoData* _data_) {
	...
	g_debug ("trf-persona-store.vala:1793: _get_affl_info: %s", _data_->_tmp4_);
	{
		_data_->_tmp5_ = NULL;
	...
	__catch5_tracker_sparql_error:
	{
		...
		g_warning ("trf-persona-store.vala:1857: Couldn't fetch affiliation info: %s %s", _data_->_tmp113_, _data_->_tmp115_);
		_g_error_free0 (_data_->e1);
	}
	goto __finally5;
	__catch5_g_error:
	{
		...
		g_warning ("trf-persona-store.vala:1862: Couldn't fetch affiliation info: %s %s", _data_->_tmp116_, _data_->_tmp118_);
		_g_error_free0 (_data_->e2);
	}
	__finally5:
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
static gboolean _trf_persona_store_insert_persona_co (TrfPersonaStoreInsertPersonaData* _data_) {
	...
	}
	{
		...
		g_debug ("trf-persona-store.vala:1883: _insert_persona: %s", _data_->_tmp3_);
		_data_->_tmp4_ = NULL;
		_data_->_tmp4_ = _data_->self->priv->_connection;
		g_debug ("trf-persona-store.vala:1884: _connection is %p", _data_->_tmp4_);
		_data_->_tmp6_ = NULL;
		...
		_data_->_tmp10_ = NULL;
		_data_->_tmp10_ = _data_->variant;
		_data_->_tmp11_ = NULL;
		_data_->_tmp11_ = g_variant_iter_new (_data_->_tmp10_);
		_g_variant_iter_free0 (_data_->iter1);
		_data_->iter1 = _data_->_tmp11_;
		while (TRUE) {
			_data_->_tmp12_ = NULL;
			_data_->_tmp12_ = _data_->iter1;
			_data_->_tmp13_ = FALSE;
			_data_->_tmp13_ = g_variant_iter_next (_data_->_tmp12_, "aa{ss}", &_data_->iter2, NULL);
			if (!_data_->_tmp13_) {
				break;
			}
			_data_->_tmp14_ = NULL;
			...
			while (TRUE) {
				_data_->_tmp15_ = NULL;
				_data_->_tmp15_ = _data_->iter2;
				_data_->_tmp16_ = FALSE;
				_data_->_tmp16_ = g_variant_iter_next (_data_->_tmp15_, "a{ss}", &_data_->iter3, NULL);
				if (!_data_->_tmp16_) {
					break;
				}
				_data_->_tmp17_ = NULL;
				...
				while (TRUE) {
					_data_->_tmp18_ = NULL;
					_data_->_tmp18_ = _data_->iter3;
					_data_->_tmp19_ = FALSE;
					_data_->_tmp19_ = g_variant_iter_next (_data_->_tmp18_, "{ss}", &_data_->anon_var, &_data_->contact_urn, NULL);
					if (!_data_->_tmp19_) {
						break;
					}
					_data_->_tmp20_ = NULL;
					_data_->_tmp20_ = _data_->anon_var;
					_data_->_tmp21_ = NULL;
					_data_->_tmp21_ = _data_->persona_var;
	...
	__catch6_g_error:
	{
		...
		g_warning ("trf-persona-store.vala:1917: Couldn't insert nco:PersonContact: %s", _data_->_tmp23_);
		_g_error_free0 (_data_->e);
	}
	__finally6:
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
static gboolean _trf_persona_store_multi_value_query_co (TrfPersonaStoreMultiValueQueryData* _data_) {
	...
	g_debug ("trf-persona-store.vala:1939: [_multi_value_query] %s", _data_->_tmp1_);
	{
		_data_->_tmp2_ = NULL;
	...
	__catch7_tracker_sparql_error:
	{
		...
		g_warning ("trf-persona-store.vala:1953: Couldn't run query: %s %s", _data_->_tmp14_, _data_->_tmp16_);
		_g_error_free0 (_data_->e1);
	}
	goto __finally7;
	__catch7_g_error:
	{
		...
		g_warning ("trf-persona-store.vala:1957: Couldn't run query: %s %s", _data_->_tmp17_, _data_->_tmp19_);
		_g_error_free0 (_data_->e2);
	}
	__finally7:
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
static gboolean _trf_persona_store_set_avatar_co (TrfPersonaStoreSetAvatarData* _data_) {
	...
	if (_data_->_tmp14_ != NULL) {
		...
		__catch8_g_error:
		{
			...
			_data_->_tmp31_ = NULL;
			_data_->_tmp31_ = _data_->_tmp30_->message;
			g_warning ("trf-persona-store.vala:2373: Couldn't cache avatar for Trf.Persona '%s" \
...
static gboolean _trf_persona_store_set_attrib_set_co (TrfPersonaStoreSetAttribSetData* _data_) {
	...
	_data_->i = 0;
	{
		...
		while (TRUE) {
			...
			switch (_data_->_tmp21_) {
				...
				case TRF_ATTRIB_URLS:
				{
					...
					if (_data_->_tmp74_) {
						...
						_data_->_tmp79_ = NULL;
						_data_->_tmp79_ = _data_->type_p;
						if (_data_->_tmp79_ != NULL) {
							_data_->_tmp80_ = NULL;
							_data_->_tmp80_ = _data_->type_p;
							_data_->_tmp81_ = FALSE;
							_data_->_tmp81_ = gee_collection_contains (_data_->_tmp80_, FOLKS_URL_FIELD_DETAILS_PARAM_TYPE_HOME_PAGE);
					...
					_data_->_tmp82_ = NULL;
					_data_->_tmp82_ = _data_->fd;
					_data_->_tmp83_ = NULL;
					_data_->_tmp83_ = folks_abstract_field_details_get_value ((FolksAbstractFieldDetails*) G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp82_, FOLKS_TYPE_URL_FIELD_DETAILS, FolksUrlFieldDetails));
					_data_->_tmp84_ = NULL;
					_data_->_tmp84_ = _data_->_tmp83_;
					_data_->_tmp85_ = NULL;
					_data_->_tmp85_ = g_strdup_printf ("'%s'", (const gchar*) _data_->_tmp84_);
					_g_free0 (_data_->attr);
					_data_->attr = _data_->_tmp85_;
				...
				case TRF_ATTRIB_IM_ADDRESSES:
				{
					...
					_data_->_tmp86_ = _data_->p;
					_data_->_tmp87_ = NULL;
					_data_->_tmp87_ = _g_object_ref0 ((FolksAbstractFieldDetails*) G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp86_, FOLKS_TYPE_IM_FIELD_DETAILS, FolksImFieldDetails));
					_g_object_unref0 (_data_->fd);
					_data_->fd = _data_->_tmp87_;
					_data_->_tmp88_ = 0;
					_data_->_tmp88_ = _data_->i;
					_data_->_tmp89_ = NULL;
					_data_->_tmp89_ = g_strdup_printf ("_:p%d", _data_->_tmp88_);
					_g_free0 (_data_->attr);
					_data_->attr = _data_->_tmp89_;
					_data_->_tmp90_ = NULL;
					_data_->_tmp90_ = _data_->builder;
					_data_->_tmp91_ = NULL;
					_data_->_tmp91_ = _data_->attr;
					tracker_sparql_builder_subject (_data_->_tmp90_, _data_->_tmp91_);
					_data_->_tmp92_ = NULL;
					_data_->_tmp92_ = _data_->builder;
					tracker_sparql_builder_predicate (_data_->_tmp92_, "a");
					_data_->_tmp93_ = NULL;
					_data_->_tmp93_ = _data_->builder;
					_data_->_tmp94_ = NULL;
					_data_->_tmp94_ = _data_->related_attrib;
					tracker_sparql_builder_object (_data_->_tmp93_, _data_->_tmp94_);
					_data_->_tmp95_ = NULL;
					_data_->_tmp95_ = _data_->builder;
					_data_->_tmp96_ = NULL;
					_data_->_tmp96_ = _data_->related_prop;
					tracker_sparql_builder_predicate (_data_->_tmp95_, _data_->_tmp96_);
					_data_->_tmp97_ = NULL;
					_data_->_tmp97_ = _data_->builder;
					_data_->_tmp98_ = NULL;
					_data_->_tmp98_ = _data_->fd;
					_data_->_tmp99_ = NULL;
					_data_->_tmp99_ = folks_abstract_field_details_get_value ((FolksAbstractFieldDetails*) G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp98_, FOLKS_TYPE_IM_FIELD_DETAILS, FolksImFieldDetails));
					_data_->_tmp100_ = NULL;
					_data_->_tmp100_ = _data_->_tmp99_;
					tracker_sparql_builder_object_string (_data_->_tmp97_, (const gchar*) _data_->_tmp100_);
					_data_->_tmp101_ = 0;
					_data_->_tmp101_ = _data_->what;
					if (_data_->_tmp101_ == TRF_ATTRIB_IM_ADDRESSES) {
						_data_->_tmp102_ = NULL;
						_data_->_tmp102_ = _data_->builder;
						_data_->_tmp103_ = NULL;
						_data_->_tmp103_ = _data_->related_prop_2;
						tracker_sparql_builder_predicate (_data_->_tmp102_, _data_->_tmp103_);
						_data_->_tmp104_ = NULL;
						_data_->_tmp104_ = _data_->fd;
						_data_->_tmp105_ = NULL;
						_data_->_tmp105_ = folks_abstract_field_details_get_parameter_values (_data_->_tmp104_, "proto");
						_data_->_tmp106_ = NULL;
						_data_->_tmp106_ = _data_->_tmp105_;
						_data_->_tmp107_ = 0;
						_data_->_tmp108_ = NULL;
						_data_->_tmp108_ = gee_collection_to_array (_data_->_tmp106_, &_data_->_tmp107_);
						_data_->_tmp109_ = NULL;
						_data_->_tmp109__length1 = 0;
						_data_->_tmp109_ = _data_->_tmp108_;
						_data_->_tmp109__length1 = _data_->_tmp107_;
						_g_object_unref0 (_data_->_tmp106_);
						_data_->im_params_length1 = 0;
						_data_->_im_params_size_ = 0;
						_data_->im_params = _data_->_tmp109_;
						_data_->im_params_length1 = _data_->_tmp109__length1;
						_data_->_im_params_size_ = _data_->im_params_length1;
						_data_->_tmp110_ = NULL;
						_data_->_tmp110_ = _data_->builder;
						_data_->_tmp111_ = NULL;
						_data_->_tmp111__length1 = 0;
						_data_->_tmp111_ = _data_->im_params;
						_data_->_tmp111__length1 = _data_->im_params_length1;
						_data_->_tmp112_ = NULL;
						_data_->_tmp112_ = _data_->_tmp111_[0];
						tracker_sparql_builder_object_string (_data_->_tmp110_, _data_->_tmp112_);
			...
			_data_->_tmp113_ = NULL;
			_data_->_tmp113_ = _data_->builder;
			_data_->_tmp114_ = NULL;
			_data_->_tmp114_ = _data_->affl;
			tracker_sparql_builder_subject (_data_->_tmp113_, _data_->_tmp114_);
			_data_->_tmp115_ = NULL;
			_data_->_tmp115_ = _data_->builder;
			tracker_sparql_builder_predicate (_data_->_tmp115_, "a");
			_data_->_tmp116_ = NULL;
			_data_->_tmp116_ = _data_->builder;
			tracker_sparql_builder_object (_data_->_tmp116_, TRF_ONTOLOGY_DEFS_NCO_AFFILIATION);
			_data_->_tmp117_ = NULL;
			_data_->_tmp117_ = _data_->builder;
			_data_->_tmp118_ = NULL;
			_data_->_tmp118_ = _data_->related_connection;
			tracker_sparql_builder_predicate (_data_->_tmp117_, _data_->_tmp118_);
			_data_->_tmp119_ = NULL;
			_data_->_tmp119_ = _data_->builder;
			_data_->_tmp120_ = NULL;
			_data_->_tmp120_ = _data_->attr;
			tracker_sparql_builder_object (_data_->_tmp119_, _data_->_tmp120_);
			_data_->_tmp121_ = NULL;
			_data_->_tmp121_ = _data_->builder;
			tracker_sparql_builder_subject (_data_->_tmp121_, "?contact");
			_data_->_tmp122_ = NULL;
			_data_->_tmp122_ = _data_->builder;
			tracker_sparql_builder_predicate (_data_->_tmp122_, TRF_ONTOLOGY_DEFS_NCO_HAS_AFFILIATION);
			_data_->_tmp123_ = NULL;
			_data_->_tmp123_ = _data_->builder;
			_data_->_tmp124_ = NULL;
			_data_->_tmp124_ = _data_->affl;
			tracker_sparql_builder_object (_data_->_tmp123_, _data_->_tmp124_);
			_data_->_tmp125_ = 0;
			_data_->_tmp125_ = _data_->i;
			_data_->i = _data_->_tmp125_ + 1;
			_g_free0 (_data_->attr);
			_g_free0 (_data_->affl);
			_g_object_unref0 (_data_->pa);
			_g_object_unref0 (_data_->pafd);
	...
	_data_->_tmp126_ = NULL;
	_data_->_tmp126_ = _data_->builder;
	tracker_sparql_builder_insert_close (_data_->_tmp126_);
	_data_->_tmp127_ = NULL;
	_data_->_tmp127_ = _data_->builder;
	tracker_sparql_builder_where_open (_data_->_tmp127_);
	_data_->_tmp128_ = NULL;
	_data_->_tmp128_ = _data_->builder;
	tracker_sparql_builder_subject (_data_->_tmp128_, "?contact");
	_data_->_tmp129_ = NULL;
	_data_->_tmp129_ = _data_->builder;
	tracker_sparql_builder_predicate (_data_->_tmp129_, "a");
	_data_->_tmp130_ = NULL;
	_data_->_tmp130_ = _data_->builder;
	tracker_sparql_builder_object (_data_->_tmp130_, TRF_ONTOLOGY_DEFS_NCO_PERSON);
	_data_->_tmp131_ = NULL;
	_data_->_tmp131_ = _data_->p_id;
	_data_->_tmp132_ = NULL;
	_data_->_tmp132_ = g_strdup_printf (" FILTER(tracker:id(?contact) = %s) ", _data_->_tmp131_);
	_data_->filter = _data_->_tmp132_;
	_data_->_tmp133_ = NULL;
	_data_->_tmp133_ = _data_->builder;
	tracker_sparql_builder_append (_data_->_tmp133_, _data_->filter);
	_data_->_tmp134_ = NULL;
	_data_->_tmp134_ = _data_->builder;
	tracker_sparql_builder_where_close (_data_->_tmp134_);
	_data_->_tmp135_ = NULL;
	_data_->_tmp135_ = _data_->builder;
	_data_->_tmp136_ = NULL;
	_data_->_tmp136_ = tracker_sparql_builder_get_result (_data_->_tmp135_);
	_data_->_tmp137_ = NULL;
	_data_->_tmp137_ = _data_->_tmp136_;
	_data_->_state_ = 3;
	_trf_persona_store_tracker_update (_data_->self, _data_->_tmp137_, "set_attrib", _trf_persona_store_set_attrib_set_ready, _data_);
	return FALSE;
	_state_3:
	_trf_persona_store_tracker_update_finish (_data_->self, _data_->_res_);
	_g_free0 (_data_->filter);
...
static gboolean _trf_persona_store_tracker_update_co (TrfPersonaStoreTrackerUpdateData* _data_) {
	...
	_data_->_tmp1_ = NULL;
	_data_->_tmp1_ = _data_->query;
	g_debug ("trf-persona-store.vala:2603: %s: %s", _data_->_tmp0_, _data_->_tmp1_);
	{
		_data_->_tmp2_ = NULL;
		_data_->_tmp2_ = _data_->self->priv->_connection;
		_data_->_tmp3_ = NULL;
	...
	__catch10_tracker_sparql_error:
	{
		...
		_data_->_tmp7_ = NULL;
		_data_->_tmp7_ = _data_->query;
		g_warning ("trf-persona-store.vala:2612: [%s] SPARQL syntax error: %s. Query: %s", _data_->_tmp4_, _data_->_tmp6_, _data_->_tmp7_);
		_g_error_free0 (_data_->e1);
	}
	goto __finally10;
	__catch10_g_io_error:
	{
		...
		g_warning ("trf-persona-store.vala:2617: [%s] IO error: %s", _data_->_tmp8_, _data_->_tmp10_);
		_g_error_free0 (_data_->e2);
	}
	goto __finally10;
	__catch10_g_dbus_error:
	{
		...
		g_warning ("trf-persona-store.vala:2622: [%s] DBus error: %s", _data_->_tmp11_, _data_->_tmp13_);
		_g_error_free0 (_data_->e3);
	}
	goto __finally10;
	__catch10_g_error:
	{
		...
		_data_->_inner_error_ = NULL;
		_data_->_tmp14_ = NULL;
		_data_->_tmp14_ = _data_->caller;
		_data_->_tmp15_ = NULL;
		_data_->_tmp15_ = _data_->e4;
		_data_->_tmp16_ = NULL;
		_data_->_tmp16_ = _data_->_tmp15_->message;
		g_warning ("trf-persona-store.vala:2627: [%s] GLib error: %s", _data_->_tmp14_, _data_->_tmp16_);
...
static GObject * trf_persona_store_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	g_debug ("trf-persona-store.vala:426: Initial query : \n%s\n", TRF_PERSONA_STORE__INITIAL_QUERY);
...
static void trf_persona_store_class_init (TrfPersonaStoreClass * klass) {
	...
	((FolksPersonaStoreClass *) klass)->add_persona_from_details = trf_persona_store_real_add_persona_from_details;
	((FolksPersonaStoreClass *) klass)->add_persona_from_details_finish = trf_persona_store_real_add_persona_from_details_finish;
	((FolksPersonaStoreClass *) klass)->remove_persona = trf_persona_store_real_remove_persona;
	((FolksPersonaStoreClass *) klass)->remove_persona_finish = trf_persona_store_real_remove_persona_finish;
	((FolksPersonaStoreClass *) klass)->prepare = trf_persona_store_real_prepare;
	((FolksPersonaStoreClass *) klass)->prepare_finish = trf_persona_store_real_prepare_finish;
