/* tpf-persona-store.c generated by valac 0.27.1.3-6129, the Vala compiler
...
static void _tpf_persona_store_reset (TpfPersonaStore* self) {
	...
	_tmp9_ = gee_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, TPF_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	_g_object_unref0 (self->priv->_personas);
	self->priv->_personas = _tmp9_;
	_tmp10_ = self->priv->_personas;
	_tmp11_ = gee_abstract_map_get_read_only_view ((GeeAbstractMap*) _tmp10_);
	_tmp12_ = _tmp11_;
	_g_object_unref0 (self->priv->_personas_ro);
	self->priv->_personas_ro = _tmp12_;
	_tmp13_ = gee_hash_set_new (TPF_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
	_g_object_unref0 (self->priv->_persona_set);
	self->priv->_persona_set = _tmp13_;
	self->priv->_cache_needs_update = FALSE;
	_tmp14_ = self->priv->_conn;
	if (_tmp14_ != NULL) {
		TpConnection* _tmp15_ = NULL;
		guint _tmp16_ = 0U;
		GQuark _tmp17_ = 0U;
		TpConnection* _tmp18_ = NULL;
		guint _tmp19_ = 0U;
		GQuark _tmp20_ = 0U;
		TpConnection* _tmp21_ = NULL;
		guint _tmp22_ = 0U;
		_tmp15_ = self->priv->_conn;
		g_signal_parse_name ("notify::self-contact", G_TYPE_OBJECT, &_tmp16_, &_tmp17_, TRUE);
		g_signal_handlers_disconnect_matched ((GObject*) _tmp15_, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_DETAIL | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp16_, _tmp17_, NULL, (GCallback) __tpf_persona_store_self_contact_changed_cb_g_object_notify, self);
		_tmp18_ = self->priv->_conn;
		g_signal_parse_name ("notify::contact-list-state", G_TYPE_OBJECT, &_tmp19_, &_tmp20_, TRUE);
		g_signal_handlers_disconnect_matched ((GObject*) _tmp18_, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_DETAIL | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp19_, _tmp20_, NULL, (GCallback) __tpf_persona_store_contact_list_state_changed_cb_g_object_notify, self);
		_tmp21_ = self->priv->_conn;
		g_signal_parse_name ("contact-list-changed", tp_connection_get_type (), &_tmp22_, NULL, FALSE);
		g_signal_handlers_disconnect_matched (_tmp21_, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp22_, 0, NULL, (GCallback) __tpf_persona_store_contact_list_changed_cb_tp_connection_contact_list_changed, self);
		_g_object_unref0 (self->priv->_conn);
		self->priv->_conn = NULL;
	}
	_tmp23_ = self->priv->_contact_persona_map;
	if (_tmp23_ != NULL) {
		...
		while (TRUE) {
			...
			_tmp30_ = _g_object_ref0 ((TpContact*) _tmp29_);
			contact = _tmp30_;
			_tmp31_ = contact;
			g_object_weak_unref ((GObject*) _tmp31_, __tpf_persona_store_contact_weak_notify_cb_gweak_notify, self);
			_g_object_unref0 (contact);
		}
		_g_object_unref0 (iter);
	}
	_tmp32_ = gee_hash_map_new (tp_contact_get_type (), NULL, NULL, TPF_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	_g_object_unref0 (self->priv->_contact_persona_map);
	self->priv->_contact_persona_map = _tmp32_;
	_tmp33_ = folks_small_set_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, NULL, NULL, NULL, NULL, NULL, NULL);
	_g_object_unref0 (self->priv->_supported_fields);
	self->priv->_supported_fields = _tmp33_;
	_tmp34_ = self->priv->_supported_fields;
	_tmp35_ = gee_abstract_set_get_read_only_view ((GeeAbstractSet*) _tmp34_);
	_tmp36_ = _tmp35_;
	_g_object_unref0 (self->priv->_supported_fields_ro);
	self->priv->_supported_fields_ro = _tmp36_;
			...
			_tmp12_ = field_specs;
			{
				...
				for (field_spec_it = field_spec_collection; field_spec_it != NULL; field_spec_it = field_spec_it->next) {
					...
					field_spec = (TpContactInfoFieldSpec*) field_spec_it->data;
					{
						...
						TpContactInfoFieldSpec* _tmp14_ = NULL;
