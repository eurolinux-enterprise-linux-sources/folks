/* tpf-persona.c generated by valac 0.35.3.10-6b27, the Vala compiler
...
static gboolean tpf_persona_real_change_group_co (TpfPersonaChangeGroupData* _data_) {
	...
	{
		_data_->_tmp5_ = _data_->is_member;
		if (_data_->_tmp5_) {
			_data_->_tmp6_ = _data_->self->priv->_groups;
			_data_->_tmp7_ = _data_->group;
			_data_->_tmp8_ = gee_abstract_collection_contains ((GeeAbstractCollection*) _data_->_tmp6_, _data_->_tmp7_);
		...
		if (_data_->_tmp4_) {
			...
			_data_->_state_ = 1;
			tp_contact_add_to_group_async (_data_->_tmp9_, _data_->_tmp10_, tpf_persona_change_group_ready, _data_);
			return FALSE;
			_state_1:
			tp_contact_add_to_group_finish (_data_->_tmp9_, _data_->_res_, &_data_->_inner_error_);
			if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
				goto __catch2_g_error;
			}
		} else {
			_data_->_tmp12_ = _data_->is_member;
			if (!_data_->_tmp12_) {
				_data_->_tmp13_ = _data_->self->priv->_groups;
				_data_->_tmp14_ = _data_->group;
				_data_->_tmp15_ = gee_abstract_collection_contains ((GeeAbstractCollection*) _data_->_tmp13_, _data_->_tmp14_);
			...
			if (_data_->_tmp11_) {
				...
				_data_->_state_ = 2;
				tp_contact_remove_from_group_async (_data_->_tmp16_, _data_->_tmp17_, tpf_persona_change_group_ready, _data_);
				return FALSE;
				_state_2:
				tp_contact_remove_from_group_finish (_data_->_tmp16_, _data_->_res_, &_data_->_inner_error_);
				if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
					goto __catch2_g_error;
				}
			}
	...
	__catch2_g_error:
	{
		...
		_data_->_tmp20_ = g_error_new (FOLKS_PROPERTY_ERROR, FOLKS_PROPERTY_ERROR_UNKNOWN_ERROR, _ ("Failed to change group membership: %s"), _data_->_tmp19_);
...
static gboolean tpf_persona_real_change_groups_co (TpfPersonaChangeGroupsData* _data_) {
	...
	}
	{
		...
		_data_->_tmp5_ = _data_->groups;
		_data_->_tmp7_ = gee_collection_to_array ((GeeCollection*) _data_->_tmp5_, &_data_->_tmp6_);
		_data_->_tmp8_ = _data_->_tmp7_;
		_data_->_tmp8__length1 = _data_->_tmp6_;
		_data_->_state_ = 1;
		tp_contact_set_contact_groups_async (_data_->_tmp4_, _data_->_tmp6_, _data_->_tmp8_, tpf_persona_change_groups_ready, _data_);
		return FALSE;
		_state_1:
	...
	__catch3_g_error:
	{
		...
		_data_->_tmp11_ = g_error_new (FOLKS_PROPERTY_ERROR, FOLKS_PROPERTY_ERROR_UNKNOWN_ERROR, _ ("Failed to change group membership: %s"), _data_->_tmp10_);
...
static void _tpf_persona_contact_notify_contact_info (TpfPersona* self, gboolean create_if_not_exists, gboolean emit_notification) {
				...
				if (g_strcmp0 (_tmp41_, "") == 0) {
					...
					if (g_strcmp0 (_tmp43_, "bday") == 0) {
						...
						if (g_strcmp0 (_tmp50_, "email") == 0) {
							...
							_tmp52__length1 = _vala_array_length (_tmp51_->field_value);
							{
								...
								for (email_addr_it = 0; email_addr_it < _tmp52__length1; email_addr_it = email_addr_it + 1) {
									...
									email_addr = _tmp53_;
									{
										...
										if (g_strcmp0 (_tmp54_, "") != 0) {
											...
											_tmp56__length1 = _vala_array_length (_tmp55_->parameters);
							...
							if (g_strcmp0 (_tmp64_, "fn") == 0) {
								...
								_tmp66__length1 = _vala_array_length (_tmp65_->field_value);
								_tmp67_ = _tmp66_[0];
								...
								if (g_strcmp0 (_tmp72_, "tel") == 0) {
										...
										for (phone_num_it = 0; phone_num_it < _tmp74__length1; phone_num_it = phone_num_it + 1) {
											...
											phone_num = _tmp75_;
											{
												...
												if (g_strcmp0 (_tmp76_, "") != 0) {
													...
													FolksPhoneFieldDetails* _tmp84_;
													_tmp77_ = info;
													_tmp78_ = _tmp77_->parameters;
													_tmp78__length1 = _vala_array_length (_tmp77_->parameters);
									...
									if (g_strcmp0 (_tmp86_, "url") == 0) {
										TpContactInfoField* _tmp87_;
										gchar** _tmp88_;
										gint _tmp88__length1;
										_tmp87_ = info;
										_tmp88_ = _tmp87_->field_value;
										_tmp88__length1 = _vala_array_length (_tmp87_->field_value);
										{
											...
											for (url_it = 0; url_it < _tmp88__length1; url_it = url_it + 1) {
												...
												url = _tmp89_;
												{
													...
													if (g_strcmp0 (_tmp90_, "") != 0) {
														...
														FolksUrlFieldDetails* _tmp98_;
														_tmp91_ = info;
														_tmp92_ = _tmp91_->parameters;
														_tmp92__length1 = _vala_array_length (_tmp91_->parameters);
	...
	if (!_tmp136_) {
		...
		FolksSmallSet* _tmp138_;
		FolksSmallSet* _tmp139_;
		GeeSet* _tmp140_;
		GeeSet* _tmp141_;
		gboolean _tmp142_;
...
static void _tpf_persona_contact_notify_presence_type (TpfPersona* self) {
	...
	TpContact* _tmp0_;
	TpContact* _tmp1_;
	TpConnectionPresenceType _tmp2_;
...
static void tpf_persona_real_set_presence_type (FolksPresenceDetails* base, FolksPresenceType value) {
	TpfPersona* self;
	self = (TpfPersona*) base;
	if (tpf_persona_real_get_presence_type (self) != value) {
		FolksPresenceType _tmp0_;
		_tmp0_ = value;
...
static void tpf_persona_real_set_presence_status (FolksPresenceDetails* base, const gchar* value) {
	TpfPersona* self;
	self = (TpfPersona*) base;
	if (g_strcmp0 (value, tpf_persona_real_get_presence_status (self)) != 0) {
		const gchar* _tmp0_;
		gchar* _tmp1_;
		_tmp0_ = value;
...
static void tpf_persona_real_set_presence_message (FolksPresenceDetails* base, const gchar* value) {
	TpfPersona* self;
	self = (TpfPersona*) base;
	if (g_strcmp0 (value, tpf_persona_real_get_presence_message (self)) != 0) {
		const gchar* _tmp0_;
		gchar* _tmp1_;
		_tmp0_ = value;
		_tmp1_ = g_strdup (_tmp0_);
...
static void tpf_persona_real_set_client_types (FolksPresenceDetails* base, gchar** value, int value_length1) {
	...
	self = (TpfPersona*) base;
	if (tpf_persona_real_get_client_types (self, &old_value_length) != value) {
		gchar** _tmp0_;
		gint _tmp0__length1;
		gchar** _tmp1_;
		gint _tmp1__length1;
...
static void tpf_persona_set_contact (TpfPersona* self, TpContact* value) {
	g_return_if_fail (self != NULL);
	if (tpf_persona_get_contact (self) != value) {
		TpContact* _tmp0_;
		_tmp0_ = value;
