/* bluez-persona-store.c generated by valac 0.36.1.697-2b74, the Vala compiler
...
enum  {
	...
	FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_LAST_PROPERTY
};
static GParamSpec* folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_LAST_PROPERTY];
...
struct _FolksBackendsBlueZPersonaStoreUpdateContactsFromFileData {
	...
	gpointer _tmp99_;
	GeeHashMap* _tmp100_;
	FolksBackendsBlueZPersona* _tmp101_;
	const gchar* _tmp102_;
	const gchar* _tmp103_;
	FolksBackendsBlueZPersona* _tmp104_;
	...
	gpointer _tmp110_;
	GeeHashMap* _tmp111_;
	FolksBackendsBlueZPersona* _tmp112_;
...
struct _FolksBackendsBlueZPersonaStoreUpdateContactsData {
	...
	const gchar* _tmp21_;
	gboolean _tmp22_;
	orgbluezDevice* _tmp23_;
	gchar* _tmp24_;
	gchar* _tmp25_;
	gchar* _tmp26_;
	GError* _tmp27_;
	GError* _tmp28_;
	orgbluezDevice* _tmp29_;
	gchar* _tmp30_;
	gchar* _tmp31_;
	gchar* _tmp32_;
	GError* _tmp33_;
	...
	const gchar* _tmp44_;
	const gchar* _tmp45_;
	orgbluezobexPhonebookAccess* _tmp46_;
	...
	GVariant* _tmp76_;
	orgbluezobexPhonebookAccess* _tmp77_;
	GHashTable* _tmp78_;
	gchar* _tmp79_;
	GHashTable* _tmp80_;
	GError* e2;
	orgbluezDevice* _tmp81_;
	gchar* _tmp82_;
	gchar* _tmp83_;
	gchar* _tmp84_;
	GError* _tmp85_;
...
static void _folks_backends_blue_z_persona_store_update_contacts_from_file_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_backends_blue_z_persona_store_set_connection_state_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void _folks_backends_blue_z_persona_store_new_obex_session_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void _folks_backends_blue_z_persona_store_remove_obex_session_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void _folks_backends_blue_z_persona_store_perform_obex_transfer_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void _folks_backends_blue_z_persona_store_update_contacts_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_backends_blue_z_persona_store_real_prepare_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_backends_blue_z_persona_store_real_remove_persona_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_backends_blue_z_persona_store_real_add_persona_from_details_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
FolksBackendsBlueZPersonaStore* folks_backends_blue_z_persona_store_construct (GType object_type, orgbluezDevice* device, const gchar* object_path, orgbluezobexClient* obex_client) {
	...
	orgbluezobexClient* _tmp11_;
	orgbluezobexClient* _tmp12_;
	orgbluezDevice* _tmp13_;
	gboolean _tmp14_;
	gboolean _tmp15_;
...
static void _folks_backends_blue_z_persona_store_update_contacts_from_file_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreUpdateContactsFromFileData* _task_data_;
...
static void _folks_backends_blue_z_persona_store_update_contacts_from_file (FolksBackendsBlueZPersonaStore* self, GFile* file, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, _folks_backends_blue_z_persona_store_update_contacts_from_file_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
...
static gboolean _folks_backends_blue_z_persona_store_update_contacts_from_file_co (FolksBackendsBlueZPersonaStoreUpdateContactsFromFileData* _data_) {
	...
	_data_->_tmp7_ = gee_abstract_map_get_values ((GeeAbstractMap*) _data_->_tmp6_);
	...
	__catch8_g_error:
	{
		...
		_data_->_tmp85_ = _data_->e1;
		_data_->_tmp86_ = _data_->_tmp85_->message;
		_data_->_tmp87_ = g_error_new (G_IO_ERROR, G_IO_ERROR_FAILED, _ ("Error reading the transferred address book file: %s"), _data_->_tmp86_);
	...
	_data_->_tmp88_ = _data_->added_personas;
	_data_->_tmp89_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) _data_->_tmp88_);
	_data_->_tmp90_ = _data_->_tmp89_;
	_data_->_tmp91_ = _data_->removed_personas;
	_data_->_tmp92_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) _data_->_tmp91_);
	_data_->_tmp93_ = _data_->_tmp92_;
	g_debug ("Finished parsing personas; now updating store state with %u " "added personas and %u removed personas.", _data_->_tmp90_, _data_->_tmp93_);
	{
		_data_->_tmp94_ = _data_->added_personas;
		_data_->_tmp95_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _data_->_tmp94_);
		_data_->_p_it = _data_->_tmp95_;
		while (TRUE) {
			_data_->_tmp96_ = _data_->_p_it;
			_data_->_tmp97_ = gee_iterator_next (_data_->_tmp96_);
			if (!_data_->_tmp97_) {
				break;
			}
			_data_->_tmp98_ = _data_->_p_it;
			_data_->_tmp99_ = gee_iterator_get (_data_->_tmp98_);
			_data_->p = (FolksBackendsBlueZPersona*) _data_->_tmp99_;
			_data_->_tmp100_ = _data_->self->priv->_personas;
			_data_->_tmp101_ = _data_->p;
			_data_->_tmp102_ = folks_persona_get_iid ((FolksPersona*) _data_->_tmp101_);
			_data_->_tmp103_ = _data_->_tmp102_;
			_data_->_tmp104_ = _data_->p;
			gee_abstract_map_set ((GeeAbstractMap*) _data_->_tmp100_, _data_->_tmp103_, _data_->_tmp104_);
	...
	}
	{
		...
		_data_->_tmp106_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _data_->_tmp105_);
		_data_->_vala1__p_it = _data_->_tmp106_;
		while (TRUE) {
			_data_->_tmp107_ = _data_->_vala1__p_it;
			_data_->_tmp108_ = gee_iterator_next (_data_->_tmp107_);
			if (!_data_->_tmp108_) {
				break;
			}
			_data_->_tmp109_ = _data_->_vala1__p_it;
			_data_->_tmp110_ = gee_iterator_get (_data_->_tmp109_);
			_data_->_vala1_p = (FolksBackendsBlueZPersona*) _data_->_tmp110_;
			_data_->_tmp111_ = _data_->self->priv->_personas;
			_data_->_tmp112_ = _data_->_vala1_p;
			_data_->_tmp113_ = folks_persona_get_iid ((FolksPersona*) _data_->_tmp112_);
			_data_->_tmp114_ = _data_->_tmp113_;
			gee_abstract_map_unset ((GeeAbstractMap*) _data_->_tmp111_, _data_->_tmp114_, NULL);
			_g_object_unref0 (_data_->_vala1_p);
		}
		_g_object_unref0 (_data_->_vala1__p_it);
	}
	_data_->_tmp115_ = _data_->photos_up_to_date;
	_data_->self->priv->_photos_up_to_date = _data_->_tmp115_;
	_data_->_tmp117_ = _data_->added_personas;
	_data_->_tmp118_ = gee_collection_get_is_empty ((GeeCollection*) _data_->_tmp117_);
	_data_->_tmp119_ = _data_->_tmp118_;
	if (_data_->_tmp119_ == FALSE) {
		_data_->_tmp116_ = TRUE;
	} else {
		_data_->_tmp120_ = _data_->removed_personas;
		_data_->_tmp121_ = gee_collection_get_is_empty ((GeeCollection*) _data_->_tmp120_);
		_data_->_tmp122_ = _data_->_tmp121_;
		_data_->_tmp116_ = _data_->_tmp122_ == FALSE;
	}
	if (_data_->_tmp116_) {
		_data_->_tmp123_ = _data_->added_personas;
		_data_->_tmp124_ = _data_->removed_personas;
		_folks_persona_store_emit_personas_changed ((FolksPersonaStore*) _data_->self, (GeeSet*) _data_->_tmp123_, (GeeSet*) _data_->_tmp124_, NULL, NULL, FOLKS_GROUP_DETAILS_CHANGE_REASON_NONE);
	}
	_g_object_unref0 (_data_->removed_personas);
	_g_object_unref0 (_data_->added_personas);
...
static void folks_backends_blue_z_persona_store_set_connection_state_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreSetConnectionStateData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
void folks_backends_blue_z_persona_store_set_connection_state (FolksBackendsBlueZPersonaStore* self, gboolean connected, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, folks_backends_blue_z_persona_store_set_connection_state_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static void _folks_backends_blue_z_persona_store_new_obex_session_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreNewObexSessionData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void _folks_backends_blue_z_persona_store_new_obex_session (FolksBackendsBlueZPersonaStore* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, _folks_backends_blue_z_persona_store_new_obex_session_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static void _folks_backends_blue_z_persona_store_remove_obex_session_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreRemoveObexSessionData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void _folks_backends_blue_z_persona_store_remove_obex_session (FolksBackendsBlueZPersonaStore* self, const char* session_path, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, _folks_backends_blue_z_persona_store_remove_obex_session_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static void _folks_backends_blue_z_persona_store_perform_obex_transfer_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStorePerformObexTransferData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void _folks_backends_blue_z_persona_store_perform_obex_transfer (FolksBackendsBlueZPersonaStore* self, const gchar* path, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), cancellable, _folks_backends_blue_z_persona_store_perform_obex_transfer_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static gboolean _folks_backends_blue_z_persona_store_perform_obex_transfer_co (FolksBackendsBlueZPersonaStorePerformObexTransferData* _data_) {
	...
	_data_->transfer = NULL;
	{
		...
		_data_->_tmp7_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp6_, g_dbus_proxy_get_type (), GDBusProxy));
		...
		if (g_strcmp0 (_data_->_tmp24_, "complete") == 0) {
			...
			if (_data_->_tmp28_ == NULL) {
				_data_->_tmp29_ = _data_->transfer;
				_data_->_tmp30_ = org_bluez_obex_transfer_get_name (_data_->_tmp29_);
				_data_->_tmp31_ = _data_->_tmp30_;
				_data_->_tmp32_ = _data_->_tmp31_;
				_data_->_tmp33_ = _data_->self->priv->_display_name;
				_data_->_tmp34_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _ ("Error during transfer of the address book ‘%s’ from " "Bluetooth device ‘%s’."), _data_->_tmp32_, _data_->_tmp33_);
			...
			_data_->_tmp37_ = g_file_new_for_path ((const gchar*) _data_->_tmp36_);
			_data_->file = _data_->_tmp37_;
...
"s", _data_->_tmp38_, _data_->_tmp40_, (const gchar*) _data_->_tmp41_);
			_data_->_tmp42_ = _data_->file;
			_data_->_state_ = 3;
			_folks_backends_blue_z_persona_store_update_contacts_from_file (_data_->self, _data_->_tmp42_, _folks_backends_blue_z_persona_store_perform_obex_transfer_ready, _data_);
			return FALSE;
			_state_3:
			...
			_data_->_tmp43_ = _data_->_data3_->transfer_status;
			if (g_strcmp0 (_data_->_tmp43_, "error") == 0) {
				_data_->_tmp44_ = _data_->cancellable;
				if (_data_->_tmp44_ != NULL) {
					_data_->_tmp45_ = _data_->cancellable;
					g_cancellable_set_error_if_cancelled (_data_->_tmp45_, &_data_->_inner_error_);
					if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
						_g_object_unref0 (_data_->transfer_proxy);
						_g_object_unref0 (_data_->_tmp2_);
						block3_data_unref (_data_->_data3_);
				...
				_data_->_tmp51_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _ ("Error during transfer of the address book ‘%s’ from Bluetooth device ‘" \
"%s’."), _data_->_tmp49_, _data_->_tmp50_);
				_data_->_tmp52_ = _data_->_tmp51_;
	...
	__finally10:
	{
		...
		if (_data_->_tmp53_) {
			...
			g_file_delete_async (_data_->_tmp65_, G_PRIORITY_DEFAULT, NULL, _____lambda6__gasync_ready_callback, block4_data_ref (_data_->_data4_));
...
static void _folks_backends_blue_z_persona_store_update_contacts_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreUpdateContactsData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void _folks_backends_blue_z_persona_store_update_contacts (FolksBackendsBlueZPersonaStore* self, gboolean download_photos, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, _folks_backends_blue_z_persona_store_update_contacts_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
"ate operation.");
		...
		__catch13_g_error:
		{
			...
			if (_data_->_tmp18_) {
				_data_->_tmp23_ = _data_->self->priv->_device;
				_data_->_tmp24_ = org_bluez_device_get_alias (_data_->_tmp23_);
				_data_->_tmp25_ = _data_->_tmp24_;
				_data_->_tmp26_ = _data_->_tmp25_;
				_data_->_tmp27_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_PERMISSION_DENIED, _ ("Permission to access the address book on Bluetooth device ‘%s’ was den" \
"ied by the user."), _data_->_tmp26_);
			...
			_data_->_tmp29_ = _data_->self->priv->_device;
			_data_->_tmp30_ = org_bluez_device_get_alias (_data_->_tmp29_);
			_data_->_tmp31_ = _data_->_tmp30_;
			_data_->_tmp32_ = _data_->_tmp31_;
			_data_->_tmp33_ = _data_->e1;
			_data_->_tmp34_ = _data_->_tmp33_->message;
			_data_->_tmp35_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _ ("An OBEX address book transfer from device ‘%s’ could not be started: %" \
"s"), _data_->_tmp32_, _data_->_tmp34_);
		...
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
			...
			_g_free0 (_data_->path);
			{
				_data_->_tmp37_ = _data_->session_path;
				if (_data_->_tmp37_ != NULL) {
					_data_->_tmp38_ = _data_->session_path;
					_folks_backends_blue_z_persona_store_remove_obex_session (_data_->self, _data_->_tmp38_, NULL, NULL);
				}
				_g_object_unref0 (_data_->obex_pbap);
				_data_->obex_pbap = NULL;
				_g_object_unref0 (_data_->self->priv->_update_contacts_cancellable);
				_data_->self->priv->_update_contacts_cancellable = NULL;
				_data_->_tmp39_ = _data_->success;
				if (_data_->_tmp39_ == TRUE) {
					_data_->self->priv->_update_contacts_failures = (guint) 0;
				} else {
					_data_->_tmp40_ = _data_->self->priv->_update_contacts_failures;
					_data_->self->priv->_update_contacts_failures = _data_->_tmp40_ + 1;
				}
				_data_->_tmp41_ = _data_->success;
				if (_data_->_tmp41_ == TRUE) {
					_data_->_tmp42_ = _data_->self->priv->_photos_up_to_date;
					_data_->_vala1__tmp5_ = _data_->_tmp42_ == FALSE;
				} else {
					_data_->_vala1__tmp5_ = FALSE;
				}
				_data_->_vala1_new_download_photos = _data_->_vala1__tmp5_;
				_data_->_tmp43_ = _data_->_vala1_new_download_photos;
				_folks_backends_blue_z_persona_store_schedule_update_contacts (_data_->self, _data_->_tmp43_);
				_data_->_tmp44_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
				_data_->_tmp45_ = _data_->_tmp44_;
				folks_internal_profiling_end ("updating BlueZ.PersonaStore (ID: %s) " "contacts", _data_->_tmp45_, NULL);
			}
			_g_object_unref0 (_data_->obex_pbap);
			_g_free0 (_data_->session_path);
			g_critical ("file %s: line %d: unexpected error: %s (%s, %d)", __FILE__, __LINE__, _data_->_inner_error_->message, g_quark_to_string (_data_->_inner_error_->domain), _data_->_inner_error_->code);
		...
		{
			_data_->_tmp46_ = _data_->obex_pbap;
			org_bluez_obex_phonebook_access_select (_data_->_tmp46_, "int", "PB", &_data_->_inner_error_);
			if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
				goto __catch14_g_error;
			}
			_data_->_tmp47_ = g_hash_table_new_full (NULL, NULL, _g_free0_, _g_variant_unref0_);
			_data_->phonebook_filter = _data_->_tmp47_;
			_data_->_tmp48_ = _data_->phonebook_filter;
			_data_->_tmp49_ = g_strdup ("Format");
			_data_->_tmp50_ = _variant_new2 ("Vcard30");
			g_hash_table_insert (_data_->_tmp48_, _data_->_tmp49_, _data_->_tmp50_);
			_data_->_tmp51_ = _data_->download_photos;
			if (_data_->_tmp51_ == TRUE) {
				_data_->_tmp52_ = _data_->phonebook_filter;
				_data_->_tmp53_ = g_strdup ("Fields");
				_data_->_tmp54_ = g_strdup ("UID");
				_data_->_tmp55_ = g_strdup ("N");
				_data_->_tmp56_ = g_strdup ("FN");
				_data_->_tmp57_ = g_strdup ("NICKNAME");
				_data_->_tmp58_ = g_strdup ("TEL");
				_data_->_tmp59_ = g_strdup ("URL");
				_data_->_tmp60_ = g_strdup ("EMAIL");
				_data_->_tmp61_ = g_strdup ("PHOTO");
				_data_->_tmp62_ = g_new0 (gchar*, 8 + 1);
				_data_->_tmp62_[0] = _data_->_tmp54_;
				_data_->_tmp62_[1] = _data_->_tmp55_;
				_data_->_tmp62_[2] = _data_->_tmp56_;
				_data_->_tmp62_[3] = _data_->_tmp57_;
				_data_->_tmp62_[4] = _data_->_tmp58_;
				_data_->_tmp62_[5] = _data_->_tmp59_;
				_data_->_tmp62_[6] = _data_->_tmp60_;
				_data_->_tmp62_[7] = _data_->_tmp61_;
				_data_->_tmp63_ = _data_->_tmp62_;
				_data_->_tmp63__length1 = 8;
				_data_->_tmp64_ = g_variant_new_strv (_data_->_tmp63_, 8);
				g_variant_ref_sink (_data_->_tmp64_);
				g_hash_table_insert (_data_->_tmp52_, _data_->_tmp53_, _data_->_tmp64_);
				_data_->_tmp63_ = (_vala_array_free (_data_->_tmp63_, _data_->_tmp63__length1, (GDestroyNotify) g_free), NULL);
			} else {
				_data_->_tmp65_ = _data_->phonebook_filter;
				_data_->_tmp66_ = g_strdup ("Fields");
				_data_->_tmp67_ = g_strdup ("UID");
				_data_->_tmp68_ = g_strdup ("N");
				_data_->_tmp69_ = g_strdup ("FN");
				_data_->_tmp70_ = g_strdup ("NICKNAME");
				_data_->_tmp71_ = g_strdup ("TEL");
				_data_->_tmp72_ = g_strdup ("URL");
				_data_->_tmp73_ = g_strdup ("EMAIL");
				_data_->_tmp74_ = g_new0 (gchar*, 7 + 1);
				_data_->_tmp74_[0] = _data_->_tmp67_;
				_data_->_tmp74_[1] = _data_->_tmp68_;
				_data_->_tmp74_[2] = _data_->_tmp69_;
				_data_->_tmp74_[3] = _data_->_tmp70_;
				_data_->_tmp74_[4] = _data_->_tmp71_;
				_data_->_tmp74_[5] = _data_->_tmp72_;
				_data_->_tmp74_[6] = _data_->_tmp73_;
				_data_->_tmp75_ = _data_->_tmp74_;
				_data_->_tmp75__length1 = 7;
				_data_->_tmp76_ = g_variant_new_strv (_data_->_tmp75_, 7);
				g_variant_ref_sink (_data_->_tmp76_);
				g_hash_table_insert (_data_->_tmp65_, _data_->_tmp66_, _data_->_tmp76_);
				_data_->_tmp75_ = (_vala_array_free (_data_->_tmp75_, _data_->_tmp75__length1, (GDestroyNotify) g_free), NULL);
			}
			_data_->_tmp77_ = _data_->obex_pbap;
			_data_->_tmp78_ = _data_->phonebook_filter;
			_data_->_tmp79_ = NULL;
			_data_->_tmp80_ = NULL;
			org_bluez_obex_phonebook_access_pull_all (_data_->_tmp77_, "", _data_->_tmp78_, &_data_->_tmp79_, &_data_->_tmp80_, &_data_->_inner_error_);
			_g_free0 (_data_->path);
			_data_->path = _data_->_tmp79_;
			_g_hash_table_unref0 (_data_->props);
			_data_->props = _data_->_tmp80_;
			if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
		...
		__catch14_g_error:
		{
			...
			_data_->_inner_error_ = NULL;
			_data_->_tmp81_ = _data_->self->priv->_device;
			_data_->_tmp82_ = org_bluez_device_get_alias (_data_->_tmp81_);
			_data_->_tmp83_ = _data_->_tmp82_;
			_data_->_tmp84_ = _data_->_tmp83_;
			_data_->_tmp85_ = _data_->e2;
			_data_->_tmp86_ = _data_->_tmp85_->message;
			_data_->_tmp87_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _ ("The OBEX address book transfer from device ‘%s’ failed: %s"), _data_->_tmp84_, _data_->_tmp86_);
		...
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
			...
			_g_free0 (_data_->path);
			{
				_data_->_tmp89_ = _data_->session_path;
				if (_data_->_tmp89_ != NULL) {
					_data_->_tmp90_ = _data_->session_path;
					_folks_backends_blue_z_persona_store_remove_obex_session (_data_->self, _data_->_tmp90_, NULL, NULL);
				}
				_g_object_unref0 (_data_->obex_pbap);
				_data_->obex_pbap = NULL;
				_g_object_unref0 (_data_->self->priv->_update_contacts_cancellable);
				_data_->self->priv->_update_contacts_cancellable = NULL;
				_data_->_tmp91_ = _data_->success;
				if (_data_->_tmp91_ == TRUE) {
					_data_->self->priv->_update_contacts_failures = (guint) 0;
				} else {
					_data_->_tmp92_ = _data_->self->priv->_update_contacts_failures;
					_data_->self->priv->_update_contacts_failures = _data_->_tmp92_ + 1;
				}
				_data_->_tmp93_ = _data_->success;
				if (_data_->_tmp93_ == TRUE) {
					_data_->_tmp94_ = _data_->self->priv->_photos_up_to_date;
					_data_->_vala2__tmp5_ = _data_->_tmp94_ == FALSE;
				} else {
					_data_->_vala2__tmp5_ = FALSE;
				}
				_data_->_vala2_new_download_photos = _data_->_vala2__tmp5_;
				_data_->_tmp95_ = _data_->_vala2_new_download_photos;
				_folks_backends_blue_z_persona_store_schedule_update_contacts (_data_->self, _data_->_tmp95_);
				_data_->_tmp96_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
				_data_->_tmp97_ = _data_->_tmp96_;
				folks_internal_profiling_end ("updating BlueZ.PersonaStore (ID: %s) " "contacts", _data_->_tmp97_, NULL);
			}
			_g_object_unref0 (_data_->obex_pbap);
			_g_free0 (_data_->session_path);
			g_critical ("file %s: line %d: unexpected error: %s (%s, %d)", __FILE__, __LINE__, _data_->_inner_error_->message, g_quark_to_string (_data_->_inner_error_->domain), _data_->_inner_error_->code);
		...
		{
			_data_->_tmp98_ = _data_->path;
			_data_->_tmp99_ = _data_->self->priv->_update_contacts_cancellable;
			_data_->_state_ = 2;
			_folks_backends_blue_z_persona_store_perform_obex_transfer (_data_->self, _data_->_tmp98_, _data_->_tmp99_, _folks_backends_blue_z_persona_store_update_contacts_ready, _data_);
			return FALSE;
			_state_2:
		...
		__catch15_g_io_error:
		{
			...
			_data_->_inner_error_ = NULL;
			_data_->_tmp100_ = _data_->e3;
			if (g_error_matches (_data_->_tmp100_, G_IO_ERROR, G_IO_ERROR_CANCELLED)) {
				_data_->_tmp101_ = _data_->e3;
				_data_->_tmp102_ = _g_error_copy0 (_data_->_tmp101_);
				_data_->_inner_error_ = _data_->_tmp102_;
				_g_error_free0 (_data_->e3);
				goto __finally15;
			}
			_data_->_tmp103_ = _data_->self->priv->_display_name;
			_data_->_tmp104_ = _data_->e3;
			_data_->_tmp105_ = _data_->_tmp104_->message;
			_data_->_tmp106_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _ ("Error during transfer of the address book from Bluetooth device ‘%s’: " \
"%s"), _data_->_tmp103_, _data_->_tmp105_);
		...
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
			...
			_g_free0 (_data_->path);
			{
				_data_->_tmp107_ = _data_->session_path;
				if (_data_->_tmp107_ != NULL) {
					_data_->_tmp108_ = _data_->session_path;
					_folks_backends_blue_z_persona_store_remove_obex_session (_data_->self, _data_->_tmp108_, NULL, NULL);
				}
				_g_object_unref0 (_data_->obex_pbap);
				_data_->obex_pbap = NULL;
				_g_object_unref0 (_data_->self->priv->_update_contacts_cancellable);
				_data_->self->priv->_update_contacts_cancellable = NULL;
				_data_->_tmp109_ = _data_->success;
				if (_data_->_tmp109_ == TRUE) {
					_data_->self->priv->_update_contacts_failures = (guint) 0;
				} else {
					_data_->_tmp110_ = _data_->self->priv->_update_contacts_failures;
					_data_->self->priv->_update_contacts_failures = _data_->_tmp110_ + 1;
				}
				_data_->_tmp111_ = _data_->success;
				if (_data_->_tmp111_ == TRUE) {
					_data_->_tmp112_ = _data_->self->priv->_photos_up_to_date;
					_data_->_vala3__tmp5_ = _data_->_tmp112_ == FALSE;
				} else {
					_data_->_vala3__tmp5_ = FALSE;
				}
				_data_->_vala3_new_download_photos = _data_->_vala3__tmp5_;
				_data_->_tmp113_ = _data_->_vala3_new_download_photos;
				_folks_backends_blue_z_persona_store_schedule_update_contacts (_data_->self, _data_->_tmp113_);
				_data_->_tmp114_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
				_data_->_tmp115_ = _data_->_tmp114_;
				folks_internal_profiling_end ("updating BlueZ.PersonaStore (ID: %s) " "contacts", _data_->_tmp115_, NULL);
			}
			_g_object_unref0 (_data_->obex_pbap);
			_g_free0 (_data_->session_path);
			g_critical ("file %s: line %d: unexpected error: %s (%s, %d)", __FILE__, __LINE__, _data_->_inner_error_->message, g_quark_to_string (_data_->_inner_error_->domain), _data_->_inner_error_->code);
	...
	__catch12_g_io_error:
	{
		...
		_data_->_tmp116_ = _data_->e4;
		_data_->_tmp117_ = _g_error_copy0 (_data_->_tmp116_);
	...
	__catch12_folks_persona_store_error:
	{
		...
		_data_->_inner_error_ = NULL;
		_data_->success = FALSE;
		_data_->_tmp118_ = _data_->e5;
		_data_->_tmp119_ = _g_error_copy0 (_data_->_tmp118_);
	...
	__finally12:
	{
		_data_->_tmp120_ = _data_->session_path;
		if (_data_->_tmp120_ != NULL) {
			_data_->_tmp121_ = _data_->session_path;
			_folks_backends_blue_z_persona_store_remove_obex_session (_data_->self, _data_->_tmp121_, NULL, NULL);
		}
		_g_object_unref0 (_data_->obex_pbap);
		_data_->obex_pbap = NULL;
		_g_object_unref0 (_data_->self->priv->_update_contacts_cancellable);
		_data_->self->priv->_update_contacts_cancellable = NULL;
		_data_->_tmp122_ = _data_->success;
		if (_data_->_tmp122_ == TRUE) {
			_data_->self->priv->_update_contacts_failures = (guint) 0;
		} else {
			_data_->_tmp123_ = _data_->self->priv->_update_contacts_failures;
			_data_->self->priv->_update_contacts_failures = _data_->_tmp123_ + 1;
		}
		_data_->_tmp124_ = _data_->success;
		if (_data_->_tmp124_ == TRUE) {
			_data_->_tmp125_ = _data_->self->priv->_photos_up_to_date;
			_data_->_vala4__tmp5_ = _data_->_tmp125_ == FALSE;
		} else {
			_data_->_vala4__tmp5_ = FALSE;
		}
		_data_->_vala4_new_download_photos = _data_->_vala4__tmp5_;
		_data_->_tmp126_ = _data_->_vala4_new_download_photos;
		_folks_backends_blue_z_persona_store_schedule_update_contacts (_data_->self, _data_->_tmp126_);
		_data_->_tmp127_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
		_data_->_tmp128_ = _data_->_tmp127_;
		folks_internal_profiling_end ("updating BlueZ.PersonaStore (ID: %s) " "contacts", _data_->_tmp128_, NULL);
	}
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
		if ((_data_->_inner_error_->domain == G_IO_ERROR) || (_data_->_inner_error_->domain == FOLKS_PERSONA_STORE_ERROR)) {
			g_task_return_error (_data_->_async_result, _data_->_inner_error_);
...
static void folks_backends_blue_z_persona_store_real_prepare_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStorePrepareData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void folks_backends_blue_z_persona_store_real_prepare (FolksPersonaStore* base, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, folks_backends_blue_z_persona_store_real_prepare_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static gboolean folks_backends_blue_z_persona_store_real_prepare_co (FolksBackendsBlueZPersonaStorePrepareData* _data_) {
	...
	}
	{
		...
		__catch18_g_io_error:
		{
			...
			_data_->_inner_error_ = NULL;
			_data_->_tmp5_ = _data_->self->priv->_device;
			_data_->_tmp6_ = org_bluez_device_get_alias (_data_->_tmp5_);
			_data_->_tmp7_ = _data_->_tmp6_;
			_data_->_tmp8_ = _data_->_tmp7_;
			_data_->_tmp9_ = g_error_new (FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE, _ ("Bluetooth device ‘%s’ disappeared during address book transfer."), _data_->_tmp8_);
			_data_->_tmp10_ = _data_->_tmp9_;
			_g_free0 (_data_->_tmp8_);
	...
	_data_->_tmp11_ = folks_persona_store_get_id ((FolksPersonaStore*) _data_->self);
	_data_->_tmp12_ = _data_->_tmp11_;
	folks_internal_profiling_end ("preparing BlueZ.PersonaStore (ID: %s)", _data_->_tmp12_, NULL);
	g_task_return_pointer (_data_->_async_result, _data_, NULL);
	if (_data_->_state_ != 0) {
		while (_data_->_task_complete_ != TRUE) {
			g_main_context_iteration (g_task_get_context (_data_->_async_result), TRUE);
...
static void folks_backends_blue_z_persona_store_real_remove_persona_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreRemovePersonaData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void folks_backends_blue_z_persona_store_real_remove_persona (FolksPersonaStore* base, FolksPersona* persona, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, folks_backends_blue_z_persona_store_real_remove_persona_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static void folks_backends_blue_z_persona_store_real_add_persona_from_details_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data) {
	FolksBackendsBlueZPersonaStoreAddPersonaFromDetailsData* _task_data_;
	_task_data_ = g_task_get_task_data (G_TASK (res));
	if (_task_data_->_callback_ != NULL) {
		_task_data_->_callback_ (source_object, res, user_data);
	}
...
static void folks_backends_blue_z_persona_store_real_add_persona_from_details (FolksPersonaStore* base, GHashTable* details, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_callback_ = _callback_;
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, folks_backends_blue_z_persona_store_real_add_persona_from_details_async_ready_wrapper, _user_data_);
	if (_callback_ == NULL) {
		_data_->_task_complete_ = TRUE;
	}
...
static void folks_backends_blue_z_persona_store_set_display_name (FolksBackendsBlueZPersonaStore* self, const gchar* value) {
	...
	g_object_notify_by_pspec ((GObject *) self, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_DISPLAY_NAME]);
}
...
static void folks_backends_blue_z_persona_store_set_object_path (FolksBackendsBlueZPersonaStore* self, const gchar* value) {
	...
	g_object_notify_by_pspec ((GObject *) self, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_OBJECT_PATH]);
}
...
static void folks_backends_blue_z_persona_store_class_init (FolksBackendsBlueZPersonaStoreClass * klass) {
	...
	((FolksPersonaStoreClass *) klass)->prepare_finish = (void (*) (FolksPersonaStore *, GAsyncResult*, GError**)) folks_backends_blue_z_persona_store_real_prepare_finish;
	...
	((FolksPersonaStoreClass *) klass)->remove_persona_finish = (void (*) (FolksPersonaStore *, GAsyncResult*, GError**)) folks_backends_blue_z_persona_store_real_remove_persona_finish;
	...
	((FolksPersonaStoreClass *) klass)->add_persona_from_details_finish = (FolksPersona* (*) (FolksPersonaStore *, GAsyncResult*, GError**)) folks_backends_blue_z_persona_store_real_add_persona_from_details_finish;
	...
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_TYPE_ID, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_TYPE_ID] = g_param_spec_string ("type-id", "type-id", "type-id", NULL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_ADD_PERSONAS, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_ADD_PERSONAS] = g_param_spec_enum ("can-add-personas", "can-add-personas", "can-add-personas", FOLKS_TYPE_MAYBE_BOOL, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_ALIAS_PERSONAS, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_ALIAS_PERSONAS] = g_param_spec_enum ("can-alias-personas", "can-alias-personas", "can-alias-personas", FOLKS_TYPE_MAYBE_BOOL, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_GROUP_PERSONAS, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_GROUP_PERSONAS] = g_param_spec_enum ("can-group-personas", "can-group-personas", "can-group-personas", FOLKS_TYPE_MAYBE_BOOL, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_REMOVE_PERSONAS, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_CAN_REMOVE_PERSONAS] = g_param_spec_enum ("can-remove-personas", "can-remove-personas", "can-remove-personas", FOLKS_TYPE_MAYBE_BOOL, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_IS_PREPARED, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_IS_PREPARED] = g_param_spec_boolean ("is-prepared", "is-prepared", "is-prepared", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_IS_QUIESCENT, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_IS_QUIESCENT] = g_param_spec_boolean ("is-quiescent", "is-quiescent", "is-quiescent", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   * {@inheritDoc}
	   *
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_ALWAYS_WRITEABLE_PROPERTIES, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_ALWAYS_WRITEABLE_PROPERTIES] = g_param_spec_boxed ("always-writeable-properties", "always-writeable-properties", "always-writeable-properties", G_TYPE_STRV, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   * {@inheritDoc}
	   *
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_PERSONAS, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_PERSONAS] = g_param_spec_object ("personas", "personas", "personas", GEE_TYPE_MAP, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   * {@inheritDoc}
	   *
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_DISPLAY_NAME, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_DISPLAY_NAME] = g_param_spec_string ("display-name", "display-name", "display-name", NULL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));
	/**
	   ...
	   * @since 0.9.6
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_OBJECT_PATH, folks_backends_blue_z_persona_store_properties[FOLKS_BACKENDS_BLUE_Z_PERSONA_STORE_OBJECT_PATH] = g_param_spec_string ("object-path", "object-path", "object-path", NULL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));
