/* sw-backend-factory.c generated by valac 0.20.1.30-1b1d, the Vala compiler
...
void module_init (FolksBackendStore* backend_store) {
	...
	FolksBackendsSwBackendFactory* _tmp1_;
	g_return_if_fail (backend_store != NULL);
	_tmp0_ = backend_store;
	_tmp1_ = folks_backends_sw_backend_factory_new (_tmp0_);
	_g_object_unref0 (backend_factory);
	backend_factory = _tmp1_;
}
