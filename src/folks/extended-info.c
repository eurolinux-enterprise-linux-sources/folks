/* extended-info.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
FolksExtendedFieldDetails* folks_extended_field_details_construct (GType object_type, const gchar* value, GeeMultiMap* parameters) {
	...
	self = (FolksExtendedFieldDetails*) folks_abstract_field_details_construct (object_type, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free);
	_tmp0_ = value;
...
static void folks_extended_field_details_class_init (FolksExtendedFieldDetailsClass * klass) {
	...
	((FolksAbstractFieldDetailsClass *) klass)->equal = folks_extended_field_details_real_equal;
	((FolksAbstractFieldDetailsClass *) klass)->hash = folks_extended_field_details_real_hash;
}
...
static void folks_extended_info_real_change_extended_field (FolksExtendedInfo* self, const gchar* name, FolksExtendedFieldDetails* value, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, folks_extended_info_real_change_extended_field);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, folks_extended_info_real_change_extended_field_data_free);
...
static gboolean folks_extended_info_real_change_extended_field_co (FolksExtendedInfoChangeExtendedFieldData* _data_) {
	...
	_state_0:
	_data_->_tmp0_ = NULL;
	_data_->_tmp0_ = _ ("Extended fields are not writeable on this contact.");
	_data_->_tmp1_ = NULL;
...
static void folks_extended_info_real_remove_extended_field (FolksExtendedInfo* self, const gchar* name, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, folks_extended_info_real_remove_extended_field);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, folks_extended_info_real_remove_extended_field_data_free);
	_tmp0_ = _g_object_ref0 (self);
	_data_->self = _tmp0_;
	_tmp1_ = name;
	_tmp2_ = g_strdup (_tmp1_);
