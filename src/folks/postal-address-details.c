...
static void _folks_postal_address_field_details___lambda30_ (FolksPostalAddressFieldDetails* self, GObject* s, GParamSpec* p);
...
static void __folks_postal_address_field_details___lambda30__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
...
gboolean folks_postal_address_is_empty (FolksPostalAddress* self) {
	...
	if (_tmp11_) {
		const gchar* _tmp12_;
		const gchar* _tmp13_;
		_tmp12_ = folks_postal_address_get_street (self);
		_tmp13_ = _tmp12_;
	...
	if (_tmp17_) {
		const gchar* _tmp18_;
		const gchar* _tmp19_;
		_tmp18_ = folks_postal_address_get_region (self);
		_tmp19_ = _tmp18_;
		_tmp3_ = g_strcmp0 (_tmp19_, "") == 0;
	} else {
		_tmp3_ = FALSE;
	}
	_tmp20_ = _tmp3_;
	if (_tmp20_) {
		const gchar* _tmp21_;
		const gchar* _tmp22_;
		_tmp21_ = folks_postal_address_get_postal_code (self);
		_tmp22_ = _tmp21_;
		_tmp2_ = g_strcmp0 (_tmp22_, "") == 0;
	} else {
		_tmp2_ = FALSE;
	}
	_tmp23_ = _tmp2_;
	if (_tmp23_) {
		const gchar* _tmp24_;
		const gchar* _tmp25_;
		_tmp24_ = folks_postal_address_get_country (self);
		_tmp25_ = _tmp24_;
		_tmp1_ = g_strcmp0 (_tmp25_, "") == 0;
	} else {
		_tmp1_ = FALSE;
	}
	_tmp26_ = _tmp1_;
	if (_tmp26_) {
		const gchar* _tmp27_;
		const gchar* _tmp28_;
		_tmp27_ = folks_postal_address_get_address_format (self);
		_tmp28_ = _tmp27_;
		_tmp0_ = g_strcmp0 (_tmp28_, "") == 0;
	} else {
		_tmp0_ = FALSE;
	}
	_tmp29_ = _tmp0_;
...
gboolean folks_postal_address_equal (FolksPostalAddress* self, FolksPostalAddress* with) {
	...
	if (_tmp17_) {
		...
		const gchar* _tmp21_;
		const gchar* _tmp22_;
		_tmp18_ = folks_postal_address_get_street (self);
		_tmp19_ = _tmp18_;
		_tmp20_ = with;
		_tmp21_ = folks_postal_address_get_street (_tmp20_);
		_tmp22_ = _tmp21_;
		_tmp5_ = g_strcmp0 (_tmp19_, _tmp22_) != 0;
	}
	_tmp23_ = _tmp5_;
	if (_tmp23_) {
		_tmp4_ = TRUE;
		...
		const gchar* _tmp27_;
		const gchar* _tmp28_;
		_tmp24_ = folks_postal_address_get_locality (self);
		_tmp25_ = _tmp24_;
		_tmp26_ = with;
		_tmp27_ = folks_postal_address_get_locality (_tmp26_);
		_tmp28_ = _tmp27_;
		_tmp4_ = g_strcmp0 (_tmp25_, _tmp28_) != 0;
	}
	_tmp29_ = _tmp4_;
	if (_tmp29_) {
		_tmp3_ = TRUE;
		...
		const gchar* _tmp33_;
		const gchar* _tmp34_;
		_tmp30_ = folks_postal_address_get_region (self);
		_tmp31_ = _tmp30_;
		_tmp32_ = with;
		_tmp33_ = folks_postal_address_get_region (_tmp32_);
		_tmp34_ = _tmp33_;
		_tmp3_ = g_strcmp0 (_tmp31_, _tmp34_) != 0;
	}
	_tmp35_ = _tmp3_;
	if (_tmp35_) {
		_tmp2_ = TRUE;
		...
		const gchar* _tmp39_;
		const gchar* _tmp40_;
		_tmp36_ = folks_postal_address_get_postal_code (self);
		_tmp37_ = _tmp36_;
		_tmp38_ = with;
		_tmp39_ = folks_postal_address_get_postal_code (_tmp38_);
		_tmp40_ = _tmp39_;
		_tmp2_ = g_strcmp0 (_tmp37_, _tmp40_) != 0;
	}
	_tmp41_ = _tmp2_;
	if (_tmp41_) {
		_tmp1_ = TRUE;
		...
		const gchar* _tmp45_;
		const gchar* _tmp46_;
		_tmp42_ = folks_postal_address_get_country (self);
		_tmp43_ = _tmp42_;
		_tmp44_ = with;
		_tmp45_ = folks_postal_address_get_country (_tmp44_);
		_tmp46_ = _tmp45_;
		_tmp1_ = g_strcmp0 (_tmp43_, _tmp46_) != 0;
	}
	_tmp47_ = _tmp1_;
	if (_tmp47_) {
		_tmp0_ = TRUE;
		...
		const gchar* _tmp51_;
		const gchar* _tmp52_;
		_tmp48_ = folks_postal_address_get_address_format (self);
		_tmp49_ = _tmp48_;
		_tmp50_ = with;
		_tmp51_ = folks_postal_address_get_address_format (_tmp50_);
		_tmp52_ = _tmp51_;
		_tmp0_ = g_strcmp0 (_tmp49_, _tmp52_) != 0;
	}
	_tmp53_ = _tmp0_;
	if (_tmp53_) {
		result = FALSE;
...
static void folks_postal_address_field_details_real_set_id (FolksAbstractFieldDetails* base, const gchar* value) {
	...
	if (g_strcmp0 (_tmp5_, _tmp9_) != 0) {
		...
		const gchar* _tmp12_;
		_tmp10_ = folks_abstract_field_details_get_value ((FolksAbstractFieldDetails*) self);
		_tmp11_ = _tmp10_;
		_tmp12_ = self->priv->_id;
		folks_postal_address_set_uid ((FolksPostalAddress*) _tmp11_, _tmp12_);
	}
...
static void __folks_postal_address_field_details___lambda30__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_folks_postal_address_field_details___lambda30_ (self, _sender, pspec);
}
...
static GObject * folks_postal_address_field_details_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_tmp1_ = _tmp0_;
	g_signal_connect_object ((GObject*) ((FolksPostalAddress*) _tmp1_), "notify::uid", (GCallback) __folks_postal_address_field_details___lambda30__g_object_notify, self, 0);
	return obj;
}
