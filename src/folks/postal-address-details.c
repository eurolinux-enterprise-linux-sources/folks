/* postal-address-details.c generated by valac 0.27.1.3-6129, the Vala compiler
...
static void _folks_postal_address_field_details___lambda8_ (FolksPostalAddressFieldDetails* self, GObject* s, GParamSpec* p);
...
static void __folks_postal_address_field_details___lambda8__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
...
static void __folks_postal_address_field_details___lambda8__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_folks_postal_address_field_details___lambda8_ ((FolksPostalAddressFieldDetails*) self, _sender, pspec);
}
...
static GObject * folks_postal_address_field_details_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_tmp1_ = _tmp0_;
	g_signal_connect_object ((GObject*) ((FolksPostalAddress*) _tmp1_), "notify::uid", (GCallback) __folks_postal_address_field_details___lambda8__g_object_notify, self, 0);
	return obj;
}
