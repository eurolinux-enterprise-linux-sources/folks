/* avatar-cache.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static GRecMutex __lock_folks_avatar_cache__instance = {0};
...
FolksAvatarCache* folks_avatar_cache_dup (void) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		g_rec_mutex_lock (&__lock_folks_avatar_cache__instance);
		{
			...
			_g_object_unref0 (_retval);
			{
				...
				g_rec_mutex_unlock (&__lock_folks_avatar_cache__instance);
			}
			return result;
		}
		__finally39:
...
static gboolean folks_avatar_cache_load_avatar_co (FolksAvatarCacheLoadAvatarData* _data_) {
	...
	g_debug ("avatar-cache.vala:130: Loading avatar '%s' from file '%s'.", _data_->_tmp2_, _data_->_tmp5_);
...
static gboolean _folks_avatar_cache_store_avatar_unlimited_co (FolksAvatarCacheStoreAvatarUnlimitedData* _data_) {
	...
	_data_->_tmp5_ = NULL;
	_data_->_tmp5_ = _data_->_tmp4_;
	g_debug ("avatar-cache.vala:201: Storing avatar '%s' in file '%s'.", _data_->_tmp2_, _data_->_tmp5_);
	_g_free0 (_data_->_tmp5_);
	_data_->_tmp6_ = NULL;
...
static gboolean folks_avatar_cache_remove_avatar_co (FolksAvatarCacheRemoveAvatarData* _data_) {
	...
	_data_->_tmp5_ = NULL;
	_data_->_tmp5_ = _data_->_tmp4_;
	g_debug ("avatar-cache.vala:264: Removing avatar '%s' in file '%s'.", _data_->_tmp2_, _data_->_tmp5_);
	_g_free0 (_data_->_tmp5_);
	{
		_data_->_tmp6_ = NULL;
		_data_->_tmp6_ = _data_->avatar_file;
...
static void folks_avatar_cache_class_init (FolksAvatarCacheClass * klass) {
	...
	g_rec_mutex_init (&__lock_folks_avatar_cache__instance);
}
