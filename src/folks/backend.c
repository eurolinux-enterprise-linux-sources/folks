...
static void folks_backend_class_init (FolksBackendClass * klass) {
	...
	((FolksBackendClass *) klass)->disable_persona_store = folks_backend_real_disable_persona_store;
	((FolksBackendClass *) klass)->enable_persona_store = folks_backend_real_enable_persona_store;
	((FolksBackendClass *) klass)->set_persona_stores = folks_backend_real_set_persona_stores;
