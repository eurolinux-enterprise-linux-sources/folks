/* alias-details.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static void folks_alias_details_real_change_alias (FolksAliasDetails* self, const gchar* alias, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FolksAliasDetailsChangeAliasData* _data_;
	FolksAliasDetails* _tmp0_ = NULL;
	const gchar* _tmp1_ = NULL;
	gchar* _tmp2_ = NULL;
	_data_ = g_slice_new0 (FolksAliasDetailsChangeAliasData);
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, folks_alias_details_real_change_alias);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, folks_alias_details_real_change_alias_data_free);
...
static gboolean folks_alias_details_real_change_alias_co (FolksAliasDetailsChangeAliasData* _data_) {
	...
	_state_0:
	_data_->_tmp0_ = NULL;
	_data_->_tmp0_ = _ ("Alias is not writeable on this contact.");
	_data_->_tmp1_ = NULL;
