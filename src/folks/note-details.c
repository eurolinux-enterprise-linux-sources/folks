/* note-details.c generated by valac 0.20.1.30-1b1d, the Vala compiler
...
static void folks_note_field_details_class_init (FolksNoteFieldDetailsClass * klass) {
	...
	FOLKS_ABSTRACT_FIELD_DETAILS_CLASS (klass)->equal = folks_note_field_details_real_equal;
	FOLKS_ABSTRACT_FIELD_DETAILS_CLASS (klass)->hash = folks_note_field_details_real_hash;
