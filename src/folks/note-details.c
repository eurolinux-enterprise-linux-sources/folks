/* note-details.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
FolksNoteFieldDetails* folks_note_field_details_construct (GType object_type, const gchar* value, GeeMultiMap* parameters, const gchar* uid) {
	...
	_tmp2_ = uid;
	_tmp3_ = parameters;
	self = (FolksNoteFieldDetails*) g_object_new (object_type, "t_type", G_TYPE_STRING, "t_dup_func", (GBoxedCopyFunc) g_strdup, "t_destroy_func", g_free, "value", _tmp1_, "id", _tmp2_, "parameters", _tmp3_, NULL);
	return self;
}
...
static void folks_note_field_details_class_init (FolksNoteFieldDetailsClass * klass) {
	...
	((FolksAbstractFieldDetailsClass *) klass)->equal = folks_note_field_details_real_equal;
	((FolksAbstractFieldDetailsClass *) klass)->hash = folks_note_field_details_real_hash;
	...
	/**
	   * {@inheritDoc}
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_NOTE_FIELD_DETAILS_ID, g_param_spec_string ("id", "id", "id", NULL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE));
	/**
	   * The UID of the note (if any).
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_NOTE_FIELD_DETAILS_UID, g_param_spec_string ("uid", "uid", "uid", NULL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
static void folks_note_details_real_change_notes (FolksNoteDetails* self, GeeSet* notes, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FolksNoteDetailsChangeNotesData* _data_;
	FolksNoteDetails* _tmp0_ = NULL;
	GeeSet* _tmp1_ = NULL;
	GeeSet* _tmp2_ = NULL;
	_data_ = g_slice_new0 (FolksNoteDetailsChangeNotesData);
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, folks_note_details_real_change_notes);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, folks_note_details_real_change_notes_data_free);
...
static gboolean folks_note_details_real_change_notes_co (FolksNoteDetailsChangeNotesData* _data_) {
	...
	_state_0:
	_data_->_tmp0_ = NULL;
	_data_->_tmp0_ = _ ("Notes are not writeable on this contact.");
	_data_->_tmp1_ = NULL;
