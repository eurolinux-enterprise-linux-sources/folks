...
"eted.", _data_->_tmp16_);
	...
	if (_data_->_tmp29_ == NULL) {
		...
		g_warning ("Cache file '%s' was version %u of the object file " "format, which is not supported. The file was deleted.", _data_->_tmp30_, _data_->_tmp31_, FOLKS_OBJECT_CACHE__FILE_FORMAT_VERSION);
		_data_->_state_ = 4;
		folks_object_cache_clear_cache (_data_->self, folks_object_cache_load_objects_ready, _data_);
		return FALSE;
		_state_4:
	...
	_data_->_tmp37_ = (_data_->_tmp36_ != NULL) ? _vala_array_dup1 (_data_->_tmp36_, _data_->_tmp36__length1) : ((gpointer) _data_->_tmp36_);
	...
	if (_data_->_tmp40_ == FALSE) {
		...
		g_warning ("object-cache.vala:273: Cache file '%s' was corrupt and was deleted.", _data_->_tmp41_);
		_data_->_state_ = 5;
		folks_object_cache_clear_cache (_data_->self, folks_object_cache_load_objects_ready, _data_);
		return FALSE;
		_state_5:
		...
		_data_->i = (guint) 0;
		{
			...
			while (TRUE) {
				...
				if (!_data_->_tmp68_) {
					...
					_data_->i = _data_->_tmp69_ + 1;
				}
				_data_->_tmp67_ = FALSE;
				_data_->_tmp70_ = _data_->i;
				_data_->_tmp71_ = _data_->objects_variant;
				_data_->_tmp72_ = 0UL;
				_data_->_tmp72_ = g_variant_n_children (_data_->_tmp71_);
				if (!(((gsize) _data_->_tmp70_) < _data_->_tmp72_)) {
					break;
				}
				_data_->_tmp73_ = _data_->objects_variant;
				_data_->_tmp74_ = _data_->i;
				_data_->_tmp75_ = NULL;
				_data_->_tmp75_ = g_variant_get_child_value (_data_->_tmp73_, (gsize) _data_->_tmp74_);
				_data_->object_variant = _data_->_tmp75_;
				_data_->_tmp76_ = _data_->object_variant;
				_data_->_tmp77_ = _data_->object_version;
				_data_->_tmp78_ = NULL;
				_data_->_tmp78_ = folks_object_cache_deserialise_object (_data_->self, _data_->_tmp76_, _data_->_tmp77_);
				_data_->object = _data_->_tmp78_;
				_data_->_tmp79_ = _data_->objects;
				_data_->_tmp80_ = _data_->object;
				gee_abstract_collection_add ((GeeAbstractCollection*) _data_->_tmp79_, _data_->_tmp80_);
...
static gboolean folks_object_cache_store_objects_co (FolksObjectCacheStoreObjectsData* _data_) {
	...
	_data_->_tmp1_ = _data_->self->priv->_id;
	_data_->_tmp2_ = _data_->self->priv->_cache_file_path;
	g_debug ("object-cache.vala:341: Storing cache (type ID '%s', ID '%s') to file '" \
"%s'.", _data_->_tmp0_, _data_->_tmp1_, _data_->_tmp2_);
	_data_->_tmp3_ = G_MAXUINT8;
	_data_->_tmp4_ = NULL;
	_data_->_tmp4_ = folks_object_cache_get_serialised_object_type (_data_->self, _data_->_tmp3_);
	_data_->child_type = _data_->_tmp4_;
	_data_->_tmp5_ = _data_->child_type;
	_vala_assert (_data_->_tmp5_ != NULL, "child_type != null");
	...
	_data_->_tmp24_ = _data_->self->priv->_id;
	_data_->_tmp25_ = g_variant_new_string (_data_->_tmp24_);
	g_variant_ref_sink (_data_->_tmp25_);
	_data_->_tmp26_ = _data_->child_type;
	_data_->_tmp27_ = _data_->children;
	_data_->_tmp27__length1 = _data_->children_length1;
	_data_->_tmp28_ = g_variant_new_array (_data_->_tmp26_, _data_->_tmp27_, _data_->_tmp27__length1);
	g_variant_ref_sink (_data_->_tmp28_);
	_data_->_tmp29_ = NULL;
	_data_->_tmp29_ = g_new0 (GVariant*, 3 + 1);
	_data_->_tmp29_[0] = _data_->_tmp23_;
	_data_->_tmp29_[1] = _data_->_tmp25_;
	_data_->_tmp29_[2] = _data_->_tmp28_;
	_data_->_tmp30_ = _data_->_tmp29_;
	_data_->_tmp30__length1 = 3;
	_data_->_tmp31_ = g_variant_new_tuple (_data_->_tmp30_, 3);
	g_variant_ref_sink (_data_->_tmp31_);
	_data_->_tmp32_ = _data_->_tmp31_;
	_data_->_tmp30_ = (_vala_array_free (_data_->_tmp30_, _data_->_tmp30__length1, (GDestroyNotify) g_variant_unref), NULL);
	_data_->variant = _data_->_tmp32_;
	_data_->_tmp33_ = _data_->wrapper_version;
	_data_->_tmp34_ = _data_->object_version;
	_data_->_tmp35_ = NULL;
	_data_->_tmp35_ = _folks_object_cache_get_cache_file_variant_type (_data_->self, _data_->_tmp33_, _data_->_tmp34_);
	_data_->desired_variant_type = _data_->_tmp35_;
	_data_->_tmp37_ = _data_->desired_variant_type;
	if (_data_->_tmp37_ != NULL) {
		_data_->_tmp38_ = _data_->variant;
		_data_->_tmp39_ = NULL;
		_data_->_tmp39_ = g_variant_get_type (_data_->_tmp38_);
		_data_->_tmp40_ = _data_->desired_variant_type;
		_data_->_tmp41_ = FALSE;
		_data_->_tmp41_ = g_variant_type_equal (_data_->_tmp39_, (const GVariantType*) _data_->_tmp40_);
		_data_->_tmp36_ = _data_->_tmp41_;
	} else {
		_data_->_tmp36_ = FALSE;
	}
	_data_->_tmp42_ = _data_->_tmp36_;
	_vala_assert (_data_->_tmp42_, "desired_variant_type != null &&           variant.get_type ().equal ((!) desired_variant_type)");
	_data_->_tmp43_ = _data_->variant;
	_data_->_tmp44_ = 0UL;
	_data_->_tmp44_ = g_variant_get_size (_data_->_tmp43_);
	_data_->_tmp45_ = NULL;
	_data_->_tmp45_ = g_new0 (guint8, FOLKS_OBJECT_CACHE__HEADER_WIDTH + _data_->_tmp44_);
	_data_->data = _data_->_tmp45_;
	_data_->data_length1 = FOLKS_OBJECT_CACHE__HEADER_WIDTH + _data_->_tmp44_;
	_data_->_data_size_ = _data_->data_length1;
	_data_->_tmp46_ = _data_->data;
	_data_->_tmp46__length1 = _data_->data_length1;
	_data_->_tmp47_ = _data_->wrapper_version;
	_data_->_tmp46_[0] = _data_->_tmp47_;
	_data_->_tmp48_ = _data_->_tmp46_[0];
	_data_->_tmp49_ = _data_->data;
	_data_->_tmp49__length1 = _data_->data_length1;
	_data_->_tmp50_ = _data_->object_version;
	_data_->_tmp49_[1] = _data_->_tmp50_;
	_data_->_tmp51_ = _data_->_tmp49_[1];
	_data_->_tmp52_ = _data_->variant;
	_data_->_tmp53_ = _data_->data;
	_data_->_tmp53__length1 = _data_->data_length1;
	_data_->_tmp54_ = _data_->data;
	_data_->_tmp54__length1 = _data_->data_length1;
	g_variant_store (_data_->_tmp52_, _data_->_tmp53_ + ((gint) FOLKS_OBJECT_CACHE__HEADER_WIDTH));
	while (TRUE) {
		{
			_data_->_tmp55_ = _data_->self->priv->_cache_file;
			_data_->_tmp56_ = _data_->data;
			_data_->_tmp56__length1 = _data_->data_length1;
			_data_->_tmp57_ = _data_->cancellable;
			_data_->_state_ = 1;
			g_file_replace_contents_async (_data_->_tmp55_, _data_->_tmp56_, (gsize) _data_->_tmp56__length1, NULL, FALSE, G_FILE_CREATE_PRIVATE, _data_->_tmp57_, folks_object_cache_store_objects_ready, _data_);
			return FALSE;
			_state_1:
			g_file_replace_contents_finish (_data_->_tmp55_, _data_->_res_, NULL, &_data_->_inner_error_);
			if (_data_->_inner_error_ != NULL) {
		...
		__catch38_g_error:
		{
			...
			if (g_error_matches (_data_->_tmp58_, G_IO_ERROR, G_IO_ERROR_NOT_FOUND)) {
				{
					_data_->_state_ = 2;
				...
				__catch39_g_error:
				{
					...
					_data_->_inner_error_ = NULL;
					_data_->_tmp59_ = _data_->self->priv->_cache_directory;
					_data_->_tmp60_ = NULL;
					...
					g_warning ("object-cache.vala:398: Couldn't create cache directory '%s': %s", _data_->_tmp61_, _data_->_tmp63_);
				...
				if (g_error_matches (_data_->_tmp64_, G_IO_ERROR, G_IO_ERROR_CANCELLED)) {
					_g_error_free0 (_data_->e);
					_data_->data = (g_free (_data_->data), NULL);
					_g_variant_type_free0 (_data_->desired_variant_type);
					_g_variant_unref0 (_data_->variant);
			...
			_data_->_tmp65_ = _data_->self->priv->_cache_file_path;
			_data_->_tmp66_ = _data_->e;
			_data_->_tmp67_ = _data_->_tmp66_->message;
			g_warning ("object-cache.vala:412: Couldn't write to cache file '%s', so deleting " \
"it: %s", _data_->_tmp65_, _data_->_tmp67_);
			_data_->_state_ = 3;
...
static gboolean folks_object_cache_clear_cache_co (FolksObjectCacheClearCacheData* _data_) {
	...
	_data_->_tmp1_ = _data_->self->priv->_id;
	_data_->_tmp2_ = _data_->self->priv->_cache_file_path;
	g_debug ("object-cache.vala:428: Clearing cache (type ID '%s', ID '%s'); deletin" \
...
"'%s'.", _tmp0_, _tmp2_);
	...
	self->priv->_cache_file_path = _tmp22_;
	_g_free0 (path);
	return obj;
}
