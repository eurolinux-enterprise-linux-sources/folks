/* individual-aggregator.c generated by valac 0.36.1.697-2b74, the Vala compiler
...
enum  {
	...
	FOLKS_INDIVIDUAL_AGGREGATOR_LAST_PROPERTY
};
static GParamSpec* folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_LAST_PROPERTY];
...
enum  {
	...
	FOLKS_INDIVIDUAL_AGGREGATOR_LAST_SIGNAL
};
static guint folks_individual_aggregator_signals[FOLKS_INDIVIDUAL_AGGREGATOR_LAST_SIGNAL] = {0};
...
struct _FolksIndividualAggregatorLinkPersonasData {
	...
	FolksAntiLinkable* _tmp26_;
	FolksAntiLinkable* _tmp27_;
	FolksAntiLinkable* _tmp28_;
	GeeSet* _tmp29_;
	GError* e;
	GError* _tmp30_;
...
FolksIndividualAggregator* folks_individual_aggregator_construct_with_backend_store (GType object_type, FolksBackendStore* store) G_GNUC_DEPRECATED;
...
static void folks_individual_aggregator_prepare_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_unprepare_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_add_persona_from_details_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_remove_individual_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_remove_persona_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_link_personas_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_unlink_individual_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_ensure_individual_property_writeable_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void _folks_individual_aggregator_ensure_personas_property_writeable_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
static void folks_individual_aggregator_look_up_individual_async_ready_wrapper (GObject *source_object, GAsyncResult *res, void *user_data);
...
FolksIndividualAggregator* folks_individual_aggregator_dup_with_backend_store (FolksBackendStore* store) {
	...
	if (_tmp2_ == NULL) {
		...
		FolksIndividualAggregator* _tmp5_;
		_tmp3_ = store;
		_tmp4_ = folks_individual_aggregator_new_with_backend_store (_tmp3_);
		_g_object_unref0 (retval);
		retval = _tmp4_;
		_tmp5_ = retval;
		...
		_tmp6_ = _retval;
		_tmp7_ = _tmp6_->priv->_backend_store;
		_tmp8_ = store;
		if (_tmp7_ != _tmp8_) {
...
"ther backend store");
			...
			_tmp9_ = _retval;
			_tmp10_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp9_, FOLKS_TYPE_INDIVIDUAL_AGGREGATOR, FolksIndividualAggregator));
			_g_object_unref0 (retval);
			retval = _tmp10_;
		}
	}
...
static void _folks_individual_aggregator_configure_primary_store (FolksIndividualAggregator* self, const gchar* store_config_ids) {
	...
	g_debug ("individual-aggregator.vala:557: _configure_primary_store to '%s'", _tmp0_);
	...
	{
		{
			...
			while (TRUE) {
				...
				_data_->p = (FolksPersonaStore*) _data_->_tmp12_;
				_data_->_tmp13_ = _data_->p;
				_data_->_state_ = 1;
				folks_persona_store_flush (_data_->_tmp13_, folks_individual_aggregator_unprepare_ready, _data_);
				return FALSE;
				_state_1:
				folks_persona_store_flush_finish (_data_->_tmp13_, _data_->_res_);
				...
				}
				{
					...
					f = _tmp27_ + 1;
					{
						...
						while (TRUE) {
							...
							FolksMatchResult _tmp50_;
							FolksMatchResult _tmp51_;
							if (!_tmp28_) {
								gint _tmp29_;
								_tmp29_ = f;
								f = _tmp29_ + 1;
							...
							if (_tmp50_ >= _tmp51_) {
								GeeHashMap* _tmp52_;
								FolksIndividual* _tmp53_;
								FolksMatchResult _tmp54_;
								GeeHashMap* _tmp55_;
								FolksIndividual* _tmp56_;
								FolksMatchResult _tmp57_;
								_tmp52_ = matches_a;
								_tmp53_ = b;
								_tmp54_ = _result_;
...
static void _folks_individual_aggregator_set_primary_store (FolksIndividualAggregator* self, FolksPersonaStore* store) {
	...
	g_debug ("individual-aggregator.vala:945: _set_primary_store()");
	...
	if (g_strcmp0 (_tmp4_, _tmp5_) == 0) {
		...
		if (_tmp6_) {
			...
			_tmp22_ = _tmp21_;
			g_debug ("individual-aggregator.vala:962: Setting primary store to %p (type ID: " \
...
static void __lambda69_ (Block4Data* _data4_, GObject* obj, GAsyncResult* _result_) {
	...
	__catch19_g_error:
	{
		...
		e = _inner_error_;
		_inner_error_ = NULL;
		_tmp2_ = _data4_->store_id;
		_tmp3_ = e;
		_tmp4_ = _tmp3_->message;
		g_warning (_ ("Error preparing persona store ‘%s’: %s"), _tmp2_, _tmp4_);
		_g_error_free0 (e);
	}
	__finally19:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static void _folks_individual_aggregator_backend_persona_store_added_cb (FolksIndividualAggregator* self, FolksBackend* backend, FolksPersonaStore* store) {
	...
	g_debug ("individual-aggregator.vala:987: _backend_persona_store_added_cb(): bac" \
"kend: %s, store: %s (%p)", _tmp4_, _tmp7_, _tmp8_);
	...
	if (_tmp35_ > 0) {
		...
		_tmp36_ = gee_hash_set_new (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
		persona_set = _tmp36_;
		{
		...
		_tmp52_ = persona_set;
		_tmp53_ = folks_small_set_empty (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref);
		_tmp54_ = _tmp53_;
...
static void _folks_individual_aggregator_backend_persona_store_removed_cb (FolksIndividualAggregator* self, FolksBackend* backend, FolksPersonaStore* store) {
	...
	_tmp17_ = gee_hash_set_new (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
	...
	_tmp28_ = store;
	_tmp29_ = folks_small_set_empty (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref);
	_tmp30_ = _tmp29_;
...
static void _folks_individual_aggregator_emit_individuals_changed (FolksIndividualAggregator* self, GeeSet* added, GeeSet* removed, GeeMultiMap* changes, const gchar* message, FolksPersona* actor, FolksGroupDetailsChangeReason reason) {
	...
	FolksGroupDetailsChangeReason _tmp95_;
	GeeMultiMap* _tmp96_;
	g_return_if_fail (self != NULL);
	_tmp3_ = added;
	if (_tmp3_ == NULL) {
	...
	if (_tmp18_ != NULL) {
		...
		_tmp21_ = folks_small_set_empty (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref);
		_g_object_unref0 (_tmp17_);
	...
	if (_tmp24_ != NULL) {
		...
		_tmp27_ = folks_small_set_empty (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref);
		_g_object_unref0 (_tmp23_);
	...
	if (_tmp29_ != NULL) {
		...
		_tmp32_ = gee_hash_multi_map_new (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
		_g_object_unref0 (_changes);
	...
	if (_tmp35_ == TRUE) {
		...
		_tmp38_ = _tmp37_;
		g_debug ("individual-aggregator.vala:1150: Emitting individuals-changed-detailed" \
" with %u mappings:", (guint) _tmp38_);
		...
		while (TRUE) {
			...
			_tmp57_ = removed_ind;
			_tmp58_ = added_ind;
			g_debug ("individual-aggregator.vala:1160:     %s (%p) → %s (%p)", _tmp47_, _tmp57_, _tmp52_, _tmp58_);
			_tmp59_ = removed_ind;
			if (_tmp59_ != NULL) {
				g_debug ("individual-aggregator.vala:1167:       Removed individual's personas:");
				{
					GeeIterator* _p_it = NULL;
					...
					while (TRUE) {
						...
						_tmp70_ = _tmp69_;
						_tmp71_ = p;
						g_debug ("individual-aggregator.vala:1171:         %s (%p)", _tmp70_, _tmp71_);
						_g_object_unref0 (p);
					}
					_g_object_unref0 (_p_it);
				}
			...
			_tmp72_ = added_ind;
			if (_tmp72_ != NULL) {
				g_debug ("individual-aggregator.vala:1177:       Added individual's personas:");
				{
					GeeIterator* _p_it = NULL;
					...
					while (TRUE) {
						...
						_tmp83_ = _tmp82_;
						_tmp84_ = p;
						g_debug ("individual-aggregator.vala:1181:         %s (%p)", _tmp83_, _tmp84_);
						_g_object_unref0 (p);
					}
					_g_object_unref0 (_p_it);
				}
	...
	_tmp94_ = actor;
	_tmp95_ = reason;
	g_signal_emit (self, folks_individual_aggregator_signals[FOLKS_INDIVIDUAL_AGGREGATOR_INDIVIDUALS_CHANGED_SIGNAL], 0, _tmp88_, _tmp92_, _tmp93_, _tmp94_, _tmp95_);
	_g_object_unref0 (_tmp92_);
	_g_object_unref0 (_tmp88_);
	_tmp96_ = _changes;
	g_signal_emit (self, folks_individual_aggregator_signals[FOLKS_INDIVIDUAL_AGGREGATOR_INDIVIDUALS_CHANGED_DETAILED_SIGNAL], 0, _tmp96_);
	_g_object_unref0 (_tmp23_);
	_g_object_unref0 (_tmp17_);
	_g_object_unref0 (_changes);
	_g_object_unref0 (_removed);
...
static void _folks_individual_aggregator_add_personas (FolksIndividualAggregator* self, GeeSet* added, FolksIndividual* * user, GeeHashMultiMap* * individuals_changes) {
	...
	g_return_if_fail (*individuals_changes != NULL);
	{
		...
		while (TRUE) {
			...
			_tmp10_ = _tmp9_;
			trust_level = _tmp10_;
			_tmp11_ = gee_hash_set_new (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
			...
			_tmp18_ = _tmp17_;
			g_debug ("individual-aggregator.vala:1223: Aggregating persona '%s' on '%s'.", _tmp15_, _tmp18_);
			...
			if (_tmp19_) {
				...
				_tmp32_ = _tmp31_;
				g_debug ("individual-aggregator.vala:1231:     Found candidate individual '%s' a" \
"s user.", _tmp32_);
			...
			if (_tmp36_ == TRUE) {
				FolksPersonaStoreTrust _tmp37_;
				_tmp37_ = trust_level;
			...
			if (_tmp72_ == TRUE) {
				...
				FolksPersonaStoreTrust _tmp77_;
				...
				_tmp80__length1 = _tmp79__length1;
				{
					...
					for (foo_it = 0; foo_it < _tmp80__length1; foo_it = foo_it + 1) {
						...
						foo = foo_collection[foo_it];
						{
							...
							FolksPersona* _tmp83_;
							GObjectClass* _tmp84_;
							GObjectClass* _tmp85_;
							const gchar* _tmp86_;
							GParamSpec* _tmp87_;
							FolksPersona* _tmp89_;
							const gchar* _tmp90_;
							...
							if (_tmp87_ == NULL) {
								const gchar* _tmp88_;
								_tmp88_ = _data6_->prop_name;
								g_warning (_ ("Unknown property ‘%s’ in linkable property list."), _tmp88_);
								block6_data_unref (_data6_);
								_data6_ = NULL;
								continue;
							}
							_tmp89_ = _data5_->persona;
							_tmp90_ = _data6_->prop_name;
							folks_persona_linkable_property_to_links (_tmp89_, _tmp90_, ________lambda67__folks_persona_linkable_property_callback, _data6_);
							block6_data_unref (_data6_);
							_data6_ = NULL;
						}
					}
			...
			if (_tmp94_ == TRUE) {
				...
				gint _tmp96_;
				gint _tmp97_;
				_tmp95_ = _data5_->candidate_inds;
				_tmp96_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) _tmp95_);
				_tmp97_ = _tmp96_;
				_tmp93_ = _tmp97_ == 0;
			}
			_vala_assert (_tmp93_, "this._linking_enabled == true || candidate_inds.size == 0");
			_tmp99_ = _data5_->candidate_inds;
			_tmp100_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) _tmp99_);
			_tmp101_ = _tmp100_;
			if (_tmp101_ > 0) {
				gboolean _tmp102_;
				_tmp102_ = self->priv->_linking_enabled;
				_tmp98_ = _tmp102_ == TRUE;
			} else {
				_tmp98_ = FALSE;
			}
			if (_tmp98_) {
				{
					...
					_tmp103_ = _data5_->candidate_inds;
					...
					while (TRUE) {
						...
						_tmp109_ = final_personas;
						_tmp110_ = individual;
						_tmp111_ = folks_individual_get_personas (_tmp110_);
						_tmp112_ = _tmp111_;
						gee_collection_add_all ((GeeCollection*) _tmp109_, (GeeCollection*) _tmp112_);
						_g_object_unref0 (individual);
					}
					_g_object_unref0 (_individual_it);
				}
				...
				gboolean _tmp113_;
				_tmp113_ = self->priv->_linking_enabled;
				if (!_tmp113_) {
					g_debug ("individual-aggregator.vala:1335:     Linking disabled.");
				} else {
					g_debug ("individual-aggregator.vala:1339:     Did not find any candidate indivi" \
"duals.");
				}
			}
			_tmp114_ = final_personas;
			_tmp115_ = folks_individual_new ((GeeSet*) _tmp114_);
			final_individual = _tmp115_;
			_tmp116_ = final_individual;
			_tmp117_ = folks_individual_get_id (_tmp116_);
			_tmp118_ = _tmp117_;
			_tmp119_ = final_individual;
			g_debug ("individual-aggregator.vala:1344:     Created new individual '%s' (%p) " \
"with personas:", _tmp118_, _tmp119_);
			{
				GeeIterator* _p_it = NULL;
				GeeHashSet* _tmp120_;
				GeeIterator* _tmp121_;
				_tmp120_ = final_personas;
				_tmp121_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _tmp120_);
				_p_it = _tmp121_;
				while (TRUE) {
					...
					p = (FolksPersona*) _tmp125_;
					_tmp126_ = p;
					_tmp127_ = folks_persona_get_uid (_tmp126_);
					_tmp128_ = _tmp127_;
					_tmp129_ = p;
					g_debug ("individual-aggregator.vala:1348:         %s (%p)", _tmp128_, _tmp129_);
					_tmp130_ = p;
					_tmp131_ = final_individual;
					_folks_individual_aggregator_add_persona_to_link_map (self, _tmp130_, _tmp131_);
					_g_object_unref0 (p);
				}
				_g_object_unref0 (_p_it);
			}
			num_mappings_added = (guint) 0;
			{
				...
				_tmp132_ = _data5_->candidate_inds;
				_tmp133_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _tmp132_);
				_i_it = _tmp133_;
				while (TRUE) {
					...
					GeeHashSet* _tmp139_;
					GeeMapIterator* iter = NULL;
					GeeHashMultiMap* _tmp140_;
					GeeMapIterator* _tmp141_;
					GeeHashSet* _tmp168_;
					gint _tmp169_;
					gint _tmp170_;
					_tmp134_ = _i_it;
					...
					i = (FolksIndividual*) _tmp137_;
					_tmp138_ = i;
					_folks_individual_aggregator_remove_individual_from_link_map (self, _tmp138_);
					_tmp139_ = gee_hash_set_new (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
					transitive_updates = _tmp139_;
					_tmp140_ = *individuals_changes;
					_tmp141_ = gee_multi_map_map_iterator ((GeeMultiMap*) _tmp140_);
					iter = _tmp141_;
					while (TRUE) {
						GeeMapIterator* _tmp142_;
						gboolean _tmp143_;
						FolksIndividual* _tmp144_;
						GeeMapIterator* _tmp145_;
						gpointer _tmp146_;
						FolksIndividual* _tmp147_;
						gboolean _tmp148_;
						_tmp142_ = iter;
						_tmp143_ = gee_map_iterator_next (_tmp142_);
						if (!_tmp143_) {
							break;
						}
						_tmp144_ = i;
						...
						_tmp147_ = (FolksIndividual*) _tmp146_;
						_tmp148_ = _tmp144_ == _tmp147_;
						...
						if (_tmp148_) {
							...
							_tmp149_ = transitive_updates;
							_tmp150_ = iter;
							_tmp151_ = gee_map_iterator_get_key (_tmp150_);
							_tmp152_ = (FolksIndividual*) _tmp151_;
							gee_abstract_collection_add ((GeeAbstractCollection*) _tmp149_, _tmp152_);
					...
					}
					{
						...
						_tmp154_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _tmp153_);
						_k_it = _tmp154_;
						while (TRUE) {
							...
							k = (FolksIndividual*) _tmp158_;
							_tmp159_ = *individuals_changes;
							_tmp160_ = k;
							_tmp161_ = i;
							_tmp162_ = gee_multi_map_remove ((GeeMultiMap*) _tmp159_, _tmp160_, _tmp161_);
							_vala_assert (_tmp162_ == TRUE, "individuals_changes.remove (k, i) == true");
							_tmp163_ = k;
							if (_tmp163_ != NULL) {
								GeeHashMultiMap* _tmp164_;
								FolksIndividual* _tmp165_;
								FolksIndividual* _tmp166_;
								guint _tmp167_;
								_tmp164_ = *individuals_changes;
								_tmp165_ = k;
								_tmp166_ = final_individual;
								gee_multi_map_set ((GeeMultiMap*) _tmp164_, _tmp165_, _tmp166_);
								_tmp167_ = num_mappings_added;
								num_mappings_added = _tmp167_ + 1;
							}
							_g_object_unref0 (k);
						}
						_g_object_unref0 (_k_it);
					}
					_tmp168_ = transitive_updates;
					_tmp169_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) _tmp168_);
					_tmp170_ = _tmp169_;
					if (_tmp170_ == 0) {
						GeeHashMultiMap* _tmp171_;
						FolksIndividual* _tmp172_;
						FolksIndividual* _tmp173_;
						guint _tmp174_;
						_tmp171_ = *individuals_changes;
						_tmp172_ = i;
						_tmp173_ = final_individual;
						gee_multi_map_set ((GeeMultiMap*) _tmp171_, _tmp172_, _tmp173_);
						_tmp174_ = num_mappings_added;
						num_mappings_added = _tmp174_ + 1;
					}
					_g_object_unref0 (iter);
			...
			if (_tmp175_ == ((guint) 0)) {
				GeeHashMultiMap* _tmp176_;
				FolksIndividual* _tmp177_;
				_tmp176_ = *individuals_changes;
				_tmp177_ = final_individual;
				gee_multi_map_set ((GeeMultiMap*) _tmp176_, NULL, _tmp177_);
			}
			_tmp178_ = final_individual;
			_tmp179_ = folks_individual_get_is_user (_tmp178_);
			_tmp180_ = _tmp179_;
			if (_tmp180_ == TRUE) {
				FolksIndividual* _tmp181_;
				FolksIndividual* _tmp182_;
				_tmp181_ = final_individual;
...
static void _folks_individual_aggregator_persona_linkable_property_changed_cb (FolksIndividualAggregator* self, GObject* obj, GParamSpec* pspec) {
	...
	_tmp15_ = folks_small_set_new (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
	persona_set = _tmp15_;
	_tmp16_ = persona_set;
	_tmp17_ = persona;
...
static void _folks_individual_aggregator_persona_anti_links_changed_cb (FolksIndividualAggregator* self, GObject* obj, GParamSpec* pspec) {
	...
	_tmp11_ = _tmp10_;
	g_debug ("individual-aggregator.vala:1448: Anti-links changed for persona '%s' (" \
"is user: %s, IID: %s).", _tmp8_, _tmp2_, _tmp11_);
	_tmp12_ = folks_small_set_new (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
	persona_set = _tmp12_;
	_tmp13_ = persona;
...
static void _____lambda68_ (Block7Data* _data7_, const gchar* l) {
	...
	_tmp0_ = l;
	prop_linking_value = _tmp0_;
	g_debug ("individual-aggregator.vala:1564:             %s", prop_linking_value);
...
static void _folks_individual_aggregator_add_persona_to_link_map (FolksIndividualAggregator* self, FolksPersona* persona, FolksIndividual* individual) {
	...
	_tmp10_ = folks_persona_get_iid (_tmp9_);
	_tmp11_ = _tmp10_;
	g_debug ("individual-aggregator.vala:1525: Connecting to Persona: %s (is user: %" \
"s, IID: %s)", _tmp8_, _tmp2_, _tmp11_);
	_tmp12_ = _data7_->individual;
	_tmp13_ = folks_individual_get_id (_tmp12_);
	_tmp14_ = _tmp13_;
	g_debug ("individual-aggregator.vala:1527:     Mapping to Individual: %s", _tmp14_);
	_tmp15_ = persona;
	...
	if (_tmp23_ == FOLKS_PERSONA_STORE_TRUST_FULL) {
		...
		g_debug ("individual-aggregator.vala:1538:     Inserting links:");
		_tmp24_ = persona;
		...
		_tmp26__length1 = _tmp25__length1;
		{
			...
			for (prop_name_it = 0; prop_name_it < _tmp26__length1; prop_name_it = prop_name_it + 1) {
				...
				prop_name = prop_name_collection[prop_name_it];
				{
					...
					_tmp28_ = prop_name;
					g_debug ("individual-aggregator.vala:1548:         %s", _tmp28_);
					_tmp29_ = persona;
					...
					if (_tmp33_ == NULL) {
						const gchar* _tmp34_;
						_tmp34_ = prop_name;
						g_warning (_ ("Unknown property ‘%s’ in linkable property list."), _tmp34_);
						continue;
					}
					_tmp35_ = persona;
					_tmp36_ = prop_name;
					folks_persona_linkable_property_to_links (_tmp35_, _tmp36_, ______lambda68__folks_persona_linkable_property_callback, _data7_);
				}
			}
		}
	}
...
static void _folks_individual_aggregator_remove_individual_from_link_map (FolksIndividualAggregator* self, FolksIndividual* individual) {
	...
	_tmp2_ = _tmp1_;
	g_debug ("individual-aggregator.vala:1579: Removing Individual '%s' from the lin" \
"k map.", _tmp2_);
			...
			i = (guint) 0;
			{
				...
				while (TRUE) {
					...
					if (((FolksIndividual*) _tmp15_) == _tmp16_) {
						...
						_tmp20_ = _tmp19_;
						_tmp21_ = individual;
						g_debug ("individual-aggregator.vala:1592:     %s → %s (%p)", _tmp17_, _tmp20_, _tmp21_);
						_tmp22_ = inds;
						_tmp23_ = i;
...
static void _folks_individual_aggregator_personas_changed_cb (FolksIndividualAggregator* self, FolksPersonaStore* store, GeeSet* added, GeeSet* removed, const gchar* message, FolksPersona* actor, FolksGroupDetailsChangeReason reason) {
	...
	GeeHashMultiMap* _tmp138_;
	gint _tmp139_;
	gint _tmp140_;
	GeeMapIterator* iter2 = NULL;
	GeeHashMap* _tmp169_;
	GeeMapIterator* _tmp170_;
	FolksDebug* _tmp187_;
	gboolean _tmp188_;
	gboolean _tmp189_;
	g_return_if_fail (self != NULL);
	...
	user = _tmp5_;
	g_debug ("individual-aggregator.vala:1625: Removing Personas:");
	{
		GeeIterator* _persona_it = NULL;
		GeeSet* _tmp6_;
		GeeIterator* _tmp7_;
		...
		while (TRUE) {
			...
			_tmp21_ = _tmp20_;
			g_debug ("individual-aggregator.vala:1629:     %s (is user: %s, IID: %s)", _tmp18_, _tmp12_, _tmp21_);
			_tmp22_ = persona;
	...
	g_debug ("individual-aggregator.vala:1653: Removing Individuals due to removed l" \
"inks:");
	{
		GeeIterator* _individual_it = NULL;
		GeeHashSet* _tmp30_;
		...
		while (TRUE) {
			...
			_tmp43_ = _tmp42_;
			g_debug ("individual-aggregator.vala:1660:     %s", _tmp43_);
			{
				GeeIterator* _persona_it = NULL;
	...
	g_debug ("individual-aggregator.vala:1682: Adding Personas:");
	{
		GeeIterator* _persona_it = NULL;
		GeeSet* _tmp65_;
		GeeIterator* _tmp66_;
		...
		while (TRUE) {
			...
			_tmp80_ = _tmp79_;
			g_debug ("individual-aggregator.vala:1685:     %s (is user: %s, IID: %s)", _tmp77_, _tmp71_, _tmp80_);
			_tmp81_ = persona;
	...
	g_debug ("individual-aggregator.vala:1698: Relinking Personas:");
	{
		GeeIterator* _persona_it = NULL;
		GeeHashSet* _tmp86_;
		GeeIterator* _tmp87_;
		...
		while (TRUE) {
			...
			_tmp101_ = _tmp100_;
			g_debug ("individual-aggregator.vala:1701:     %s (is user: %s, IID: %s)", _tmp98_, _tmp92_, _tmp101_);
			_g_object_unref0 (persona);
		}
		_g_object_unref0 (_persona_it);
	}
	...
	if (_tmp140_ > 0) {
		...
		GeeHashMultiMap* _tmp142_;
		GeeMapIterator* _tmp143_;
		GeeHashSet* _tmp166_;
		GeeHashSet* _tmp167_;
		GeeHashMultiMap* _tmp168_;
		_tmp141_ = gee_hash_set_new (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
		added_individuals = _tmp141_;
		_tmp142_ = individuals_changes;
		_tmp143_ = gee_multi_map_map_iterator ((GeeMultiMap*) _tmp142_);
		iter1 = _tmp143_;
		while (TRUE) {
			GeeMapIterator* _tmp144_;
			gboolean _tmp145_;
	...
	g_debug ("individual-aggregator.vala:1776: Replacing Individuals due to linking:");
	_tmp169_ = replaced_individuals;
	_tmp170_ = gee_abstract_map_map_iterator ((GeeAbstractMap*) _tmp169_);
	iter2 = _tmp170_;
	while (TRUE) {
		GeeMapIterator* _tmp171_;
		gboolean _tmp172_;
		FolksIndividual* old_ind = NULL;
		GeeMapIterator* _tmp173_;
		gpointer _tmp174_;
		FolksIndividual* new_ind = NULL;
		...
		_tmp183_ = _tmp182_;
		_tmp184_ = new_ind;
		g_debug ("individual-aggregator.vala:1783:     %s (%p) → %s (%p)", _tmp179_, _tmp180_, _tmp183_, _tmp184_);
		_tmp185_ = old_ind;
		_tmp186_ = new_ind;
			...
			}
			{
				...
				i = (guint) 0;
				{
					...
					while (TRUE) {
						...
						FolksIndividual* _tmp203_;
						FolksIndividual* _tmp204_;
						GeeMap* _tmp205_;
						FolksIndividual* _tmp206_;
						const gchar* _tmp207_;
						const gchar* _tmp208_;
						gpointer _tmp209_;
						FolksIndividual* _tmp210_;
						...
						if (_tmp212_) {
							...
							_tmp220_ = _tmp219_;
							_tmp221_ = individual;
							g_warning ("individual-aggregator.vala:1809: Individual %s (%p) personas:", _tmp220_, _tmp221_);
							{
								GeeIterator* _p_it = NULL;
								...
								_p_it = _tmp225_;
								while (TRUE) {
									GeeIterator* _tmp226_;
									gboolean _tmp227_;
									FolksPersona* p = NULL;
									GeeIterator* _tmp228_;
									gpointer _tmp229_;
									FolksPersona* _tmp230_;
									...
									_tmp232_ = _tmp231_;
									_tmp233_ = p;
									g_warning ("individual-aggregator.vala:1813:     %s (%p)", _tmp232_, _tmp233_);
									_g_object_unref0 (p);
								}
								_g_object_unref0 (_p_it);
							}
							...
							j = _tmp234_ + 1;
							{
								...
								while (TRUE) {
									...
									if (((FolksIndividual*) _tmp243_) == ((FolksIndividual*) _tmp246_)) {
										...
										FolksIndividual* _tmp248_;
										const gchar* _tmp249_;
										const gchar* _tmp250_;
										FolksIndividual* _tmp251_;
										_tmp247_ = link_key;
										_tmp248_ = individual;
...
static gboolean _folks_individual_aggregator_maybe_configure_as_primary (FolksIndividualAggregator* self, FolksPersonaStore* store) {
	...
	g_debug ("individual-aggregator.vala:1932: _maybe_configure_as_primary()");
	configured = FALSE;
	...
	if (_tmp0_) {
		...
		_tmp10_ = _tmp9_;
		g_debug ("individual-aggregator.vala:1939: Setting primary store IDs to '%s' and" \
" '%s'.", _tmp7_, _tmp10_);
		_tmp11_ = store;
...
static void _folks_individual_aggregator_individual_removed_cb (FolksIndividualAggregator* self, FolksIndividual* i, FolksIndividual* replacement) {
	...
	if (_tmp10_ != NULL) {
		...
		_tmp16_ = _tmp15_;
		g_debug ("individual-aggregator.vala:1961: Individual '%s' removed (replaced by " \
"'%s')", _tmp13_, _tmp16_);
	} else {
		FolksIndividual* _tmp17_;
		const gchar* _tmp18_;
		...
		_tmp19_ = _tmp18_;
		g_debug ("individual-aggregator.vala:1966: Individual '%s' removed (not replaced" \
")", _tmp19_);
	}
	_tmp20_ = i;
	...
	if (_tmp24_ > 0) {
		...
		_tmp25_ = gee_hash_multi_map_new (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
		changes = _tmp25_;
		_tmp26_ = folks_small_set_new (FOLKS_TYPE_INDIVIDUAL, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
		individuals = _tmp26_;
		_tmp27_ = individuals;
		_tmp28_ = i;
...
static gboolean folks_individual_aggregator_add_persona_from_details_co (FolksIndividualAggregatorAddPersonaFromDetailsData* _data_) {
	...
	__catch20_folks_persona_store_error:
	{
		...
		if (g_error_matches (_data_->_tmp7_, FOLKS_PERSONA_STORE_ERROR, FOLKS_PERSONA_STORE_ERROR_STORE_OFFLINE)) {
			...
			_data_->_tmp21_ = g_error_new (FOLKS_INDIVIDUAL_AGGREGATOR_ERROR, FOLKS_INDIVIDUAL_AGGREGATOR_ERROR_ADD_FAILED, _ ("Failed to add contact for persona store ID ‘%s’: %s"), _data_->_tmp18_, _data_->_tmp20_);
	...
	if (_data_->_tmp22_) {
		...
		_data_->_tmp26_ = folks_individual_get_personas (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp25_, FOLKS_TYPE_INDIVIDUAL, FolksIndividual));
		_data_->_tmp27_ = _data_->_tmp26_;
		_data_->_tmp28_ = _data_->persona;
		gee_collection_add ((GeeCollection*) _data_->_tmp27_, G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp28_, FOLKS_TYPE_PERSONA, FolksPersona));
	}
...
"that service or using the ‘%s’ GSettings key."), NULL);
	...
	_data_->_tmp15_ = _data_->personas;
	...
	_data_->_tmp18_ = _data_->self->priv->_linking_enabled;
	if (_data_->_tmp18_ == FALSE) {
		g_debug ("individual-aggregator.vala:2154: Can't link Personas: linking disabled" \
".");
		g_task_return_pointer (_data_->_async_result, _data_, NULL);
		if (_data_->_state_ != 0) {
			while (_data_->_task_complete_ != TRUE) {
	...
	}
	{
		...
		_data_->_p_it = _data_->_tmp20_;
		while (TRUE) {
			_data_->_tmp21_ = _data_->_p_it;
			_data_->_tmp22_ = gee_iterator_next (_data_->_tmp21_);
			if (!_data_->_tmp22_) {
				break;
			}
			_data_->_tmp23_ = _data_->_p_it;
			_data_->_tmp24_ = gee_iterator_get (_data_->_tmp23_);
			_data_->p = (FolksPersona*) _data_->_tmp24_;
			_data_->_tmp25_ = _data_->p;
			_data_->_tmp26_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp25_, FOLKS_TYPE_ANTI_LINKABLE) ? ((FolksAntiLinkable*) _data_->_tmp25_) : NULL);
			_data_->al = _data_->_tmp26_;
			_data_->_tmp27_ = _data_->al;
			if (_data_->_tmp27_ != NULL) {
				{
					_data_->_tmp28_ = _data_->al;
					_data_->_tmp29_ = _data_->personas;
					_data_->_state_ = 1;
					folks_anti_linkable_remove_anti_links (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp28_, FOLKS_TYPE_ANTI_LINKABLE, FolksAntiLinkable), _data_->_tmp29_, folks_individual_aggregator_link_personas_ready, _data_);
					return FALSE;
					_state_1:
					folks_anti_linkable_remove_anti_links_finish (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp28_, FOLKS_TYPE_ANTI_LINKABLE, FolksAntiLinkable), _data_->_res_, &_data_->_inner_error_);
					if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
				...
				__catch21_folks_property_error:
				{
					_data_->e = _data_->_inner_error_;
					_data_->_inner_error_ = NULL;
					_data_->_tmp30_ = g_error_new_literal (FOLKS_INDIVIDUAL_AGGREGATOR_ERROR, FOLKS_INDIVIDUAL_AGGREGATOR_ERROR_PROPERTY_NOT_WRITEABLE, _ ("Anti-links can’t be removed between personas being linked."));
	...
	_data_->_tmp31_ = _data_->self->priv->_primary_store;
	_data_->_tmp32_ = folks_persona_store_get_type_id (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp31_, FOLKS_TYPE_PERSONA_STORE, FolksPersonaStore));
	_data_->_tmp33_ = _data_->_tmp32_;
	_data_->_tmp34_ = _data_->self->priv->_configured_primary_store_type_id;
	_vala_assert (g_strcmp0 (_data_->_tmp33_, _data_->_tmp34_) == 0, "((!) this._primary_store).type_id ==           this._configured_primary_store_type_id");
	_data_->_tmp35_ = _data_->personas;
	_data_->_tmp36_ = _folks_individual_aggregator_build_linking_details (_data_->self, _data_->_tmp35_);
	_data_->details = _data_->_tmp36_;
	_data_->_tmp37_ = _data_->self->priv->_primary_store;
	_data_->_tmp38_ = _data_->details;
	_data_->_state_ = 2;
	folks_individual_aggregator_add_persona_from_details (_data_->self, NULL, G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp37_, FOLKS_TYPE_PERSONA_STORE, FolksPersonaStore), _data_->_tmp38_, folks_individual_aggregator_link_personas_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp39_ = folks_individual_aggregator_add_persona_from_details_finish (_data_->self, _data_->_res_, &_data_->_inner_error_);
...
static gboolean folks_individual_aggregator_unlink_individual_co (FolksIndividualAggregatorUnlinkIndividualData* _data_) {
	...
	if (_data_->_tmp0_ == FALSE) {
		...
		g_debug ("individual-aggregator.vala:2296: Can't unlink Individual '%s': linking" \
" disabled.", _data_->_tmp3_);
	...
	_data_->_tmp6_ = _data_->_tmp5_;
	g_debug ("individual-aggregator.vala:2301: Unlinking Individual '%s':", _data_->_tmp6_);
	...
	g_debug ("individual-aggregator.vala:2317:     Inserting anti-links:");
	{
		...
		while (TRUE) {
			...
			{
				_data_->_tmp23_ = folks_small_set_new (FOLKS_TYPE_PERSONA, (GBoxedCopyFunc) g_object_ref, (GDestroyNotify) g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL);
				...
				g_debug ("individual-aggregator.vala:2324:         Anti-linking persona '%s' (%p" \
")", _data_->_tmp28_, _data_->_tmp29_);
				...
				g_debug ("individual-aggregator.vala:2329:         Writeable persona '%s' (%p)", _data_->_tmp34_, _data_->_tmp35_);
				...
				g_debug ("individual-aggregator.vala:2339: ");
				_g_object_unref0 (_data_->al);
				_g_object_unref0 (_data_->anti_link_personas);
				_g_object_unref0 (_data_->writeable_persona);
				_g_object_unref0 (_data_->personas);
...
static gboolean folks_individual_aggregator_ensure_individual_property_writeable_co (FolksIndividualAggregatorEnsureIndividualPropertyWriteableData* _data_) {
	...
	g_debug ("individual-aggregator.vala:2391: ensure_individual_property_writeable:" \
...
static gboolean _folks_individual_aggregator_ensure_personas_property_writeable_co (FolksIndividualAggregatorEnsurePersonasPropertyWriteableData* _data_) {
	...
	_state_0:
	{
		...
		while (TRUE) {
			...
			if (_vala_string_array_contains (_data_->_tmp9_, _data_->_tmp9__length1, _data_->_tmp6_)) {
				...
				_data_->_tmp12_ = _data_->_tmp11_;
				g_debug ("individual-aggregator.vala:2411:     Returning existing persona: %s", _data_->_tmp12_);
	...
	if (_data_->_tmp15_) {
		{
			g_debug ("individual-aggregator.vala:2428:     Using writeable store");
	...
	if (_data_->_tmp26_ == NULL) {
		{
			...
			_data_->_tmp28_ = gee_abstract_map_get_values ((GeeAbstractMap*) _data_->_tmp27_);
			...
			while (TRUE) {
				...
				}
				{
					...
					g_debug ("individual-aggregator.vala:2452:     Using store %s", _data_->_tmp46_);
	...
	if (_data_->_tmp52_) {
		_data_->_tmp55_ = g_strconcat (_ ("Can’t add personas with no primary store."), "\n", NULL);
		_data_->_tmp56_ = _data_->_tmp55_;
		_data_->_tmp57_ = g_strconcat (_data_->_tmp56_, _ ("Persona store ‘%s:%s’ is configured as primary, but could not be found" \
" or failed to load."), NULL);
		_data_->_tmp58_ = _data_->_tmp57_;
		_data_->_tmp59_ = g_strconcat (_data_->_tmp58_, "\n", NULL);
		_data_->_tmp60_ = _data_->_tmp59_;
		_data_->_tmp61_ = g_strconcat (_data_->_tmp60_, _ ("Check the relevant service is running, or change the default store in " \
"that service or using the ‘%s’ GSettings key."), NULL);
		_data_->_tmp62_ = _data_->_tmp61_;
		_data_->_tmp63_ = _data_->self->priv->_configured_primary_store_type_id;
		_data_->_tmp64_ = _data_->self->priv->_configured_primary_store_id;
		_data_->_tmp65_ = g_strdup_printf ("%s %s", FOLKS_INDIVIDUAL_AGGREGATOR__FOLKS_GSETTINGS_SCHEMA, FOLKS_INDIVIDUAL_AGGREGATOR__PRIMARY_STORE_CONFIG_KEY);
		_data_->_tmp66_ = _data_->_tmp65_;
		_data_->_tmp67_ = g_error_new (FOLKS_INDIVIDUAL_AGGREGATOR_ERROR, FOLKS_INDIVIDUAL_AGGREGATOR_ERROR_NO_PRIMARY_STORE, _data_->_tmp62_, _data_->_tmp63_, _data_->_tmp64_, _data_->_tmp66_);
		...
		_data_->_tmp69_ = _data_->new_persona;
		if (_data_->_tmp69_ == NULL) {
			_data_->_tmp70_ = _data_->property_name;
			_data_->_tmp71_ = g_error_new (FOLKS_INDIVIDUAL_AGGREGATOR_ERROR, FOLKS_INDIVIDUAL_AGGREGATOR_ERROR_PROPERTY_NOT_WRITEABLE, _ ("Can’t write to requested property (‘%s’) of the writeable store."), _data_->_tmp70_);
	...
	_data_->_tmp73_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp72_, FOLKS_TYPE_PERSONA, FolksPersona));
...
static void folks_individual_aggregator_set_backend_store (FolksIndividualAggregator* self, FolksBackendStore* value) {
	...
	g_object_notify_by_pspec ((GObject *) self, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_BACKEND_STORE]);
}
...
static void folks_individual_aggregator_set_individuals (FolksIndividualAggregator* self, GeeMap* value) {
	...
	g_object_notify_by_pspec ((GObject *) self, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_INDIVIDUALS]);
}
...
static void folks_individual_aggregator_set_user (FolksIndividualAggregator* self, FolksIndividual* value) {
	...
	if (folks_individual_aggregator_get_user (self) != value) {
		...
		g_object_notify_by_pspec ((GObject *) self, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_USER]);
	}
}
...
static void folks_individual_aggregator_class_init (FolksIndividualAggregatorClass * klass) {
	...
	/**
	   ...
	   * @since 0.3.0
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_INDIVIDUAL_AGGREGATOR_IS_PREPARED, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_IS_PREPARED] = g_param_spec_boolean ("is-prepared", "is-prepared", "is-prepared", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.6.2
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_INDIVIDUAL_AGGREGATOR_IS_QUIESCENT, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_IS_QUIESCENT] = g_param_spec_boolean ("is-quiescent", "is-quiescent", "is-quiescent", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.5.0
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_INDIVIDUAL_AGGREGATOR_PRIMARY_STORE, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_PRIMARY_STORE] = g_param_spec_object ("primary-store", "primary-store", "primary-store", FOLKS_TYPE_PERSONA_STORE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   * The backend store providing the persona stores for this aggregator.
	   *
	   * @since 0.9.7
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_INDIVIDUAL_AGGREGATOR_BACKEND_STORE, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_BACKEND_STORE] = g_param_spec_object ("backend-store", "backend-store", "backend-store", FOLKS_TYPE_BACKEND_STORE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));
	/**
	   ...
	   * @since 0.5.1
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_INDIVIDUAL_AGGREGATOR_INDIVIDUALS, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_INDIVIDUALS] = g_param_spec_object ("individuals", "individuals", "individuals", GEE_TYPE_MAP, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	   ...
	   * @since 0.3.0
	   */
	g_object_class_install_property (G_OBJECT_CLASS (klass), FOLKS_INDIVIDUAL_AGGREGATOR_USER, folks_individual_aggregator_properties[FOLKS_INDIVIDUAL_AGGREGATOR_USER] = g_param_spec_object ("user", "user", "user", FOLKS_TYPE_INDIVIDUAL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
