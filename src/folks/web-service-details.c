/* web-service-details.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static void folks_web_service_field_details_class_init (FolksWebServiceFieldDetailsClass * klass) {
	...
	((FolksAbstractFieldDetailsClass *) klass)->equal = folks_web_service_field_details_real_equal;
	((FolksAbstractFieldDetailsClass *) klass)->hash = folks_web_service_field_details_real_hash;
}
...
static void folks_web_service_details_real_change_web_service_addresses (FolksWebServiceDetails* self, GeeMultiMap* web_service_addresses, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FolksWebServiceDetailsChangeWebServiceAddressesData* _data_;
	FolksWebServiceDetails* _tmp0_ = NULL;
