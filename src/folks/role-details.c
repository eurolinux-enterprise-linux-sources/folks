/* role-details.c generated by valac 0.20.1.30-1b1d, the Vala compiler
...
gboolean folks_role_is_empty (FolksRole* self) {
	...
	if (_tmp6_) {
		const gchar* _tmp7_;
		const gchar* _tmp8_;
		_tmp7_ = folks_role_get_role (self);
		_tmp8_ = _tmp7_;
...
gboolean folks_role_equal (FolksRole* a, FolksRole* b) {
	...
	if (_tmp14_) {
		...
		const gchar* _tmp20_;
		_tmp15_ = a;
		_tmp16_ = folks_role_get_organisation_name (_tmp15_);
		_tmp17_ = _tmp16_;
		_tmp18_ = b;
		_tmp19_ = folks_role_get_organisation_name (_tmp18_);
		_tmp20_ = _tmp19_;
		_tmp0_ = g_strcmp0 (_tmp17_, _tmp20_) == 0;
	} else {
		_tmp0_ = FALSE;
	}
	_tmp21_ = _tmp0_;
...
void folks_role_set_organisation_name (FolksRole* self, const gchar* value) {
	...
	self->priv->_organisation_name = _tmp4_;
...
static void folks_role_field_details_real_set_id (FolksAbstractFieldDetails* base, const gchar* value) {
	...
	if (g_strcmp0 (_tmp5_, _tmp9_) != 0) {
		...
		folks_role_set_uid ((FolksRole*) _tmp11_, _tmp12_);
	}
