/* command-persona-stores.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static void folks_inspect_commands_persona_stores_real_run (FolksInspectCommand* base, const gchar* command_string, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FolksInspectCommandsPersonaStores * self;
	FolksInspectCommandsPersonaStoresRunData* _data_;
	FolksInspectCommandsPersonaStores* _tmp0_ = NULL;
...
static gint folks_inspect_commands_persona_stores_real_run_finish (FolksInspectCommand* base, GAsyncResult* _res_) {
	gint result;
	FolksInspectCommandsPersonaStoresRunData* _data_;
...
static void folks_inspect_commands_persona_stores_class_init (FolksInspectCommandsPersonaStoresClass * klass) {
	...
	((FolksInspectCommandClass *) klass)->run = folks_inspect_commands_persona_stores_real_run;
	((FolksInspectCommandClass *) klass)->run_finish = folks_inspect_commands_persona_stores_real_run_finish;
	((FolksInspectCommandClass *) klass)->complete_subcommand = folks_inspect_commands_persona_stores_real_complete_subcommand;
