/* inspect.c generated by valac 0.27.1.3-6129, the Vala compiler
...
static void ___lambda9_ (GObject* obj, GAsyncResult* res);
...
static void __lambda8_ (Block1Data* _data1_, GObject* obj, GParamSpec* pspec);
...
static void ___lambda7_ (Block2Data* _data2_, GObject* obj, GAsyncResult* res);
...
gint folks_inspect_client_main (gchar** args, int args_length1) {
	...
	if (_tmp7__length1 == 1) {
		...
		folks_inspect_client_run_non_interactive (_tmp16_, _tmp17_, ____lambda9__gasync_ready_callback, NULL);
		_g_free0 (command_line);
	}
	_tmp18_ = main_client;
...
FolksInspectClient* folks_inspect_client_construct (GType object_type) {
	...
	FolksInspectSignalManager* _tmp32_ = NULL;
	FolksInspectSignalManager* _tmp33_ = NULL;
	FolksBackendStore* _tmp34_ = NULL;
	FolksBackendStore* _tmp35_ = NULL;
	FolksIndividualAggregator* _tmp36_ = NULL;
	FolksIndividualAggregator* _tmp37_ = NULL;
	...
	_tmp36_ = folks_individual_aggregator_dup ();
	_tmp37_ = _tmp36_;
...
static gboolean _folks_inspect_client_wait_for_quiescence_co (FolksInspectClientWaitForQuiescenceData* _data_) {
	...
	_data_->_tmp1_ = 0UL;
	_data_->_tmp1_ = g_signal_connect_data ((GObject*) _data_->_tmp0_, "notify::is-quiescent", (GCallback) ___lambda8__g_object_notify, block1_data_ref (_data_->_data1_), (GClosureNotify) block1_data_unref, 0);
...
static void _folks_inspect_client_readline_handler_cb (const gchar* _command_line) {
	...
	if (_tmp12_ != NULL) {
		...
		_tmp16_ = subcommand;
		folks_inspect_command_run (_tmp15_, _tmp16_, ____lambda7__gasync_ready_callback, block2_data_ref (_data2_));
	} else {
		FILE* _tmp17_ = NULL;
...
static void _folks_inspect_client_start_paged_output (FolksInspectClient* self) {
	...
	__catch6_g_shell_error:
	{
		...
		g_warning ("inspect.vala:414: Error parsing pager arguments: %s", _tmp12_);
		_g_error_free0 (e);
		args = (_vala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
		_g_free0 (pager);
		return;
	...
	__catch7_g_spawn_error:
	{
		...
		g_warning ("inspect.vala:444: Error spawning pager: %s", _tmp17_);
		_g_error_free0 (e2);
		args = (_vala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
		_g_free0 (pager);
		return;
