/* command-debug.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static void folks_inspect_commands_debug_real_run (FolksInspectCommand* base, const gchar* command_string, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FolksInspectCommandsDebug * self;
	FolksInspectCommandsDebugRunData* _data_;
	FolksInspectCommandsDebug* _tmp0_ = NULL;
...
static gint folks_inspect_commands_debug_real_run_finish (FolksInspectCommand* base, GAsyncResult* _res_) {
	gint result;
	FolksInspectCommandsDebugRunData* _data_;
...
static void folks_inspect_commands_debug_class_init (FolksInspectCommandsDebugClass * klass) {
	...
	((FolksInspectCommandClass *) klass)->run = folks_inspect_commands_debug_real_run;
	((FolksInspectCommandClass *) klass)->run_finish = folks_inspect_commands_debug_real_run_finish;
