/* command-individuals.c generated by valac 0.20.1.30-1b1d, the Vala compiler
...
static void folks_inspect_commands_individuals_class_init (FolksInspectCommandsIndividualsClass * klass) {
	...
	FOLKS_INSPECT_COMMAND_CLASS (klass)->run_finish = folks_inspect_commands_individuals_real_run_finish;
