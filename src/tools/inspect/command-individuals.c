/* command-individuals.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static gint folks_inspect_commands_individuals_real_run_finish (FolksInspectCommand* base, GAsyncResult* _res_) {
	gint result;
	FolksInspectCommandsIndividualsRunData* _data_;
