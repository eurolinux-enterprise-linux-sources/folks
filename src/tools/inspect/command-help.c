/* command-help.c generated by valac 0.20.1.30-1b1d, the Vala compiler
...
static void folks_inspect_commands_help_real_run (FolksInspectCommand* base, const gchar* command_string, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	FolksInspectCommandsHelp * self;
	FolksInspectCommandsHelpRunData* _data_;
	FolksInspectCommandsHelp* _tmp0_;
	const gchar* _tmp1_;
	gchar* _tmp2_;
...
static void folks_inspect_commands_help_real_run_finish (FolksInspectCommand* base, GAsyncResult* _res_) {
	FolksInspectCommandsHelpRunData* _data_;
...
static void folks_inspect_commands_help_class_init (FolksInspectCommandsHelpClass * klass) {
	...
	FOLKS_INSPECT_COMMAND_CLASS (klass)->run = folks_inspect_commands_help_real_run;
	FOLKS_INSPECT_COMMAND_CLASS (klass)->run_finish = folks_inspect_commands_help_real_run_finish;
	FOLKS_INSPECT_COMMAND_CLASS (klass)->complete_subcommand = folks_inspect_commands_help_real_complete_subcommand;
